...
# CHECK-NEXT:    0x0000000000000006 SYMTAB               {{0x190|0x1C8}}
# CHECK-NEXT:    0x000000000000000B SYMENT               24 (bytes)
# CHECK-NEXT:    0x0000000000000005 STRTAB               {{0x1A8|0x1E0}}
# CHECK-NEXT:    0x000000000000000A STRSZ                1 (bytes)
# CHECK-NEXT:    0x0000000000000004 HASH                 {{0x1F0|0x228}}
...
# CHECK-NEXT:    0x0000000070000035 MIPS_RLD_MAP_REL     {{0x1FD60|0x1FCF8}}
