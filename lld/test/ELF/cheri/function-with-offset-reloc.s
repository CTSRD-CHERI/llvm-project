...
# CHECK:      SectionData (
# CHECK-NEXT:   0000: 00000000 00010662 00000000 00000000
...
# CHECK:      Name: .data
# CHECK:      SectionData (
# CHECK-NEXT:    0000: 00000000 00010663 00000000 00000000  |.......c........|
# CHECK-NEXT:    0010: CACACACA CACACACA CACACACA CACACACA  |................|
##                            ^^ no addend since __cap_relocs is used (hidden_local_func)
# CHECK-NEXT:    0020: CACACACA CACACACA CACACACA CACACACA  |................|
##                            ^^ no addend since __cap_relocs is used (protected_local_func)
...
# CHECK-NEXT:    0x02{{.+}} Base: 0x10664 (hidden_local_func+16) Length: 4 Perms: Function
# CHECK-NEXT:    0x02{{.+}} Base: 0x10668 (protected_local_func+17) Length: 4 Perms: Function
# CHECK-NEXT:    0x02{{.+}} Base: 0x1066c (__cheri_eh_exported_local_func+18) Length: 4 Perms: Function
# CHECK-NEXT:    0x03{{.+}} Base: 0x10664 (hidden_local_func+1) Length: 4 Perms: Function
# CHECK-NEXT:    0x03{{.+}} Base: 0x10668 (protected_local_func+2) Length: 4 Perms: Function
# CHECK-NEXT: ]
