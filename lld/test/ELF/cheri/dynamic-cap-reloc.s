...
# DYN-RELOCS-NEXT:      0x20600 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:      0x20640 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:   }

# DYN-RELOCS-LABEL: CHERI Capability Relocations [
# DYN-RELOCS-NEXT:    Section ({{.+}}) __cap_relocs {
# DYN-RELOCS-NEXT:      0x20620 FUNC - 0x105C0 [0x500-0x20600]
# DYN-RELOCS-NEXT:      0x20660 FUNC - 0x105C4 [0x500-0x20600]
# DYN-RELOCS-NEXT:    }
# DYN-RELOCS-NEXT:  ]
...
# DUMP-NEXT:  0000000000020620 FUNC    00000000000105c0 [0000000000000500-0000000000020600]
# DUMP-NEXT:  0000000000020660 FUNC    00000000000105c4 [0000000000000500-0000000000020600]
# DUMP-EMPTY
