...
# DYN-RELOCS: 0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x500
...
# DYN-RELOCS-NEXT:      0x{{205D0|30560}} R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:      0x{{20610|305A0}} R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:   }

# DYN-RELOCS-LABEL: CHERI Capability Relocations [
# DYN-RELOCS-NEXT:    Section ({{.+}}) __cap_relocs {
# DYN-RELOCS-NEXT:      0x205F0 FUNC - 0x105C0 [0x500-0x20700]
# DYN-RELOCS-NEXT:      0x20630 FUNC - 0x105C4 [0x500-0x20700]
# DYN-RELOCS-NEXT:    }
# DYN-RELOCS-NEXT:  ]
...
# DUMP-NEXT:  00000000000205f0 FUNC    00000000000105c0 [0000000000000500-0000000000020700]
# DUMP-NEXT:  0000000000020630 FUNC    00000000000105c4 [0000000000000500-0000000000020700]
# DUMP-EMPTY
