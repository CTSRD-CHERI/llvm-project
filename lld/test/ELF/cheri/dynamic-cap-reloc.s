...
# DYN-RELOCS-NEXT:      0x204D0 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:      0x20510 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:   }

# DYN-RELOCS-LABEL: CHERI Capability Relocations [
# DYN-RELOCS-NEXT:    Section ({{.+}}) __cap_relocs {
# DYN-RELOCS-NEXT:      0x204F0 FUNC - 0x104C0 [0x10480-0x20580]
# DYN-RELOCS-NEXT:      0x20530 FUNC - 0x104C4 [0x10480-0x20580]
# DYN-RELOCS-NEXT:    }
# DYN-RELOCS-NEXT:  ]
...
# DUMP-NEXT:  00000000000204f0 FUNC    00000000000104c0 [0000000000010480-0000000000020580]
# DUMP-NEXT:  0000000000020530 FUNC    00000000000104c4 [0000000000010480-0000000000020580]
# DUMP-EMPTY
