...
# DYN-RELOCS-OLD: 0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x204C8
...
# DYN-RELOCS-OLD-NEXT:  0x204D0 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
# DYN-RELOCS-OLD-NEXT:  0x204F8 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE -{{$}}
...
# DYN-RELOCS-OLD-NEXT:   0x030540 (local_ref) Base: 0x104c0 (bar+0) Length: 8 Perms: Function
# DYN-RELOCS-OLD-NEXT:   0x030580 (local_ref_with_addend) Base: 0x104c0 (bar+4) Length: 8 Perms: Function
# DYN-RELOCS-NEXT:  ]
...
# DUMP-OLD-NEXT: 0x0000000000030540	Base: bar (0x00000000000104c0)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
# DUMP-OLD-NEXT: 0x0000000000030580	Base: bar (0x00000000000104c0)	Offset: 0x0000000000000004	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
# DUMP-EMPTY
