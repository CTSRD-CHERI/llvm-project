...
# DYN-RELOCS-NEXT:      0x20500 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:      0x20540 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE foo{{$}}
# DYN-RELOCS-NEXT:   }

# DYN-RELOCS-LABEL: CHERI Capability Relocations [
# DYN-RELOCS-NEXT:    Section ({{.+}}) __cap_relocs {
# DYN-RELOCS-NEXT:      0x20520 FUNC - 0x104C0 [0x10480-0x20500]
# DYN-RELOCS-NEXT:      0x20560 FUNC - 0x104C4 [0x10480-0x20500]
# DYN-RELOCS-NEXT:    }
# DYN-RELOCS-NEXT:  ]
...
# DUMP-NEXT:  0000000000020520 FUNC    00000000000104c0 [0000000000010480-0000000000020500]
# DUMP-EMPTY
