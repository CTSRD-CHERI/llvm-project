...
# CHECK-NEXT:   0x0030d0 (data) Base: 0x1000 (func) Length: 4 Perms: Function
# CHECK-NEXT:   0x0030e0 Base: 0x1000 (func) Length: 4 Perms: Code
# CHECK-NEXT:   0x0030f0 Base: 0x30d0 (data) Length: 64 Perms: Object
# CHECK-NEXT: ]
