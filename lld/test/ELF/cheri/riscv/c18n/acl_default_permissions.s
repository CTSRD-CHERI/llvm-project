...
# CHECK-NEXT:     0x012480 Base: 0x134a0 (buf) Length: 1024 Perms: Constant
# CHECK-NEXT:     0x012490 Base: 0x138a0 (buf2) Length: 1024 Perms: Object
# relocs for compartment two
# CHECK-NEXT:     0x015cd0 Base: 0x134a0 (buf) Length: 1024 Perms: Object
# CHECK-NEXT:     0x015ce0 Base: 0x138a0 (buf2) Length: 1024 Perms: Object
