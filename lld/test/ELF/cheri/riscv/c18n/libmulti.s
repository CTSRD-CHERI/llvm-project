...
# SEGMENTS-NEXT:    GNU_RELRO      0x0009a0 0x00000000000089a0 0x00000000000089a0 0x000040 0x000660 R   0x1
...
# SEGMENTS-NEXT:   06     .rela.plt.two .rodata.two
# SEGMENTS-NEXT:   07     .text.two .plt.two
# SEGMENTS-NEXT:   08     .got.plt.two
# SEGMENTS-NEXT:   09     .got.two
# SEGMENTS-NEXT:   10     .tbss
# SEGMENTS-NEXT:   11     .dynamic
# SEGMENTS-NEXT:   12     .text.one .got.one .bss.one
# SEGMENTS-NEXT:   13     .rela.plt.two .rodata.two .text.two .plt.two .got.plt.two .got.two
# SEGMENTS-NEXT:   14     .dynamic
# SEGMENTS-NEXT:   15     .got.one
# SEGMENTS-NEXT:   16     .got.two
# SEGMENTS-NEXT:   17     .text.one .got.one
# SEGMENTS-NEXT:   18     .rodata.two .text.two .plt.two .got.plt.two .got.two
# SEGMENTS-NEXT:   19
...
# DYNAMIC-NEXT:  0x0000000000000003 (PLTGOT)                    0x7960
