...
// LINKER-MSG: warning: .global_sizes section contains unresolved values -> making writable because it referneces unresolved symbol errno
...
// RUN: %cheri_purecap_cc1 -emit-obj %s -o %t.o -DDEFINED_ERRNO=1
