...
//
// RUN: %cheri_purecap_cc1 %s -O0 -S -o -
...
// EXE: 0x00000001200001c0 Base: __start (0x0000000120010000)	Offset: 0x0000000000000004	Length: 0x0000000000000028	Permissions: 0x8000000000000000 (Function)
//
// SHLIB: CAPABILITY RELOCATION RECORDS:
// SHLIB: 0x0000000000000200 Base: __start (0x0000000000010000)	Offset: 0x0000000000000004	Length: 0x0000000000000028	Permissions: 0x8000000000000000 (Function)
