...
// CHECK-NEXT:  0x0000000000020000	Base: <Unnamed symbol> (0x00000000000003f1)	Offset: 0x0000000000000000	Length: 0x0000000000000010	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000200{{1|2}}0	Base: <Unnamed symbol> (0x0000000000000401)	Offset: 0x0000000000000000	Length: 0x000000000000000b	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000200{{2|4}}0	Base: <Unnamed symbol> (0x000000000000[[RODATA_ADDR:03f0]])	Offset: 0x0000000000000000	Length: 0x0000000000000001	Permissions: 0x4000000000000000 (Constant)
// CHECK-EMPTY:
