...
// CHECK-NEXT:  0x00000000000204d0	Base: <Unnamed symbol> (0x000000000000043b)	Offset: 0x0000000000000000	Length: 0x0000000000000010	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000204{{e|f}}0	Base: <Unnamed symbol> (0x000000000000044b)	Offset: 0x0000000000000000	Length: 0x000000000000000b	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x0000000000020{{4f|51}}0	Base: <Unnamed symbol> (0x000000000000[[RODATA_ADDR:043a]])	Offset: 0x0000000000000000	Length: 0x0000000000000001	Permissions: 0x4000000000000000 (Constant)
// CHECK-EMPTY:

// CHECK-LABEL:  Contents of section .rodata:
// CHECK-NEXT:   [[RODATA_ADDR]] 006e6565 64206469 6374696f 6e617279  .need dictionary
