...
// CHECK-NEXT:  0x00000000000205a0	Base: <Unnamed symbol> (0x0000000000000501)	Offset: 0x0000000000000000	Length: 0x0000000000000010	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000205{{b|c}}0	Base: <Unnamed symbol> (0x0000000000000511)	Offset: 0x0000000000000000	Length: 0x000000000000000b	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000205{{c|e}}0	Base: <Unnamed symbol> (0x000000000000[[RODATA_ADDR:0500]])	Offset: 0x0000000000000000	Length: 0x0000000000000001	Permissions: 0x4000000000000000 (Constant)
// CHECK-EMPTY:
