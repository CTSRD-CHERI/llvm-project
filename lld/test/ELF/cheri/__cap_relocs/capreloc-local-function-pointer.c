...
// RUN: %cheri_purecap_clang -cheri=128 %s -c -o %t.o
...
// RUN: %cheri_purecap_clang -cheri=128  %S/Inputs/dummy_shlib.c -c -o %T/integrated_dummy_shlib.o
...
// RUN: %cheri_purecap_clang -cheri=128 %legacy_caprelocs_flag %s -c -o %t-legacy.o
