...
// RUN: ld.lld -preemptible-caprelocs=legacy %t-externs.o -shared -o %t-externs.so
// RUN: llvm-objdump --cap-relocs -t  %t-externs.so | FileCheck -check-prefixes DUMP-EXTERNALLIB %s

// RUN: ld.lld -preemptible-caprelocs=legacy %t-externs.so %t.o -o %t-dynamic.exe -e entry
...
// RUN: ld.lld -preemptible-caprelocs=legacy %t-externs.so %t.o -shared -o %t.so
...
// RUN: not ld.lld -preemptible-caprelocs=legacy %t.o --dynamic-linker /libexec/ld-cheri-elf.so -o /dev/null -e entry 2>&1 | FileCheck %s -check-prefix UNDEFINED
// RUN: not ld.lld -preemptible-caprelocs=legacy %t.o -static -o /dev/null -e entry 2>&1 | FileCheck %s -check-prefix UNDEFINED
// RUN: not ld.lld -preemptible-caprelocs=legacy %t.o -shared -no-undefined -o /dev/null 2>&1 | FileCheck %s -check-prefix UNDEFINED
...
// STATIC: 0x0000000120020040	Base: external_func (0x00000001200{{.+}})	Offset: 0x0000000000000000	Length: 0x000000000000002c	Permissions: 0x8000000000000000 (Function)
...
// DUMP-EXTERNALLIB:  0000000000010000 g     F .text		 0000002c external_func


// SHLIB:      Section (8) .rel.dyn {
// SHLIB-NEXT:   0x20000 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE - 0x0
// SHLIB-NEXT:   0x20028 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE - 0x0
// SHLIB-NEXT:   0x20050 R_MIPS_REL32/R_MIPS_64/R_MIPS_NONE - 0x0
// SHLIB-NEXT:   0x20030 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE external_buffer 0x0
// SHLIB-NEXT:   0x20040 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE external_buffer 0x0
// SHLIB-NEXT:   0x20008 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE external_cap 0x0
// SHLIB-NEXT:   0x20018 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE external_cap 0x0
// SHLIB-NEXT:   0x20058 R_MIPS_CHERI_ABSPTR/R_MIPS_64/R_MIPS_NONE external_func 0x0
// SHLIB-NEXT:   0x20068 R_MIPS_CHERI_SIZE/R_MIPS_64/R_MIPS_NONE external_func 0x0
// SHLIB-NEXT: }

// DUMP-SHLIB: CAPABILITY RELOCATION RECORDS:
// DUMP-SHLIB: 0x0000000000030000      Base:  (0x0000000000000000)     Offset: 0x0000000000000000      Length: 0x0000000000000000      Permissions: 0x00000000
// DUMP-SHLIB: 0x0000000000030020      Base:  (0x0000000000000000)     Offset: 0x0000000000000019      Length: 0x0000000000000000      Permissions: 0x00000000
// DUMP-SHLIB: 0x0000000000030040      Base:  (0x0000000000000000)     Offset: 0x0000000000000000      Length: 0x0000000000000000      Permissions: 0x8000000000000000 (Function)
