...
// CHECK-NEXT: 0x0000000000020000      Base: <Unnamed symbol> (0x0000000000000292)     Offset: 0x0000000000000000  Length: 0x00000000000000bd       Permissions: 0x00000000
// CHECK-NEXT: 0x0000000000020020      Base: <Unnamed symbol> (0x000000000000025c)     Offset: 0x0000000000000000  Length: 0x00000000000000f3       Permissions: 0x00000000
// CHECK-NEXT: 0x0000000000020040      Base: <Unnamed symbol> (0x0000000000000345)     Offset: 0x0000000000000000  Length: 0x000000000000000a       Permissions: 0x00000000
// CHECK-NEXT: 0x0000000000030000      Base: <Unnamed symbol> (0x0000000000000313)     Offset: 0x0000000000000000  Length: 0x000000000000003c       Permissions: 0x00000000
// CHECK-NEXT: 0x0000000000030020      Base: <Unnamed symbol> (0x0000000000000281)     Offset: 0x0000000000000000  Length: 0x00000000000000ce       Permissions: 0x00000000
// CHECK-NEXT: 0x0000000000030040      Base: <Unnamed symbol> (0x0000000000000268)     Offset: 0x0000000000000000  Length: 0x00000000000000e7       Permissions: 0x00000000
// CHECK-NEXT: 0x0000000000030060      Base: <Unnamed symbol> (0x000000000000025c)     Offset: 0x0000000000000000  Length: 0x00000000000000f3       Permissions: 0x00000000
