...
// OBJ-RELOCS-NEXT:     0x28 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE .data.rel.ro 0x10
// OBJ-RELOCS-NEXT:     0x30 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE .rodata.str1.1 0x10
// OBJ-RELOCS-NEXT:     0x50 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE .data.rel.ro 0x20
...
// CHECK-NEXT:  0x0000000000020000	Base: <Unnamed symbol> (0x00000000000001c9)	Offset: 0x0000000000000000	Length: 0x000000000000001b	Permissions: 0x00000000
// CHECK-NEXT:  0x0000000000020010	Base: <Unnamed symbol> (0x00000000000001d9)	Offset: 0x0000000000000000	Length: 0x000000000000000b	Permissions: 0x00000000
// CHECK-NEXT:  0x0000000000020020	Base: <Unnamed symbol> (0x00000000000001c8)	Offset: 0x0000000000000000	Length: 0x000000000000001c	Permissions: 0x00000000

// CHECK-LABEL:  Contents of section .rodata:
// CHECK-NEXT:   01c8 006e6565 64206469 6374696f 6e617279  .need dictionary
// CHECK-NEXT:   01d8 00737472 65616d20 656e6400           .stream end.
