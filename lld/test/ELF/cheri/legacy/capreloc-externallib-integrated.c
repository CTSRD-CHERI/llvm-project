...
// RUN: %cheri256_purecap_cc1_legacy_capreloc %S/../Inputs/external_lib_user.c -emit-obj -o %t.o
// RUN: %cheri256_purecap_cc1_legacy_capreloc %S/../Inputs/external_lib.c -emit-obj -o %t-externs.o
