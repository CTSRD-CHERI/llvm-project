...
// DYNAMIC: 0x0000000120020040	Base:  (0x0000000000000000)	Offset: 0x0000000000000000	Length: 0x0000000000000028	Permissions: 0x8000000000000000 (Function)

// DYNAMIC-EXE-RELOCS: Section ({{.+}}) .rel.dyn {
// DYNAMIC-EXE-RELOCS-NEXT:    0x120030030 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE external_buffer 0x0
// DYNAMIC-EXE-RELOCS-NEXT:    0x120030008 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE external_cap 0x0
// DYNAMIC-EXE-RELOCS-NEXT:    0x120030058 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE external_func 0x0
...
// SHLIB-NEXT:   0x30030 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE external_buffer 0x0
// SHLIB-NEXT:   0x30008 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE external_cap 0x0
// SHLIB-NEXT:   0x30058 R_MIPS_64/R_MIPS_NONE/R_MIPS_NONE external_func 0x0
// SHLIB-NEXT: }
