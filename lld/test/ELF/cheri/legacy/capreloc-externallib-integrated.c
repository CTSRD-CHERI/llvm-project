...
// RUN: %clang_cheri_purecap_legacy_capreloc -mcpu=cheri -mllvm -cheri-test-mode %S/../Inputs/external_lib_user.c -c -o %t.o
// RUN: %clang_cheri_purecap_legacy_capreloc -mcpu=cheri -mllvm -cheri-test-mode %S/../Inputs/external_lib.c -c -o %t-externs.o
...
// DYNAMIC: 0x0000000120020040	Base:  (0x0000000000000000)	Offset: 0x0000000000000000	Length: 0x0000000000000048	Permissions: 0x8000000000000000 (Function)
...
// DUMP-SHLIB: 0x0000000000020040      Base:  (0x0000000000000000)     Offset: 0x0000000000000000      Length: 0x0000000000000048      Permissions: 0x8000000000000000 (Function)
