...
// CHECK-NEXT: 0x0000000120030080	Base: crt_call_constructors (0x0000000120010{{.+}})	Offset: 0x0000000000000000	Length: 0x0000000000000098	Permissions: 0x8000000000000000 (Function)
// CHECK-NEXT: 0x0000000120030090	Base: handle_static_init (0x0000000120010{{.+}})	Offset: 0x0000000000000000	Length: 0x00000000000001b8	Permissions: 0x8000000000000000 (Function)
...
// CHECK-NEXT: 0x00000001200300c0	Base: finalizer (0x0000000120010{{.+}})	Offset: 0x0000000000000000	Length: 0x00000000000000c4	Permissions: 0x8000000000000000 (Function)
