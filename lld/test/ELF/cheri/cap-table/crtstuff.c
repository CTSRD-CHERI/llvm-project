// RUN: %cheri128_purecap_cc1 -mllvm -mxcaptable %S/Inputs/crt1.c -emit-obj -O2 -mllvm -cheri-cap-table -o %t-crt1.o
...
// CHECK-NEXT: 0x0000000120030080	Base: crt_call_constructors (0x0000000120010{{.+}})	Offset: 0x0000000000000000	Length: 0x00000000000000a4	Permissions: 0x8000000000000000 (Function)
// CHECK-NEXT: 0x0000000120030090	Base: handle_static_init (0x0000000120010{{.+}})	Offset: 0x0000000000000000	Length: 0x00000000000001c4	Permissions: 0x8000000000000000 (Function)
...
// CHECK-NEXT: 0x00000001200300c0	Base: finalizer (0x0000000120010{{.+}})	Offset: 0x0000000000000000	Length: 0x00000000000000cc	Permissions: 0x8000000000000000 (Function)
