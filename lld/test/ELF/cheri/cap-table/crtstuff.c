...
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (__auxargs@CAPTABLE) Base: 0x120030f50 (__auxargs+0) Length: 16 Perms: Object
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (environ@CAPTABLE) Base: 0x120030f40 (environ+0) Length: 16 Perms: Object
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (__progname@CAPTABLE) Base: 0x120030f20 (__progname+0) Length: 16 Perms: Object
...
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (handle_static_init@CAPTABLE.7) Base: 0x12001{{.+}} (handle_static_init+0) Length: {{.+}} Perms: Function
...
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (__CTOR_LIST__@CAPTABLE.17) Base: 0x120020da0 (__CTOR_LIST__+0) Length: 8 Perms: Constant
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (__CTOR_END__@CAPTABLE) Base: 0x120020da8 (__CTOR_END__+0) Length: 8 Perms: Constant
...
// WITHOUT-CTORS-NEXT:    0x12002{{.+}} (_int@CAPTABLE) Base: 0x120030f60 (_int+0) Length: 4 Perms: Object
...
// WITH-CTORS-NEXT:    0x12002{{.+}} (__auxargs@CAPTABLE) Base: 0x120030f60 (__auxargs+0) Length: 16 Perms: Object
// WITH-CTORS-NEXT:    0x12002{{.+}} (environ@CAPTABLE) Base: 0x120030f50 (environ+0) Length: 16 Perms: Object
// WITH-CTORS-NEXT:    0x12002{{.+}} (__progname@CAPTABLE) Base: 0x120030f30 (__progname+0) Length: 16 Perms: Object
...
// WITH-CTORS-NEXT:    0x12002{{.+}} (handle_static_init@CAPTABLE.7) Base: 0x12001{{.+}} (handle_static_init+0) Length: {{.+}} Perms: Function
...
// WITH-CTORS-NEXT:    0x12002{{.+}} (__init_array_start@CAPTABLE) Base: 0x120020dc0 (__init_array_start+0) Length: 8 Perms: Constant
// WITH-CTORS-NEXT:    0x12002{{.+}} (__init_array_end@CAPTABLE) Base:  0x120020dc8 (__fini_array_start+0) Length: 0 Perms: Constant
// WITH-CTORS-NEXT:    0x12002{{.+}} (__fini_array_start@CAPTABLE) Base: 0x120020dc8 (__fini_array_start+0)  Length: 8 Perms: Constant
// WITH-CTORS-NEXT:    0x12002{{.+}} (__fini_array_end@CAPTABLE) Base: 0x120020dd0 (__auxargs@CAPTABLE+0) Length: 0 Perms: Constant
// WITH-CTORS-NEXT:    0x12002{{.+}} (__CTOR_LIST__@CAPTABLE.17) Base: 0x120020da0 (__CTOR_LIST__+0) Length: 8 Perms: Constant
// WITH-CTORS-NEXT:    0x12002{{.+}} (__CTOR_END__@CAPTABLE) Base: 0x120020da8 (__CTOR_END__+0) Length: 8 Perms: Constant
...
// WITH-CTORS-NEXT:    0x12002{{.+}} (_int@CAPTABLE) Base: 0x120030f70 (_int+0) Length: 4 Perms: Object
...
// WITHOUT-CTORS-SYMS:       0000000120020f20 .captable		 00000000 .hidden __cap_table_end
// WITHOUT-CTORS-SYMS:       0000000120020dc0 .captable		 00000160 .hidden __cap_table_start
...
// WITH-CTORS-SYMS:       0000000120020f30 .captable		 00000000 .hidden __cap_table_end
// WITH-CTORS-SYMS:       0000000120020dd0 .captable		 00000160 .hidden __cap_table_start
// WITH-CTORS-SYMS:       0000000120020dd0 .fini_array		 00000000 .hidden __fini_array_end
// WITH-CTORS-SYMS:       0000000120020dc8 .fini_array		 00000008 .hidden __fini_array_start
// WITH-CTORS-SYMS:       0000000120020dc8 .init_array		 00000000 .hidden __init_array_end
// WITH-CTORS-SYMS:       0000000120020dc0 .init_array		 00000008 .hidden __init_array_start
