...
// PER-FILE-NEXT:     0x20A90 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// PER-FILE-NEXT:     0x20AC0 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// PER-FILE-NEXT:     0x20AE0 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// PER-FILE-NEXT:   }
// PER-FILE-NEXT:   Section ({{.+}}) .rel.plt {
// PER-FILE-NEXT:     0x20A60 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_void_ptr{{$}}
// PER-FILE-NEXT:     0x20A70 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// PER-FILE-NEXT:     0x20A80 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_int{{$}}
// PER-FILE-NEXT:     0x20AB0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// PER-FILE-NEXT:     0x20AD0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// PER-FILE-NEXT:   }
// PER-FILE-NEXT: ]
// PER-FILE-NEXT: CHERI __cap_relocs [
// PER-FILE-NEXT:    0x020aa0 (function3@CAPTABLE@file1.o.4) Base: 0x10{{.+}} (function3+0) Length: {{.+}} Perms: Function
// PER-FILE-NEXT: ]
...
// GLOBAL-NEXT:     0x20910 R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE global_int{{$}}
// GLOBAL-NEXT:   }
// GLOBAL-NEXT:   Section (8) .rel.plt {
// GLOBAL-NEXT:     0x208E0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_void_ptr{{$}}
// GLOBAL-NEXT:     0x208F0 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_char_ptr{{$}}
// GLOBAL-NEXT:     0x20900 R_MIPS_CHERI_CAPABILITY_CALL/R_MIPS_NONE/R_MIPS_NONE extern_int{{$}}
// GLOBAL-NEXT:   }
// GLOBAL-NEXT: ]
