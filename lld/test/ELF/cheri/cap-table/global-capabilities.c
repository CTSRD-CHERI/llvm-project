...
// EXE-NEXT: 0x0000000120020000	Base: functions (0x0000000120030020)	Offset: 0x0000000000000000	Length: 0x0000000000000040	Permissions: 0x00000000
// EXE-NEXT: 0x0000000120020010	Base: string (0x0000000120030010)	Offset: 0x0000000000000000	Length: 0x0000000000000010	Permissions: 0x00000000
// EXE-NEXT: 0x0000000120030000	Base: func (0x0000000120010000)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
// EXE-NEXT: 0x0000000120030010	Base: <Unnamed symbol> (0x000000012000027e)	Offset: 0x0000000000000000	Length: 0x000000000000000e	Permissions: 0x4000000000000000 (Constant)
// EXE-NEXT: 0x0000000120030020	Base: <Unnamed symbol> (0x0000000120000278)	Offset: 0x0000000000000000	Length: 0x0000000000000006	Permissions: 0x4000000000000000 (Constant)
// EXE-NEXT: 0x0000000120030030	Base: func1 (0x0000000120010008)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
// EXE-NEXT: 0x0000000120030040	Base: <Unnamed symbol> (0x000000012000028c)	Offset: 0x0000000000000000	Length: 0x0000000000000007	Permissions: 0x4000000000000000 (Constant)
// EXE-NEXT: 0x0000000120030050	Base: func2 (0x0000000120010010)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
