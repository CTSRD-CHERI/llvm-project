...
// CHECK: [[#%.16x,__MAN_MACROS_ADDR:]] g     O .data.rel.ro		 0000000000000440 __man_macros
// CHECK: [[#%.16x,MAN_MACROS_ADDR:]] g     O .data.rel.ro		 0000000000000010 man_macros

// CHECK-LABEL: CAPABILITY RELOCATION RECORDS:
// CHECK:       [[#MAN_MACROS_ADDR]] RODATA  [[#__MAN_MACROS_ADDR-0x2d80]] {{\[}}[[#__MAN_MACROS_ADDR]]-[[#__MAN_MACROS_ADDR+0x440]]]
