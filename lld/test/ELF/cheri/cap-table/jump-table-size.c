...
// RUN: %cheri_purecap_cc1 -mllvm -mxcaptable -emit-obj -O2 -mllvm -cheri-cap-table %s -o %t.o
...
// TODO-EXE-DAG: 0000000120030000 l    d  .cap_table		 00000010 .hidden .cap_table
// EXE-DAG: 0000000120030000 l       .cap_table		 00000010 .hidden .LJTI0_0@CAPTABLE
