...
// STATIC-NEXT:     0x030630 (callbacks)     Base: 0x203f0 (default_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030640 Base: 0x20478 (static_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030650 Base: 0x203f0 (default_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030660 Base: 0x20478 (static_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030670 (default_callback@CAPTABLE) Base: 0x203f0 (default_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030680 (check_if_default@CAPTABLE) Base: 0x20600 (check_if_default) Length: {{.+}} Perms: Function
// STATIC-NEXT:     0x030690 (static_callback@CAPTABLE.2) Base: 0x20478 (static_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x0306a0 (callbacks@CAPTABLE.3) Base: 0x30630 (callbacks) Length: 64 Perms: Constant
// STATIC-NEXT:  ]
