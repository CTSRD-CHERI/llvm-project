...
// DISAS: 0000000000000020: R_MIPS_CHERI_CAPTAB20/R_MIPS_NONE/R_MIPS_NONE default_callback
...
// CHECK-NEXT:   0x{{.+}} (check_if_default@CAPTABLE) Base: 0x{{.+}} (check_if_default) Length: {{.+}} Perms: Function
// CHECK-NEXT:   0x{{.+}} (callbacks@CAPTABLE.3) Base: 0x{{.+}} (callbacks) Length: 64 Perms: Constant
// CHECK-NEXT: ]
...
// STATIC-NEXT:     0x030600 (callbacks)     Base: 0x203c0 (default_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030610 Base: 0x20448 (static_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030620 Base: 0x203c0 (default_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030630 Base: 0x20448 (static_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030640 (default_callback@CAPTABLE) Base: 0x203c0 (default_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030650 (check_if_default@CAPTABLE) Base: 0x205d0 (check_if_default) Length: {{.+}} Perms: Function
// STATIC-NEXT:     0x030660 (static_callback@CAPTABLE.2) Base: 0x20448 (static_callback) Length: 12 Perms: Function
// STATIC-NEXT:     0x030670 (callbacks@CAPTABLE.3) Base: 0x30600 (callbacks) Length: 64 Perms: Constant
// STATIC-NEXT:  ]
