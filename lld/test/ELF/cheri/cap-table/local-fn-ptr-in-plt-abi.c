...
// STATIC-NEXT:     0x0303c0 (return1@CAPTABLE.0) Base: 0x20368 (return1) Length: 12 Perms: Function
// STATIC-NEXT:     0x0303d0 (use_callback@CAPTABLE) Base: 0x20380 (use_callback) Length: {{[0-9]+}} Perms: Function
// STATIC-NEXT:     0x0303e0 (global_return2@CAPTABLE) Base: 0x202f0 (global_return2) Length: 12 Perms: Function
// STATIC-NEXT:  ]
