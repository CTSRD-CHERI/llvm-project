...
// STATIC-NEXT:     0x0304d0 (return1@CAPTABLE.0) Base: 0x20478 (return1+0) Length: 12 Perms: Function
// STATIC-NEXT:     0x0304e0 (use_callback@CAPTABLE) Base: 0x20490 (use_callback+0) Length: {{[0-9]+}} Perms: Function
// STATIC-NEXT:     0x0304f0 (global_return2@CAPTABLE) Base: 0x20400 (global_return2+0) Length: 12 Perms: Function
// STATIC-NEXT:  ]
