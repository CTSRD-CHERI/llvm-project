...
// STATIC-NEXT:     0x030400 (return1@CAPTABLE.0) Base: 0x203a8 (return1+0) Length: 12 Perms: Function
// STATIC-NEXT:     0x030410 (use_callback@CAPTABLE) Base: 0x203c0 (use_callback+0) Length: {{[0-9]+}} Perms: Function
// STATIC-NEXT:     0x030420 (global_return2@CAPTABLE) Base: 0x20330 (global_return2+0) Length: 12 Perms: Function
// STATIC-NEXT:  ]
