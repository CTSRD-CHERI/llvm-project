...
static int64_t getTlsTgotOffset(const Compartment *c, const Symbol &s) {
  // XXX: Factor in offset of TGOT itself due to prior compartments
  return s.getTgotOffset(c);
}
