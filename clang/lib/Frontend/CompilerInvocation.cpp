...
static bool ParseCodeGenArgs(CodeGenOptions &Opts, ArgList &Args, InputKind IK,
  ...
  // XXXAR: If we don't enable new struct path TBAA we get LLVM verifier issues
  // when compiling files containing recursive cheri ccall
  Opts.NewStructPathTBAA = !Args.hasArg(OPT_no_struct_path_tbaa) &&
    (Args.hasArg(OPT_new_struct_path_tbaa) || Triple.getArch() == llvm::Triple::cheri);
