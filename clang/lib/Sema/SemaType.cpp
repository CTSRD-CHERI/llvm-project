...
static ParsedAttr::Kind getAttrListKind(AttributedType::Kind kind) {
  ...
  case AttributedType::attr_cheri_ccall:
    return ParsedAttr::AT_CHERICCall;
  case AttributedType::attr_cheri_ccallback:
    return ParsedAttr::AT_CHERICCallback;
  case AttributedType::attr_cheri_ccallee:
    return ParsedAttr::AT_CHERICCallee;
  ...
  case AttributedType::attr_cheri_capability:
    return ParsedAttr::AT_CHERICapability;
  case AttributedType::attr_memory_address:
    return ParsedAttr::AT_MemoryAddress;
