...
CGOpenMPRuntimeNVPTX::createNVPTXRuntimeFunction(unsigned Function) {
  ...
  case OMPRTL_NVPTX__kmpc_nvptx_teams_reduce_nowait_v2: {
    ...
    llvm::Type *TypeParams[] = {getIdentTyPointerTy(),
                                ...
                                ShuffleReduceFnTy->getPointerTo(DefaultAS),
                                InterWarpCopyFnTy->getPointerTo(DefaultAS),
                                GlobalListFnTy->getPointerTo(DefaultAS),
                                GlobalListFnTy->getPointerTo(DefaultAS),
                                GlobalListFnTy->getPointerTo(DefaultAS),
                                GlobalListFnTy->getPointerTo(DefaultAS)};
    auto *FnTy =
...
void CGOpenMPRuntimeNVPTX::emitReduction(
  ...
  llvm::Function *ReductionFn = emitReductionFunction(
      Loc, CGF.ConvertTypeForMem(ReductionArrayTy)->getPointerTo(DefaultAS), Privates,
...
CGOpenMPRuntimeNVPTX::getParameterAddress(CodeGenFunction &CGF,
  ...
  unsigned NativePointeeAddrSpace =
      CGF.CGM.getTargetAddressSpace(NativePointeeTy.getAddressSpace());
