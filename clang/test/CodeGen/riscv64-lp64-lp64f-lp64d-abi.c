...
// CHECK-LABEL: define dso_local zeroext i1 @f_scalar_0(i1 zeroext %x)
_Bool f_scalar_0(_Bool x) { return x; }

// CHECK-LABEL: define dso_local signext i8 @f_scalar_1(i8 signext %x)
int8_t f_scalar_1(int8_t x) { return x; }

// CHECK-LABEL: define dso_local zeroext i8 @f_scalar_2(i8 zeroext %x)
uint8_t f_scalar_2(uint8_t x) { return x; }

// CHECK-LABEL: define dso_local signext i32 @f_scalar_3(i32 signext %x)
uint32_t f_scalar_3(int32_t x) { return x; }

// CHECK-LABEL: define dso_local i64 @f_scalar_4(i64 %x)
int64_t f_scalar_4(int64_t x) { return x; }

// CHECK-LABEL: define dso_local float @f_fp_scalar_1(float %x)
float f_fp_scalar_1(float x) { return x; }

// CHECK-LABEL: define dso_local double @f_fp_scalar_2(double %x)
double f_fp_scalar_2(double x) { return x; }

// CHECK-LABEL: define dso_local fp128 @f_fp_scalar_3(fp128 %x)
...
// CHECK-LABEL: define dso_local void @f_agg_tiny(i64 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_tiny_v4i16(i64 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_tiny_v1i64(i64 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_agg_small([2 x i64] %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_small_v8i16(i128 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_small_v1i128(i128 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_agg_small_aligned(i128 %x.coerce)
void f_agg_small_aligned(struct small_aligned x) {
  x.a += x.a;
}

// CHECK-LABEL: define dso_local i128 @f_agg_small_aligned_ret(i128 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_agg_large(%struct.large* %x)
...
// argument
// CHECK-LABEL: define dso_local void @f_agg_large_ret(%struct.large* noalias sret %agg.result, i32 signext %i, i8 signext %j)
...
// CHECK-LABEL: define dso_local void @f_vec_large_v32i8(<32 x i8>* %0)
void f_vec_large_v32i8(v32i8 x) {
  x[0] = x[7];
}

// CHECK-LABEL: define dso_local void @f_vec_large_v32i8_ret(<32 x i8>* noalias sret %agg.result)
...
// CHECK-LABEL: define dso_local signext i32 @f_scalar_stack_1(i64 %a.coerce, [2 x i64] %b.coerce, i128 %c.coerce, %struct.large* %d, i8 zeroext %e, i8 signext %f, i8 %g, i8 %h)
...
// CHECK-LABEL: define dso_local signext i32 @f_scalar_stack_2(i32 signext %a, i128 %b, i64 %c, fp128 %d, <32 x i8>* %0, i8 zeroext %f, i8 %g, i8 %h)
...
// CHECK-LABEL: define dso_local void @f_scalar_stack_3(%struct.large* noalias sret %agg.result, i32 signext %a, i128 %b, fp128 %c, <32 x i8>* %0, i8 zeroext %e, i8 %f, i8 %g)
...
// CHECK-LABEL: define dso_local signext i32 @f_va_1(i8* %fmt, ...) {{.*}} {
