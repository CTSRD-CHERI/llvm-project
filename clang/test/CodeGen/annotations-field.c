...
// CHECK-NEXT: call i8* @llvm.ptr.annotation.p0i8.p0i8({{.*}}str{{.*}}str{{.*}}i32 8, i8* null)
// CHECK-NEXT: bitcast i8* {{.*}} to i32*
// CHECK-NEXT: bitcast i32* {{.*}} to i8*
// CHECK-NEXT: call i8* @llvm.ptr.annotation.p0i8.p0i8({{.*}}str{{.*}}str{{.*}}i32 8, i8* null)
// CHECK-NEXT: bitcast i8* {{.*}} to i32*
    gf.v = argc;
// CHECK: call i8* @llvm.ptr.annotation.p0i8.p0i8(i8* bitcast (%struct.foo* @gf to i8*), {{.*}}str{{.*}}str{{.*}}i32 8, i8* null)
    return 0;
}
