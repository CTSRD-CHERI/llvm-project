...
// CHECK: @.str = private unnamed_addr constant [4 x i8] c"cls\00", align 1
// CHECK: @.str.1 = private unnamed_addr constant [4 x i8] c"foo\00", align 1
// CHECK: @.sandbox_required_method.cls.foo = global { i64, [4 x i8]*, [4 x i8]*, i64*, i64 } { i64 0, [4 x i8]* @.str, [4 x i8]* @.str.1, i64* @__cheri_method.cls.foo, i64 0 }, section "__cheri_sandbox_required_methods", comdat
...
// CHECK: @.str.2 = private unnamed_addr constant [5 x i8] c"fish\00", align 1
// CHECK: @.sandbox_provided_method.cls.fish = global { i64, [4 x i8]*, [5 x i8]*, void ()** } { i64 0, [4 x i8]* @.str, [5 x i8]* @.str.2, void ()** @__cheri_callee_method.cls.fish }, section "__cheri_sandbox_provided_methods", comdat
