...
int addrof_label_in_static(void) {
  ...
  // COMMON: @addrof_label_in_static.b = internal addrspace(200) global ptr addrspace(200) blockaddress(@addrof_label_in_static, %label1)
  // COMMON-LABEL: define dso_local signext i32 @addrof_label_in_static()
  // COMMON: load ptr addrspace(200), ptr addrspace(200) @addrof_label_in_static.b
  goto *b;
label1:
  return 2;
}
...
int addrof_label_in_local(void) {
  ...
  // COMMON: store ptr addrspace(200) blockaddress(@addrof_label_in_local, %label2), ptr addrspace(200) [[D_ADDR:%.+]], align
  goto *d;
label2:
  return 2;
}
