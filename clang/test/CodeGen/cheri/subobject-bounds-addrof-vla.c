...
void test2(void* ptr) {
  ...
  do_stuff_untyped(&global_vn); // expected-remark{{not setting bounds for 'struct VLAContainerNoLength' (has flexible array member)}}
  do_stuff_untyped(&vn->buf); // expected-remark{{not setting bounds for 'struct ArbitraryLengthCharArray' (has flexible array member)}}
  do_stuff_untyped(&vn->buf.data); // expected-remark{{not setting bounds for 'char []' (incomplete type)}}
  struct VLAContainerLen0* v0 = (struct VLAContainerLen0*)ptr;
  do_stuff_untyped(&global_v0); // expected-remark{{not setting bounds for 'struct VLAContainerLen0' (has flexible array member)}}
  do_stuff_untyped(&v0->buf); // expected-remark{{not setting bounds for 'struct ZeroLengthCharArray' (has flexible array member)}}
  do_stuff_untyped(&v0->buf.data);  // expected-remark{{not setting bounds for 'char [0]' (member is potential variable length array)}}
  struct VLAContainerLen1* v1 = (struct VLAContainerLen1*)ptr;
  do_stuff_untyped(&global_v1); // expected-remark{{not setting bounds for 'struct VLAContainerLen1' (has flexible array member)}}
  do_stuff_untyped(&v1->buf); // expected-remark{{not setting bounds for 'struct LengthOneCharArray' (has flexible array member)}}
...
void test_maybe_vla(void) {
  MaybeVLA<0> mvla0;
  do_stuff_reference(mvla0); // expected-remark{{not setting bounds for 'MaybeVLA<0>' (has flexible array member)}}
  do_stuff_untyped(&mvla0); // expected-remark{{not setting bounds for 'MaybeVLA<0>' (has flexible array member)}}
  do_stuff_reference(mvla0.data); // expected-remark{{not setting bounds for 'char [0]' (member is potential variable length array)}}
  do_stuff_untyped(&mvla0.data);  // expected-remark{{not setting bounds for 'char [0]' (member is potential variable length array)}}

  MaybeVLA<1> mvla1;
  do_stuff_reference(mvla1); // expected-remark{{not setting bounds for 'MaybeVLA<1>' (has flexible array member)}}
  do_stuff_untyped(&mvla1); // expected-remark{{not setting bounds for 'MaybeVLA<1>' (has flexible array member)}}
  do_stuff_reference(mvla1.data);  // expected-remark{{not setting bounds for 'char [1]' (member is potential variable length array)}}
  do_stuff_untyped(&mvla1.data); // expected-remark{{not setting bounds for 'char [1]' (member is potential variable length array)}}
