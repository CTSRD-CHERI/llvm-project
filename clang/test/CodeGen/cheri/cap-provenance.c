...
// CHECK-NEXT:    call void @check(i8 addrspace(200)* [[RESULT]]) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-SAME: (i8 addrspace(200)* [[ARG:%.*]], i8 addrspace(200)* [[ARG_PTR:%.*]]) local_unnamed_addr addrspace(200)
// CHECK-NEXT:  entry:
// CHECK-NEXT:    call void @check(i8 addrspace(200)* [[ARG:%.*]]) #4
// CHECK-NEXT:    call void @check(i8 addrspace(200)* [[ARG_PTR:%.*]]) #4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call void @check(i8 addrspace(200)* nonnull [[INCDEC_PTR]]) #4
// CHECK-NEXT:    call void @check(i8 addrspace(200)* [[TMP0]]) #4
// CHECK-NEXT:    call void @check(i8 addrspace(200)* nonnull [[INCDEC_PTR]]) #4
// CHECK-NEXT:    ret void
//
