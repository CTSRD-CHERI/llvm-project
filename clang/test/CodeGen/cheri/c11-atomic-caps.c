...
// RUN: %cheri_cc1 -std=c11 -o - -emit-llvm -O1 %s -verify=expected,hybrid | FileCheck %s --check-prefix=HYBRID
// RUNTODO: %riscv64_cheri_cc1 -std=c11 -o - -emit-llvm -O1 -verify=expected,hybrid %s | FileCheck %s --check-prefix=HYBRID
...
// HYBRID-SAME: (i8 addrspace(200)** [[F:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[F]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_load_cap(i8* [[TMP0]], i32 signext 5) #3
...
// HYBRID-SAME: (i8 addrspace(200)** [[F:%.*]], i8 addrspace(200)* [[VALUE:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[F]] to i8*
// HYBRID-NEXT:    call void @__atomic_store_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
...
// HYBRID-SAME: (i8 addrspace(200)** nocapture [[F:%.*]], i8 addrspace(200)* [[VALUE:%.*]]) local_unnamed_addr #1
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    store i8 addrspace(200)* [[VALUE]], i8 addrspace(200)** [[F]], align 16, !tbaa !2
// HYBRID-NEXT:    ret void
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[F]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_exchange_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-SAME: (i64 addrspace(200)** [[F:%.*]], i64 addrspace(200)* [[VALUE:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i64 addrspace(200)** [[F]] to i8*
// HYBRID-NEXT:    [[TMP1:%.*]] = bitcast i64 addrspace(200)* [[VALUE]] to i8 addrspace(200)*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_exchange_cap(i8* [[TMP0]], i8 addrspace(200)* [[TMP1]], i32 signext 5) #3
// HYBRID-NEXT:    [[TMP2:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to i64 addrspace(200)*
...
// HYBRID-SAME: (i8 addrspace(200)** [[F:%.*]], i8 addrspace(200)** [[EXP:%.*]], i8 addrspace(200)* [[NEW:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[F]] to i8*
// HYBRID-NEXT:    [[TMP1:%.*]] = bitcast i8 addrspace(200)** [[EXP]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call zeroext i1 @__atomic_compare_exchange_cap(i8* [[TMP0]], i8* [[TMP1]], i8 addrspace(200)* [[NEW]], i32 signext 0, i32 signext 0) #3
...
// HYBRID-SAME: (i8 addrspace(200)** [[PTR:%.*]], i8 addrspace(200)* [[VALUE:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_add_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-SAME: (i64 addrspace(200)** [[PTR:%.*]], i8 addrspace(200)* [[VALUE:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
...
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_add_cap(i8* [[TMP3]], i8 addrspace(200)* [[TMP2]], i32 signext 5) #3
...
// HYBRID-SAME: (i64 addrspace(200)** [[PTR:%.*]], i16 signext [[VALUE:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
...
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_add_cap(i8* [[TMP2]], i8 addrspace(200)* [[TMP1]], i32 signext 5) #3
...
// HYBRID-SAME: (i8 addrspace(200)** [[PTR:%.*]], i16 signext [[VALUE:%.*]]) local_unnamed_addr #0
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[CONV:%.*]] = sext i16 [[VALUE]] to i64
// HYBRID-NEXT:    [[TMP0:%.*]] = getelementptr i8, i8 addrspace(200)* null, i64 [[CONV]]
// HYBRID-NEXT:    [[TMP1:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_add_cap(i8* [[TMP1]], i8 addrspace(200)* [[TMP0]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_sub_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:    [[TMP2:%.*]] = getelementptr i8, i8 addrspace(200)* null, i64 [[TMP1]]
// HYBRID-NEXT:    [[TMP3:%.*]] = bitcast i64 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_sub_cap(i8* [[TMP3]], i8 addrspace(200)* [[TMP2]], i32 signext 5) #3
// HYBRID-NEXT:    [[TMP4:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to i64 addrspace(200)*
// HYBRID-NEXT:    ret i64 addrspace(200)* [[TMP4]]
//
...
// HYBRID-NEXT:    [[TMP1:%.*]] = getelementptr i8, i8 addrspace(200)* null, i64 [[TMP0]]
// HYBRID-NEXT:    [[TMP2:%.*]] = bitcast i64 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_sub_cap(i8* [[TMP2]], i8 addrspace(200)* [[TMP1]], i32 signext 5) #3
// HYBRID-NEXT:    [[TMP3:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to i64 addrspace(200)*
// HYBRID-NEXT:    ret i64 addrspace(200)* [[TMP3]]
//
...
// HYBRID-NEXT:    [[TMP0:%.*]] = getelementptr i8, i8 addrspace(200)* null, i64 [[CONV]]
// HYBRID-NEXT:    [[TMP1:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_sub_cap(i8* [[TMP1]], i8 addrspace(200)* [[TMP0]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_and_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_or_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_xor_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_umax_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
...
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)** [[PTR]] to i8*
// HYBRID-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @__atomic_fetch_umin_cap(i8* [[TMP0]], i8 addrspace(200)* [[VALUE]], i32 signext 5) #3
// HYBRID-NEXT:    ret i8 addrspace(200)* [[CALL]]
//
