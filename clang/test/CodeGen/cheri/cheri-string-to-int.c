...
// N64: @c = local_unnamed_addr global %struct.b { i64 ptrtoint (ptr @.str to i64) }, align 8

// PURECAP: @.str = private unnamed_addr addrspace(200) constant [4 x i8] c"123\00", align 1
// PURECAP: @c = local_unnamed_addr addrspace(200) global %struct.b { i64 ptrtoint (ptr addrspace(200) @.str to i64) }, align 8
