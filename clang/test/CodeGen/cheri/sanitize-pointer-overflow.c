...
// RUN: %riscv64_cheri_purecap_clang -c %s -fsanitize=cheri -fsanitize-trap=cheri -Xclang -disable-O0-optnone -S -emit-llvm -o - -fsanitize-undefined-strip-path-components=-1 \
// RUN:   | opt -S -mem2reg | FileCheck %s --check-prefixes=PURECAP,PURECAP-TRAP
