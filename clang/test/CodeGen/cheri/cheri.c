...
// PTRS: define dso_local noundef i32 @cheri_length_get(ptr nocapture noundef readnone
// PTRS: ret i32 -1
// PTRS: define dso_local noundef i32 @cheri_base_get(ptr nocapture noundef readnone
// PTRS: ret i32 -1
// PTRS: define dso_local noundef i32 @cheri_offset_get(ptr nocapture noundef readnone
// PTRS: ret i32 -1
// PTRS: define dso_local noundef ptr @cheri_offset_set(ptr noundef readnone returned{{( %.+)?}}, i32
// PTRS: ret ptr
// PTRS: define dso_local noundef i32 @cheri_type_get(ptr nocapture noundef readnone
// PTRS: ret i32 0
// PTRS: define dso_local noundef zeroext i16 @cheri_perms_get(ptr nocapture noundef readnone
// PTRS: ret i16 0
// PTRS: define dso_local noundef ptr @cheri_perms_and(ptr noundef readnone returned{{( %.+)?}}, i16 noundef zeroext
// PTRS: ret ptr
// PTRS: define dso_local noundef zeroext i16 @cheri_flags_get(ptr nocapture noundef readnone
// PTRS: ret i16 0
// PTRS: define dso_local noundef ptr @cheri_flags_set(ptr noundef readnone returned{{( %.+)?}}, i16 noundef zeroext
// PTRS: ret ptr
// PTRS: define dso_local noundef zeroext i1 @cheri_tag_get(ptr nocapture noundef readnone
// PTRS: ret i1 false
// PTRS: define dso_local noundef zeroext i1 @cheri_sealed_get(ptr nocapture noundef readnone
// PTRS: ret i1 false
...
// PTRS: ret ptr %[[TEMP1]]
// PTRS: define dso_local noundef ptr @cheri_cap_from_pointer(ptr nocapture noundef readnone{{( %.+)?}}, ptr noundef readnone returned{{( %.+)?}})
// PTRS: ret ptr
// PTRS: define dso_local noundef ptr @cheri_cap_to_pointer(ptr nocapture noundef readnone{{( %.+)?}}, ptr noundef readnone returned{{( %.+)?}})
// PTRS: ret ptr
