...
// HYBRID-NEXT: @global_cap_data_addr_uintcap_src_is_cap = global i8 addrspace(200)* addrspacecast (i8* @extern_data to i8 addrspace(200)*), align 16
// PURECAP-NEXT: @global_cap_data_addr_uintcap_src_is_cap = addrspace(200) global i8 addrspace(200)* @extern_data, align 16
...
// PURECAP-NEXT: @global_intcap_data_addr_cast_intcap = addrspace(200) global i8 addrspace(200)* @extern_data, align 16
...
// PURECAP-NEXT: @global_intcap_data_one_past_end_addr_cast_intcap = addrspace(200) global i8 addrspace(200)* getelementptr inbounds (i8, i8 addrspace(200)* @extern_data, i64 1), align 16
...
// PURECAP-NEXT: @global_intcap_data_plus_two_addr_cast_intcap = addrspace(200) global i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* @extern_data, i64 2), align 16
...
// PURECAP-NEXT: @global_intcap_fn_cast_addr = addrspace(200) global i8 addrspace(200)* bitcast (void () addrspace(200)* @extern_fn to i8 addrspace(200)*), align 16
...
// PURECAP-NEXT: @global_intcap_fn_plus_two_intcap_addr_intcap = addrspace(200) global i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* bitcast (void () addrspace(200)* @extern_fn to i8 addrspace(200)*), i64 2), align 16
...
// PURECAP-NEXT: @global_cap_data_addr_cast_intcap_one_past_end = addrspace(200) global i8 addrspace(200)* getelementptr inbounds (i8, i8 addrspace(200)* @extern_data, i64 1), align 16
