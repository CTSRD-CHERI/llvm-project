...
// CHECK: @x = dso_local addrspace(200) global i32 0, align 4
// CHECK: @longvalue = dso_local local_unnamed_addr addrspace(200) global i64 ptrtoint (i32 addrspace(200)* @x to i64), align 8
// CHECK: @uintcapvalue = dso_local local_unnamed_addr addrspace(200) global i8 addrspace(200)* bitcast (i32 addrspace(200)* @x to i8 addrspace(200)*), align [[#CAP_SIZE]]

__uintcap_t uintptr_constant_int = 1;
// CHECK: @uintptr_constant_int = dso_local addrspace(200) global i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 1), align [[#CAP_SIZE]]
__uintcap_t uintptr_constant_ptr = (__uintcap_t)&uintptr_constant_int;
// CHECK: @uintptr_constant_ptr = dso_local local_unnamed_addr addrspace(200) global i8 addrspace(200)* bitcast (i8 addrspace(200)* addrspace(200)* @uintptr_constant_int to i8 addrspace(200)*), align [[#CAP_SIZE]]
...
// @uintptr_array = dso_local addrspace(200) global <{ i64, i64, i8 addrspace(200)*, i64 }> <{ i64 3, i64 5246977, i8 addrspace(200)* bitcast (i8 addrspace(200)* addrspace(200)* @one_uintptr to i8 addrspace(200)*), i64 0 }>, align 16
// This bug resulted in qhooks.cpp being miscompiled (and I'm sure lots of other stuff too)

__uintcap_t uintptr_array[] = {
    // CHECK: @uintptr_array = dso_local local_unnamed_addr addrspace(200) global [4 x i8 addrspace(200)*]
    3,
...
// An array with a filler was also broken: @uintptr_array_2 = dso_local global <{ i64, i128, i128 }> <{ i64 1, i128 0, i128 0 }>, align 16
__uintcap_t uintptr_array_2[3] = {1};
// CHECK: @uintptr_array_2 = dso_local local_unnamed_addr addrspace(200) global [3 x i8 addrspace(200)*]
...
void *ptr_array[] = {
    ...
    (void *)0};
// CHECK: @ptr_array = dso_local local_unnamed_addr addrspace(200) global [4 x i8 addrspace(200)*] [i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 3), i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 5246977), i8 addrspace(200)* bitcast (i8 addrspace(200)* addrspace(200)* @uintptr_constant_int to i8 addrspace(200)*), i8 addrspace(200)* null]

// Using a struct with a single uintptr_t value happened to work correctly for ASM output
// but the IR was quite broken:
// @uintptr_struct_array = dso_local addrspace(200) global <{ { i64, [8 x i8] }, { i64, [8 x i8] }, %struct.uintptr_struct, { i64, [8 x i8] } }> <{ { i64, [8 x i8] } { i64 3, [8 x i8] undef }, { i64, [8 x i8] } { i64 5246977, [8 x i8] undef }, %struct.uintptr_struct { i8 addrspace(200)* bitcast (i8 addrspace(200)* addrspace(200)* @one_uintptr to i8 addrspace(200)*) }, { i64, [8 x i8] } { i64 0, [8 x i8] undef } }>, align 16
...
// CHECK: @one_uintptr_struct = dso_local local_unnamed_addr addrspace(200) global %struct.uintptr_struct { i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 123) }

struct uintptr_struct uintptr_struct_array[] = {
    // CHECK: @uintptr_struct_array = dso_local local_unnamed_addr addrspace(200) global [4 x %struct.uintptr_struct]
    {3},
...
// CHECK: @uintptr_bss = dso_local local_unnamed_addr addrspace(200) global i8 addrspace(200)* null, align [[#CAP_SIZE]]
// CHECK: @uintptr_array_bss = dso_local local_unnamed_addr addrspace(200) global [5 x i8 addrspace(200)*] zeroinitializer, align [[#CAP_SIZE]]
// CHECK: @uintptr_struct_bss = dso_local local_unnamed_addr addrspace(200) global %struct.uintptr_struct zeroinitializer, align [[#CAP_SIZE]]
