...
void *castp(__intcap a)
{
  ...
  // CHECK: inttoptr i64 [[CTOTPR]] to ptr
...
void negativeint()
{
  // CHECK: store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 -5), ptr %minus
  __intcap minus = -5;
}
...
void largeint()
{
  // CHECK: store ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 4294967295), ptr %large
