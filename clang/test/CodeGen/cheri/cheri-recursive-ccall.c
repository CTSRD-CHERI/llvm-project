...
d(void) {
  d();
// CHECK-LABEL: define chericcallcc signext i32 @d()
...
// CHECK-NEXT: tail call chericcallcc signext i32 @cheri_invoke(i8 addrspace(200)* [[ARG1]], i8 addrspace(200)* [[ARG2]], i64 zeroext [[NUM]])
