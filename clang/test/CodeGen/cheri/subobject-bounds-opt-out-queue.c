...
test_tailq_macros(void)
{
        ...
        TAILQ_INIT(&bufhead);
        // default-remark@-1 {{sub-object bounds for pointer to 'struct bufarea * __capability' to 16 bytes}}
        ...
        // default-remark@-1 3 {{sub-object bounds for pointer to 'struct bufarea * __capability' to 16 bytes}}
        // opt-out-remark-re@-2 2 {{not setting bounds for 'struct bufarea::(anonymous at {{.+}})' (base type declaration has opt-out attribute)}}
        // opt-out-remark@-3 {{not setting bounds for 'struct buflist' (base type declaration has opt-out attribute)}}
        ...
        // default-remark@-1 4 {{sub-object bounds for pointer to 'struct bufarea * __capability' to 16 bytes}}
