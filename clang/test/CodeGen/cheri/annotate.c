...
// CHECK-NEXT: @.str.5 = private unnamed_addr addrspace(200) constant [9 x i8] c"function\00", section "llvm.metadata"
...
// CHECK-SAME: { ptr addrspace(200) @annotated_global, ptr addrspace(200) @.str, ptr addrspace(200) @.str.1
// CHECK-SAME: i32 [[ANNOTATED_GLOBAL_LINE:9]], ptr addrspace(200) null },
// CHECK-SAME: { ptr addrspace(200), ptr addrspace(200), ptr addrspace(200), i32, ptr addrspace(200) } { ptr addrspace(200) @annotated_function, ptr addrspace(200) @.str.5, ptr addrspace(200) @.str.1
// CHECK-SAME: i32 [[ANNOTATED_FUNC_LINE:7]], ptr addrspace(200) null }], section "llvm.metadata"
