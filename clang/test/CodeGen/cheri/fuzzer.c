...
// MIPS-NEXT:    call void @llvm.lifetime.start.p0i8(i64 10, i8* nonnull [[TMP2]]) #[[ATTR6:[0-9]+]]
// MIPS-NEXT:    [[CALL:%.*]] = call i8* @gets(i8* nonnull [[TMP2]]) #[[ATTR7:[0-9]+]]
// MIPS-NEXT:    [[CALL2:%.*]] = call signext i32 @puts(i8* nonnull [[TMP2]]) #[[ATTR7]]
// MIPS-NEXT:    call void @llvm.lifetime.end.p0i8(i64 10, i8* nonnull [[TMP2]]) #[[ATTR6]]
// MIPS-NEXT:    ret i32 0
//
...
// PURECAP-NEXT:    call void @llvm.lifetime.start.p200i8(i64 10, i8 addrspace(200)* nonnull [[TMP2]]) #[[ATTR6:[0-9]+]]
// PURECAP-NEXT:    [[CALL:%.*]] = call i8 addrspace(200)* @gets(i8 addrspace(200)* nonnull [[TMP2]]) #[[ATTR7:[0-9]+]]
// PURECAP-NEXT:    [[CALL2:%.*]] = call signext i32 @puts(i8 addrspace(200)* nonnull [[TMP2]]) #[[ATTR7]]
// PURECAP-NEXT:    call void @llvm.lifetime.end.p200i8(i64 10, i8 addrspace(200)* nonnull [[TMP2]]) #[[ATTR6]]
...
// MIPS-NEXT:    [[CALL:%.*]] = tail call signext i32 @fail1() #[[ATTR8:[0-9]+]]
...
// MIPS-NEXT:    [[CALL3:%.*]] = tail call signext i32 @fail2() #[[ATTR8]]
// MIPS-NEXT:    br label [[RETURN]]
// MIPS:       if.end4:
...
// PURECAP-NEXT:    [[CALL:%.*]] = tail call signext i32 @fail1() #[[ATTR8:[0-9]+]]
...
// PURECAP-NEXT:    [[CALL3:%.*]] = tail call signext i32 @fail2() #[[ATTR8]]
// PURECAP-NEXT:    br label [[RETURN]]
// PURECAP:       if.end4:
