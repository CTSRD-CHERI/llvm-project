...
// CLEAR-PERM2-LABEL: @return_global_int(
...
// CLEAR-PERM2-LABEL: @return_global_subobject(
// CLEAR-PERM2-NEXT:  entry:
// CLEAR-PERM2-NEXT:    [[TMP0:%.*]] = tail call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* bitcast (%struct.foo addrspace(200)* @global_foo to i8 addrspace(200)*), i64 4)
// CLEAR-PERM2-NEXT:    [[CUR_LEN:%.*]] = tail call i64 @llvm.cheri.cap.length.get.i64(i8 addrspace(200)* bitcast (%struct.foo addrspace(200)* @global_foo to i8 addrspace(200)*))
// CLEAR-PERM2-NEXT:    [[NEW_LEN:%.*]] = tail call i64 @llvm.cheri.cap.length.get.i64(i8 addrspace(200)* [[TMP0]])
// CLEAR-PERM2-NEXT:    [[NEW_LEN1:%.*]] = tail call i8 addrspace(200)* @llvm.cheri.cap.perms.and.i64(i8 addrspace(200)* [[TMP0]], i64 -131073)
// CLEAR-PERM2-NEXT:    [[NEW_BOUNDS_LESS:%.*]] = icmp ult i64 [[NEW_LEN]], [[CUR_LEN]]
// CLEAR-PERM2-NEXT:    [[RESULT:%.*]] = select i1 [[NEW_BOUNDS_LESS]], i8 addrspace(200)* [[NEW_LEN1]], i8 addrspace(200)* [[TMP0]]
