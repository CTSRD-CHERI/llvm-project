...
// RUN: %cheri256_cc1 -o - -O0 -emit-llvm %s | FileCheck %s --check-prefix=HYBRID
// RUN: %cheri128_purecap_cc1 -o - -O0 -emit-llvm %s | FileCheck %s --check-prefix=PURECAP128
// RUN: %cheri256_purecap_cc1 -o - -O0 -emit-llvm %s | FileCheck %s --check-prefix=PURECAP256
...
//
// PURECAP256-LABEL: @clear_cache(
// PURECAP256-NEXT:  entry:
// PURECAP256-NEXT:    [[TMP0:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* @start, align 32
// PURECAP256-NEXT:    [[TMP1:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* @end, align 32
// PURECAP256-NEXT:    call void @llvm.clear_cache.p200i8(i8 addrspace(200)* [[TMP0]], i8 addrspace(200)* [[TMP1]])
