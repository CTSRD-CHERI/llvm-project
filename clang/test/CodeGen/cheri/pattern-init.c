...
// RUN: %cheri256_cc1 -emit-llvm %s -o - -ftrivial-auto-var-init=pattern | FileCheck %s --check-prefix=MIPS64C256
...
//
// MIPS64C256-LABEL: @get_uninitialised_cap(
// MIPS64C256-NEXT:  entry:
// MIPS64C256-NEXT:    [[CAP:%.*]] = alloca i32 addrspace(200)*, align 32
// MIPS64C256-NEXT:    store i32 addrspace(200)* bitcast (i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 -6148914691236517206) to i32 addrspace(200)*), i32 addrspace(200)** [[CAP]], align 32
// MIPS64C256-NEXT:    [[TMP0:%.*]] = load i32 addrspace(200)*, i32 addrspace(200)** [[CAP]], align 32
// MIPS64C256-NEXT:    ret i32 addrspace(200)* [[TMP0]]
//
...
//
// MIPS64C256-LABEL: @get_uninitialised_struct(
// MIPS64C256-NEXT:  entry:
// MIPS64C256-NEXT:    [[TMP0:%.*]] = bitcast %struct.S* [[AGG_RESULT:%.*]] to i8*
// MIPS64C256-NEXT:    call void @llvm.memset.p0i8.i64(i8* align 32 [[TMP0]], i8 0, i64 128, i1 false)
// MIPS64C256-NEXT:    [[TMP1:%.*]] = getelementptr inbounds [[STRUCT_S:%.*]], %struct.S* [[AGG_RESULT]], i32 0, i32 0
// MIPS64C256-NEXT:    store i16 addrspace(200)* bitcast (i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 -6148914691236517206) to i16 addrspace(200)*), i16 addrspace(200)** [[TMP1]], align 32
// MIPS64C256-NEXT:    [[TMP2:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[AGG_RESULT]], i32 0, i32 1
// MIPS64C256-NEXT:    [[TMP3:%.*]] = getelementptr inbounds [2 x i8 addrspace(200)*], [2 x i8 addrspace(200)*]* [[TMP2]], i32 0, i32 0
// MIPS64C256-NEXT:    store i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 -6148914691236517206), i8 addrspace(200)** [[TMP3]], align 32
// MIPS64C256-NEXT:    [[TMP4:%.*]] = getelementptr inbounds [2 x i8 addrspace(200)*], [2 x i8 addrspace(200)*]* [[TMP2]], i32 0, i32 1
// MIPS64C256-NEXT:    store i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 -6148914691236517206), i8 addrspace(200)** [[TMP4]], align 32
// MIPS64C256-NEXT:    [[TMP5:%.*]] = getelementptr inbounds [[STRUCT_S]], %struct.S* [[AGG_RESULT]], i32 0, i32 2
// MIPS64C256-NEXT:    [[TMP6:%.*]] = getelementptr inbounds [[UNION_ANON:%.*]], %union.anon* [[TMP5]], i32 0, i32 0
// MIPS64C256-NEXT:    store i8 addrspace(200)* getelementptr (i8, i8 addrspace(200)* null, i64 -6148914691236517206), i8 addrspace(200)** [[TMP6]], align 32
// MIPS64C256-NEXT:    ret void
//
