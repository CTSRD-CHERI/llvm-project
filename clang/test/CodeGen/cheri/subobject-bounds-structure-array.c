...
// RUN: %cheri_purecap_cc1 -cheri-bounds=everywhere-unsafe -O2 -emit-llvm %s -o - -Wcheri-subobject-bounds -Rcheri-subobject-bounds -verify | %cheri_FileCheck %s
...
// CHECK-NEXT:    [[TMP0:%.*]] = load i32 addrspace(200)*, i32 addrspace(200)* addrspace(200)* [[BUF]], align [[$CAP_SIZE]], !tbaa !10
...
// CHECK-NEXT:    tail call void @llvm.memcpy.p200i8.p200i8.i64(i8 addrspace(200)* align [[$CAP_SIZE]] [[TMP0]], i8 addrspace(200)* align [[$CAP_SIZE]] [[TMP1]], i64 {{48|96}}, i1 false), !tbaa.struct !13
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* nonnull [[TMP1]]) #10
...
// CHECK-NEXT:    [[V8_8_VECBLEND:%.*]] = shufflevector <8 x i32> [[V8_8_VEC_EXPAND]], <8 x i32> [[V8_0_VEC_EXPAND]], <8 x i32> <i32 8, i32 9, i32 2, i32 3, i32 undef, i32 undef, i32 undef, i32 undef>
...
// CHECK-NEXT:    [[V8_16_VECBLEND:%.*]] = shufflevector <8 x i32> [[V8_16_VEC_EXPAND]], <8 x i32> [[V8_8_VECBLEND]], <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 4, i32 5, i32 undef, i32 undef>
...
// CHECK-NEXT:    [[V8_24_VECBLEND:%.*]] = shufflevector <8 x i32> [[V8_24_VEC_EXPAND]], <8 x i32> [[V8_16_VECBLEND]], <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 6, i32 7>
...
// CHECK-NEXT:    ret i32 addrspace(200)* [[ARRAYDECAY]]
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = load [[STRUCT_MY_STRUCT28]] addrspace(200)*, [[STRUCT_MY_STRUCT28]] addrspace(200)* addrspace(200)* [[ARRAYIDX]], align [[$CAP_SIZE]], !tbaa !14
