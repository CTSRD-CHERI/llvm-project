...
// -Wcheri-subobject-bounds -Rcheri-subobject-bounds -verify | %cheri_FileCheck %s
// RUNs: %cheri_purecap_cc1 -cheri-bounds=subobject-safe  -O0 -emit-llvm %s -o /dev/null \
// RUNs:    -w -mllvm -debug-only="cheri-bounds" -mllvm -stats 2>&1 | FileCheck %s -check-prefix DBG -implicit-check-not cheri-bounds
...
// CHECK-SAME: (%struct.struct_with_array addrspace(200)* readonly [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #0
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%struct.struct_with_ptr addrspace(200)* nocapture readonly [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #4
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%struct.struct_vla addrspace(200)* [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%struct.struct_fake_vla1 addrspace(200)* [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%struct.struct_fake_vla2 addrspace(200)* [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (i32 signext [[LEN:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #2
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* [[TMP2]]) #10
...
// CHECK-SAME: (i32 inreg [[V4_COERCE:%.*]], i192 [[TMP0:%.*]], i64 inreg [[V8_COERCE0:%.*]], i64 inreg [[V8_COERCE1:%.*]], i64 inreg [[V8_COERCE2:%.*]], i64 inreg [[V8_COERCE3:%.*]]) local_unnamed_addr addrspace(200) #7
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (i64 signext [[INDEX:%.*]], i32 inreg [[V4_COERCE:%.*]], i128 [[TMP0:%.*]], i64 inreg [[V8_COERCE0:%.*]], i64 inreg [[V8_COERCE1:%.*]], i64 inreg [[V8_COERCE2:%.*]], i64 inreg [[V8_COERCE3:%.*]]) local_unnamed_addr addrspace(200) #7
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i32 [[V4_COERCE]] to <4 x i8>
...
// CHECK-SAME: ([10 x i32] addrspace(200)* readonly [[ARRAY:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #0
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([10 x i32] addrspace(200)* readnone [[ARRAY:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #8
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([10 x [5 x i32]] addrspace(200)* readnone [[ARRAY:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #8
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([10 x [5 x i32]] addrspace(200)* readonly [[ARRAY:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #0
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast [10 x [5 x i32]] addrspace(200)* [[ARRAY]] to i8 addrspace(200)*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* [[TMP0]], i64 200)
// CHECK-NEXT:    [[SUBSCRIPT_WITH_BOUNDS:%.*]] = bitcast i8 addrspace(200)* [[TMP1]] to [10 x [5 x i32]] addrspace(200)*
...
// CHECK-SAME: (%struct.my_struct21 addrspace(200)* [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%struct.my_struct21 addrspace(200)* nocapture readnone [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%struct.my_struct22 addrspace(200)* [[S:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (%union.my_union25 addrspace(200)* [[U:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #5
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #2
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #10
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* [[TMP0]]) #10
// CHECK-NEXT:    call void @llvm.lifetime.end.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #10
// CHECK-NEXT:    ret i32 0
//
...
// CHECK-SAME: (%struct.my_struct28 addrspace(200)* addrspace(200)* nocapture readonly [[ARRAY1:%.*]], i64 signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #9
// CHECK-NEXT:  entry:
...
// CHECK-SAME: (i64 signext [[INDEX1:%.*]], i64 signext [[INDEX2:%.*]]) local_unnamed_addr addrspace(200) #2
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[ARRAY23:%.*]] = alloca [100 x i8], align 1, addrspace(200)
// CHECK-NEXT:    [[ARRAY23_SUB:%.*]] = getelementptr inbounds [100 x i8], [100 x i8] addrspace(200)* [[ARRAY23]], i64 0, i64 0
// CHECK-NEXT:    call void @llvm.lifetime.start.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #10
...
// CHECK-SAME: (%struct.my_struct28 addrspace(200)* addrspace(200)* nocapture readonly [[ARRAY1:%.*]], i64 signext [[INDEX1:%.*]], i64 signext [[INDEX2:%.*]]) local_unnamed_addr addrspace(200) #9
// CHECK-NEXT:  entry:
