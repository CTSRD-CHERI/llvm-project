...
// CHECK-SAME: ([[STRUCT_STRUCT_WITH_ARRAY:%.*]] addrspace(200)* noundef readonly [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0:[0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_STRUCT_WITH_ARRAY:%.*]] addrspace(200)* noalias nocapture writeonly sret([[STRUCT_STRUCT_WITH_ARRAY]]) align 8 [[AGG_RESULT:%.*]], [[STRUCT_STRUCT_WITH_ARRAY]] addrspace(200)* nocapture noundef readonly [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2:[0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_STRUCT_WITH_PTR:%.*]] addrspace(200)* nocapture noundef readonly [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR4:[0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_STRUCT_WITH_PTR:%.*]] addrspace(200)* noalias nocapture writeonly sret([[STRUCT_STRUCT_WITH_PTR]]) align 16 [[AGG_RESULT:%.*]], [[STRUCT_STRUCT_WITH_PTR]] addrspace(200)* nocapture noundef readonly [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_STRUCT_VLA:%.*]] addrspace(200)* noundef [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5:[0-9]+]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_STRUCT_FAKE_VLA1:%.*]] addrspace(200)* noundef [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_STRUCT_FAKE_VLA2:%.*]] addrspace(200)* noundef [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* noundef [[TMP2]]) #[[ATTR11:[0-9]+]]
...
// CHECK-SAME: ([10 x i32] addrspace(200)* noundef readonly [[ARRAY:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([10 x [5 x i32]] addrspace(200)* noundef readnone [[ARRAY:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR10]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([10 x [5 x i32]] addrspace(200)* noundef readonly [[ARRAY:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR0]] {
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast [10 x [5 x i32]] addrspace(200)* [[ARRAY]] to i8 addrspace(200)*
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* [[TMP0]], i64 200)
// CHECK-NEXT:    [[SUBSCRIPT_WITH_BOUNDS:%.*]] = bitcast i8 addrspace(200)* [[TMP1]] to [10 x [5 x i32]] addrspace(200)*
...
// CHECK-SAME: ([[STRUCT_MY_STRUCT21:%.*]] addrspace(200)* noundef writeonly [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_MY_STRUCT21:%.*]] addrspace(200)* nocapture noundef readnone [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_MY_STRUCT22:%.*]] addrspace(200)* noundef writeonly [[S:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[UNION_MY_UNION25:%.*]] addrspace(200)* noundef writeonly [[U:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[UNION_MY_UNION25:%.*]] addrspace(200)* noalias writeonly sret([[UNION_MY_UNION25]]) align 8 [[AGG_RESULT:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR5]] {
// CHECK-NEXT:  entry:
...
// CHECK-NEXT:    call void @llvm.lifetime.start.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #[[ATTR11]]
...
// CHECK-NEXT:    call void @use_buf(i8 addrspace(200)* noundef [[TMP0]]) #[[ATTR11]]
// CHECK-NEXT:    call void @llvm.lifetime.end.p200i8(i64 100, i8 addrspace(200)* nonnull [[ARRAY23_SUB]]) #[[ATTR11]]
// CHECK-NEXT:    ret i32 0
//
...
// CHECK-SAME: ([[STRUCT_MY_STRUCT28:%.*]] addrspace(200)* addrspace(200)* nocapture noundef readonly [[ARRAY1:%.*]], i64 noundef signext [[INDEX:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2]] {
// CHECK-NEXT:  entry:
...
// CHECK-SAME: ([[STRUCT_MY_STRUCT28:%.*]] addrspace(200)* addrspace(200)* nocapture noundef readonly [[ARRAY1:%.*]], i64 noundef signext [[INDEX1:%.*]], i64 noundef signext [[INDEX2:%.*]]) local_unnamed_addr addrspace(200) #[[ATTR2]] {
// CHECK-NEXT:  entry:
