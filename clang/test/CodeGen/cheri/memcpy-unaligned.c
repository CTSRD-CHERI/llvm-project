...
void test_no_warn_for_non_caps(short* align2, int not_a_cap, __uintcap_t cap,
  ...
  // CHECK: call void @llvm.memcpy.p200i8.p200i8.i64(i8 addrspace(200)* align 2 %{{.+}}, i8 addrspace(200)* align 4 %{{.+}}, i64 4, i1 false)
  ...
  // expected-note@-2{{use __builtin_assume_aligned() or cast to __intcap_t*}}
  // CHECK: call void @llvm.memcpy.p200i8.p200i8.i64(i8 addrspace(200)* align 2 %{{.+}}, i8 addrspace(200)* align 16 %{{.+}}, i64 32, i1 false)
