...
// IEEE: call void @llvm.va_start.p0i8(i8* %{{[0-9a-zA-Z_.]+}})
...
// IEEE: call void @llvm.va_end.p0i8(i8* %{{[0-9a-zA-Z_.]+}})
...
// IBM: call void @llvm.va_start.p0i8(i8* %{{[0-9a-zA-Z_.]+}})
...
// IBM: call void @llvm.va_end.p0i8(i8* %{{[0-9a-zA-Z_.]+}})
