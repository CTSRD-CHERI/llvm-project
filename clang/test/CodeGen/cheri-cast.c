...
// RUN: %cheri_cc1 -DWITH_CHERI_CAST %s -emit-llvm -o - -O2 | FileCheck %s -check-prefixes BOTH,HYBRID -enable-var-scope
// RUN: %cheri_cc1 -DWITH_CHERI_CAST -target-abi purecap %s -emit-llvm -o - -O2 | FileCheck %s -check-prefixes BOTH,PURECAP -enable-var-scope
