...
// CHECK-LABEL: define dso_local i32 @f_scalar_3(i32 %x)
...
// CHECK-FORCEINT128-LABEL: define dso_local i128 @f_scalar_5(i128 %x)
...
// CHECK-LABEL: define dso_local void @f_agg_tiny(i32 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_tiny_v4i8(i32 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_tiny_v1i32(i32 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_agg_small([2 x i32] %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_small_v8i8(i64 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_vec_small_v1i64(i64 %x.coerce)
...
// CHECK-LABEL: define dso_local void @f_agg_small_aligned(i64 %x.coerce)
void f_agg_small_aligned(struct small_aligned x) {
  x.a += x.a;
}

// CHECK-LABEL: define dso_local i64 @f_agg_small_aligned_ret(i64 %x.coerce)
...
// argument
// CHECK-LABEL: define dso_local void @f_agg_large_ret(%struct.large* noalias sret %agg.result, i32 %i, i8 signext %j)
...
// CHECK-LABEL: define dso_local void @f_vec_large_v16i8(<16 x i8>* %0)
void f_vec_large_v16i8(v16i8 x) {
  x[0] = x[7];
}

// CHECK-LABEL: define dso_local void @f_vec_large_v16i8_ret(<16 x i8>* noalias sret %agg.result)
...
// CHECK-LABEL: define dso_local i32 @f_scalar_stack_1(i32 %a.coerce, [2 x i32] %b.coerce, i64 %c.coerce, %struct.large* %d, i8 zeroext %e, i8 signext %f, i8 %g, i8 %h)
...
// CHECK-LABEL: define dso_local void @f_scalar_stack_2(%struct.large* noalias sret %agg.result, i32 %a, i64 %b, i64 %c, fp128 %d, i8 zeroext %e, i8 %f, i8 %g)
struct large f_scalar_stack_2(int32_t a, int64_t b, int64_t c, long double d,
                              uint8_t e, int8_t f, uint8_t g) {
  return (struct large){a, e, f, g};
}

// CHECK-LABEL: define dso_local fp128 @f_scalar_stack_4(i32 %a, i64 %b, i64 %c, fp128 %d, i8 zeroext %e, i8 %f, i8 %g)
...
// CHECK-LABEL: define dso_local void @f_scalar_stack_5(double %a, i64 %b, double %c, i64 %d, i32 %e, i64 %f, float %g, double %h, fp128 %i)
void f_scalar_stack_5(double a, int64_t b, double c, int64_t d, int e,
                      int64_t f, float g, double h, long double i) {}

// CHECK-LABEL: define dso_local void @f_agg_stack(double %a, i64 %b, double %c, i64 %d, i32 %e.coerce, [2 x i32] %f.coerce, i64 %g.coerce, %struct.large* %h)
...
// CHECK-LABEL: define dso_local i32 @f_va_1(i8* %fmt, ...) {{.*}} {
...
// CHECK-LABEL: define dso_local i32 @f_va_4(i8* %fmt, ...) {{.*}} {
// CHECK:         [[FMT_ADDR:%.*]] = alloca i8*, align 4
// CHECK-NEXT:    [[VA:%.*]] = alloca i8*, align 4
