...
// RUN: %cheri_purecap_cc1 -o - -cheri-uintcap=offset -O3 -emit-llvm %s |  FileCheck '-D$UINTCAP_INTRIN=offset' %s -check-prefixes BROKEN-OPT -enable-var-scope
// RUN: %cheri_purecap_cc1 -o - -cheri-uintcap=addr -O3 -emit-llvm %s |  FileCheck %s '-D$UINTCAP_INTRIN=address' -check-prefixes BROKEN-OPT -enable-var-scope
...
// RUN: %cheri_purecap_cc1 -o - -cheri-uintcap=offset -cheri-data-dependent-provenance -O0 -emit-llvm %s | FileCheck '-D$UINTCAP_INTRIN=offset' %s -check-prefixes WORKS -enable-var-scope
// RUN: %cheri_purecap_cc1 -o - -cheri-uintcap=offset -cheri-data-dependent-provenance -O3 -emit-llvm %s | FileCheck '-D$UINTCAP_INTRIN=offset' %s -check-prefixes WORKS-OPT -enable-var-scope
// RUN: %cheri_purecap_cc1 -o - -cheri-uintcap=addr -cheri-data-dependent-provenance -O0 -emit-llvm %s | FileCheck '-D$UINTCAP_INTRIN=address' %s -check-prefixes WORKS -enable-var-scope
// RUN: %cheri_purecap_cc1 -o - -cheri-uintcap=addr -cheri-data-dependent-provenance -O3 -emit-llvm %s | FileCheck '-D$UINTCAP_INTRIN=address' %s -check-prefixes WORKS-OPT -enable-var-scope
...
// WORKS-NEXT:  entry:
// WORKS-NEXT:    [[MTX_ADDR:%.*]] = alloca i8 addrspace(200)*, align 16, addrspace(200)
// WORKS-NEXT:    store i8 addrspace(200)* [[MTX:%.*]], i8 addrspace(200)* addrspace(200)* [[MTX_ADDR]], align 16
// WORKS-NEXT:    [[TMP0:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* [[MTX_ADDR]], align 16
...
// WORKS-NEXT:    [[TMP7:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* [[MTX_ADDR]], align 16
...
// WORKS-NEXT:    store i8 addrspace(200)* [[TMP10]], i8 addrspace(200)* addrspace(200)* [[MTX_ADDR]], align 16
// WORKS-NEXT:    call void @do_unlock()
// WORKS-NEXT:    br label [[IF_END]]
// WORKS:       if.end:
// WORKS-NEXT:    [[TMP11:%.*]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* [[MTX_ADDR]], align 16
