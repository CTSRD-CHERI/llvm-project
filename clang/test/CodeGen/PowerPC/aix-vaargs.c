...
// CHECK-NEXT:  call void @llvm.va_copy.p0i8.p0i8(i8* %3, i8* %4)
...
// CHECK-NEXT:  call void @llvm.va_end.p0i8(i8* %ap24)
// CHECK-NEXT:  %ap5 = bitcast i8** %ap to i8*
// CHECK-NEXT:  call void @llvm.va_end.p0i8(i8* %ap5)
// CHECK-NEXT:  ret void

// CHECK: declare void @llvm.va_start.p0i8(i8*)
...
// CHECK: declare void @llvm.va_copy.p0i8.p0i8(i8*, i8*)
// CHECK: declare void @llvm.va_end.p0i8(i8*)
