...
void __attribute__((ms_abi)) f4(int a, ...) {
  // FREEBSD-LABEL: define dso_local win64cc void @f4
...
void __attribute__((sysv_abi)) f6(__builtin_ms_va_list ap) {
  // FREEBSD-LABEL: define dso_local void @f6
...
__attribute__((ms_abi)) struct i128 f7(struct i128 a) {
  ...
  // FREEBSD: define dso_local win64cc void @f7(%struct.i128* noalias sret %agg.result, %struct.i128* %a)
  return a;
}
