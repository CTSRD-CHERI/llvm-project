...
// RUN: %clang -c -### -target cheri-unknown-freebsd11 -cheri=256 -mabi=purecap -fno-pic \
// RUN:   %s 2>&1 | FileCheck --check-prefix=PURECAP_FNOPIC %s
// RUN: not %clang -c -target cheri-unknown-freebsd11 -cheri=256 -mabi=purecap -fno-pic %s -o /dev/null
// RUN: not %clang -S -target cheri-unknown-freebsd11 -cheri=256 -mabi=purecap -fno-pic %s -o /dev/null
