...
// RUN: not %cheri_purecap_cc1 -cheri-bounds=subobject-safe -emit-llvm %s -o /dev/null 2>&1 | FileCheck %s -check-prefix NOTYET
// NOTYET: error: unsupported argument 'subobject-safe' to option '-cheri-bounds=subobject-safe'
