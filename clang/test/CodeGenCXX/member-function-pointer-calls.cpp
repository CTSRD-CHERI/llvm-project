...
/// Also check that we can inline the calls for purecap and hybrid CHERI.
...
// RUN: %riscv64_cheri_purecap_cc1 %s -emit-llvm -O3 -fno-experimental-new-pass-manager -o - | FileCheck %s
// RUN: %riscv64_cheri_purecap_cc1 %s -emit-llvm -O3 -fexperimental-new-pass-manager -o - | FileCheck %s
struct A {
