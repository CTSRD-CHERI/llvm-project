...
// CSV-NEXT: 2,4,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:39, col:43>","operator new for Foo *","allocating type struct Foo"
...
// CSV-NEXT: 2,4,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-2]]:47, col:61>","operator new for Foo *","allocating type struct Foo"
void *test_foo_not_aligned_array() { return new Foo[2]; }
// CSV-NEXT: 2,8,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:45, col:54>","operator new[] for Foo *","allocating type struct Foo"
void *test_foo_not_aligned_array_nonconst(int n) { return new Foo[n]; }
// CSV-NEXT: 2,<unknown multiple of 4>,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:59, col:68>","operator new[] for Foo *","allocating type struct Foo"
...
// CSV-NEXT: 8,256,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:35, col:39>","operator new for FooAligned *","allocating type struct FooAligned"
...
// CSV-NEXT: 8,256,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-2]]:43, col:57>","operator new for FooAligned *","allocating type struct FooAligned"
void *test_foo_aligned_array() { return new FooAligned[3]; }
// CSV-NEXT: 8,768,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:41, col:57>","operator new[] for FooAligned *","allocating type struct FooAligned"
void *test_foo_aligned_array_nonconst(int n) { return new FooAligned[n]; }
// CSV-NEXT: 8,<unknown multiple of 256>,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:55, col:71>","operator new[] for FooAligned *","allocating type struct FooAligned"
