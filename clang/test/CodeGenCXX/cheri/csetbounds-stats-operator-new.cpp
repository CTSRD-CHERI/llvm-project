...
// CSV-NEXT: 2,4,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:47, col:61>","operator new for Foo * __capability","allocating type struct Foo"
...
// CSV-NEXT: 8,256,h,"<{{.+}}csetbounds-stats-operator-new.cpp:[[@LINE-1]]:43, col:57>","operator new for FooAligned * __capability","allocating type struct FooAligned"
