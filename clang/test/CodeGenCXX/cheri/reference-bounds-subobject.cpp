...
// CHECK-NEXT:    tail call void @_Z17do_stuff_with_refR6Nested(%struct.Nested addrspace(200)* nonnull align 4 dereferenceable(8) [[REF_WITH_BOUNDS]]) #3
...
// CHECK-NEXT:    tail call void @_Z17do_stuff_with_refRi(i32 addrspace(200)* nonnull align 4 dereferenceable(4) [[REF_WITH_BOUNDS2]]) #3
...
// CHECK-NEXT:    tail call void @_Z17do_stuff_with_refRf(float addrspace(200)* nonnull align 4 dereferenceable(4) [[REF_WITH_BOUNDS3]]) #3
// CHECK-NEXT:    ret void
//
