...
// CHECK-NEXT:    [[TMP1:%.*]] = tail call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* nonnull [[TMP0]])
// CHECK-NEXT:    [[TMP2:%.*]] = tail call i64 @llvm.cheri.cap.address.get.i64(i8 addrspace(200)* nonnull [[TMP0]])
