...
// RUN: %cheri_purecap_cc1 -emit-llvm -o - %s -O2 | %cheri_FileCheck %s -check-prefix PURECAP_IR
...
// RUN: %cheri_purecap_cc1 -DERROR_CHECK -emit-llvm -o - %s -O2 | %cheri_FileCheck %s -check-prefixes PURECAP_IR,WITH_ERROR_IR
