...
public:
  constexpr static pointer pointer_to(element_type &__r) noexcept {
    ...
    // expected-remark@-1{{not setting bounds for reference to 'pointer_traits<char * __capability>::element_type' (aka 'char') (source is a C++ reference and therefore should already have sub-object bounds)}}
  }
};
