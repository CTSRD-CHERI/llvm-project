...
// CHECK-NEXT:    [[CALL:%.*]] = call signext i32 @_Z3fooRSt16initializer_listIiE(%"class.std::initializer_list" addrspace(200)* nonnull align 16 dereferenceable({{24|40}}) [[L1]])
...
// STATIC-LABEL: @main(
// STATIC-NEXT:  entry:
// STATIC-NEXT:    [[CALL:%.*]] = call signext i32 @_Z3fooRSt16initializer_listIiE(%"class.std::initializer_list" addrspace(200)* nonnull align 16 dereferenceable({{24|40}}) bitcast ({ i32 addrspace(200)*, i64 } addrspace(200)* @_ZZ4mainE2l1 to %"class.std::initializer_list" addrspace(200)*))
