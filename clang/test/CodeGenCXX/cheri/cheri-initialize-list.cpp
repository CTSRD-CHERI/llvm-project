...
//.
// STATIC: @_ZZ4mainE2l1 = internal addrspace(200) global { i32 addrspace(200)*, i64 } { i32 addrspace(200)* getelementptr inbounds ([3 x i32], [3 x i32] addrspace(200)* @_ZGRZ4mainE2l1_, i32 0, i32 0), i64 3 }, align 16
...
// CHECK-NEXT:    store i32 addrspace(200)* [[ARRAYSTART]], i32 addrspace(200)* addrspace(200)* [[__BEGIN_]], align 16
...
// CHECK-NEXT:    store i64 3, i64 addrspace(200)* [[__SIZE_]], align 16
// CHECK-NEXT:    [[CALL:%.*]] = call noundef signext i32 @_Z3fooRSt16initializer_listIiE(%"class.std::initializer_list" addrspace(200)* noundef nonnull align 16 dereferenceable(24) [[L1]])
// CHECK-NEXT:    ret i32 0
//
// STATIC-LABEL: define {{[^@]+}}@main
// STATIC-SAME: () addrspace(200) #[[ATTR0:[0-9]+]] {
// STATIC-NEXT:  entry:
// STATIC-NEXT:    [[CALL:%.*]] = call noundef signext i32 @_Z3fooRSt16initializer_listIiE(%"class.std::initializer_list" addrspace(200)* noundef nonnull align 16 dereferenceable(24) bitcast ({ i32 addrspace(200)*, i64 } addrspace(200)* @_ZZ4mainE2l1 to %"class.std::initializer_list" addrspace(200)*))
