...
// CHECK-LABEL: define void @_Z10test_derefPi(i32 addrspace(200)*
...
// CHECK-LABEL: define void @_Z10test_derefPd(double addrspace(200)*
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// CHECK-SAME: i64 8)
...
// CHECK-LABEL: define void @_Z10test_derefPPv(i8 addrspace(200)* addrspace(200)*
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
...
// CHECK-LABEL: define void @_Z10test_derefP5Enum1(i32 addrspace(200)*
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// CHECK-SAME: i64 4)
...
// CHECK-LABEL: define void @_Z10test_derefP9EnumClass(i16 addrspace(200)*
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// CHECK-SAME: i64 2)
...
// CHECK-LABEL: define void @_Z10test_derefP18FinalClassNoVTable(
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// CHECK-SAME: i64 4)
...
// CHECK-LABEL: define void @_Z10test_derefP20FinalClassWithVTable(
...
// CHECK-LABEL: define void @_Z10test_derefP27FinalClassInheritedNoVTable(
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// CHECK-SAME: i64 12)
...
// CHECK-LABEL: define void @_Z10test_derefP29FinalClassInheritedWithVTable(
// TODO-CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// TODO-CHECK-SAME: i64 1234)
// for now no bounds on classes with vtables
// CHECK-NOT: @llvm.cheri.cap.bounds.set.i64
...
// CHECK-LABEL: define void @_Z10test_derefP13FlexArrayBase(
...
// CHECK-LABEL: define void @_Z10test_derefP14FlexArrayFinal(
// CHECK: @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}}, i64 %remaining_bytes)
...
// CHECK-LABEL: define void @_Z10test_derefP5CLike(
// CHECK-NOT: @llvm.cheri.cap.bounds.set.i64
...
// CHECK-LABEL: define void @_Z10test_derefP10CLikeFinal(
// CHECK: call i8 addrspace(200)* @llvm.cheri.cap.bounds.set.i64(i8 addrspace(200)* %{{.+}},
// CHECK-SAME: i64 16)
...
// CHECK-LABEL: define void @_Z10test_derefP10IntOrFloat(
// CHECK-NOT: @llvm.cheri.cap.bounds.set.i64
