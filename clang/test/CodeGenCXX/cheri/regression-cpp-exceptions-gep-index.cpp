...
// CHECK-NEXT:    call void @_ZN1cC1Ev(%class.c addrspace(200)* nonnull dereferenceable(16) [[E]]) [[ATTR4:#.*]]
...
// CHECK-NEXT:    call void @_ZN1a1bEv(%class.a addrspace(200)* nonnull dereferenceable(1) [[TMP4]])
// CHECK-NEXT:    ret void
//
void d() {
  c e;
