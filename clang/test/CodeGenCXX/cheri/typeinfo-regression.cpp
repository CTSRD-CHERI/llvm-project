...
// CHECK: @_ZN1cD1Ev = unnamed_addr alias void (%struct.c addrspace(200)*), void (%struct.c addrspace(200)*) addrspace(200)* @_ZN1cD2Ev
// CHECK: @_ZN1CD2Ev = unnamed_addr alias void (%struct.C addrspace(200)*), bitcast (void (%struct.c addrspace(200)*) addrspace(200)* @_ZN1cD2Ev to void (%struct.C addrspace(200)*) addrspace(200)*)
// CHECK: @_ZN1CD1Ev = unnamed_addr alias void (%struct.C addrspace(200)*), void (%struct.C addrspace(200)*) addrspace(200)* @_ZN1CD2Ev
//.
