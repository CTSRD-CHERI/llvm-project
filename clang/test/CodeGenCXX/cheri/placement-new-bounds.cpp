...
// RUN: %cheri_purecap_cc1 -no-opaque-pointers %s -emit-llvm -std=c++2a -cheri-bounds=aggressive -o - -std=c++11 -O2 | FileCheck -check-prefixes CHECK,AGGRESSIVE %s
// RUN: %cheri_purecap_cc1 -no-opaque-pointers %s -emit-llvm -std=c++2a -cheri-bounds=conservative -o - -std=c++11 -O2 | FileCheck -check-prefixes CHECK,CONSERVATIVE %s
namespace std {
...
// AGGRESSIVE-NEXT:    [[CALL:%.*]] = tail call noalias noundef nonnull dereferenceable(4) i8 addrspace(200)* @_Znwm(i64 noundef zeroext 4) #[[ATTR6:[0-9]+]]
// AGGRESSIVE-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// AGGRESSIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP0]]
//
// CONSERVATIVE-LABEL: @_Z20test_foo_not_alignedv(
// CONSERVATIVE-NEXT:  entry:
// CONSERVATIVE-NEXT:    [[CALL:%.*]] = tail call noalias noundef nonnull dereferenceable(4) i8 addrspace(200)* @_Znwm(i64 noundef zeroext 4) #[[ATTR4:[0-9]+]]
// CONSERVATIVE-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// CONSERVATIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP0]]
//
...
// AGGRESSIVE-NEXT:  entry:
// AGGRESSIVE-NEXT:    [[CALL:%.*]] = tail call noalias noundef nonnull dereferenceable(8) i8 addrspace(200)* @_Znam(i64 noundef zeroext 8) #[[ATTR6]]
// AGGRESSIVE-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// AGGRESSIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP0]]
//
// CONSERVATIVE-LABEL: @_Z26test_foo_not_aligned_arrayv(
// CONSERVATIVE-NEXT:  entry:
// CONSERVATIVE-NEXT:    [[CALL:%.*]] = tail call noalias noundef nonnull dereferenceable(8) i8 addrspace(200)* @_Znam(i64 noundef zeroext 8) #[[ATTR4]]
// CONSERVATIVE-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// CONSERVATIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP0]]
//
...
// AGGRESSIVE-NEXT:    [[CALL:%.*]] = tail call noalias noundef nonnull i8 addrspace(200)* @_Znam(i64 noundef zeroext [[TMP4]]) #[[ATTR6]]
// AGGRESSIVE-NEXT:    [[TMP5:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// AGGRESSIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP5]]
//
...
// CONSERVATIVE-NEXT:    [[CALL:%.*]] = tail call noalias noundef nonnull i8 addrspace(200)* @_Znam(i64 noundef zeroext [[TMP4]]) #[[ATTR4]]
// CONSERVATIVE-NEXT:    [[TMP5:%.*]] = bitcast i8 addrspace(200)* [[CALL]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// CONSERVATIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP5]]
//
...
// AGGRESSIVE-NEXT:    [[TMP1:%.*]] = bitcast i8 addrspace(200)* [[TMP0]] to [[STRUCT_FOO:%.*]] addrspace(200)*
// AGGRESSIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP1]]
//
...
// AGGRESSIVE-NEXT:    ret [[STRUCT_FOO]] addrspace(200)* [[TMP6]]
//
