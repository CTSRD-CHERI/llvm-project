// RUN: %clang_cc1 "-triple" "x86_64-unknown-linux-gnu" "-emit-obj" "-mrelax-all" "-disable-free" "-main-file-name" "driver.cpp" "-mrelocation-model" "static" "-mthread-model" "posix" "-munwind-tables" "-target-cpu" "x86-64" "-std=c++11" "-fcxx-exceptions" "-fexceptions" "-fdiagnostics-show-option" "-cheri-linker" "-x" "c++" "%s" -emit-llvm -o -
