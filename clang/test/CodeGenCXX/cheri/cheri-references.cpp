...
void f() {
  ...
  // CHECK-NEXT: [[FAKE_CAP:%.+]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set(i8 addrspace(200)* null, i64 19088743)
  ...
  // CHECK-NEXT: [[FAKE_VOID_PTR:%.+]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set(i8 addrspace(200)* null, i64 19088743)
