...
// RUN: %cheri_cc1 %s -std=c++14 -emit-llvm -O0 -o - | FileCheck -check-prefix=HYBRID %s
// RUN: %cheri_purecap_cc1 %s -std=c++14 -emit-llvm -O0 -o - | FileCheck -check-prefix=PURECAP %s
