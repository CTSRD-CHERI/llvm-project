...
// RISCV64-PURECAP-NEXT:    store { i8 addrspace(200)*, i64 } { i8 addrspace(200)* bitcast (i32 (%class.A addrspace(200)*) addrspace(200)* @_ZN1A3fooEv to i8 addrspace(200)*), i64 0 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[AGG_RESULT]], align 16, [[TBAA4:!tbaa !.*]]
...
// RISCV64-PURECAP-SAME: ({ i8 addrspace(200)*, i64 } addrspace(200)* noalias nocapture sret({ i8 addrspace(200)*, i64 }) align 16 [[AGG_RESULT:%.*]], { i8 addrspace(200)*, i64 } addrspace(200)* nocapture readonly [[TMP0:%.*]]) local_unnamed_addr addrspace(200) [[ATTR2:#.*]] {
// RISCV64-PURECAP-NEXT:  entry:
