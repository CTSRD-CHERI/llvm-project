...
public:
  ...
  // CHECK-SAME: ([[CLASS_TIME_POINT:%.*]] addrspace(200)* nonnull align 1 dereferenceable(1) [[THIS:%.*]]) unnamed_addr addrspace(200) #[[ATTR1:[0-9]+]] comdat align 2 {
  // CHECK-NEXT:  entry:
  ...
  // CHECK-NEXT:    call void @_ZN10time_pointC2Ev([[CLASS_TIME_POINT]] addrspace(200)* nonnull align 1 dereferenceable(1) [[THIS1]])
  // CHECK-NEXT:    ret void
  //
  time_point() {}
};
