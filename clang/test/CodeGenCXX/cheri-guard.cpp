...
foo *f() {
  // CHECK: define %struct.foo addrspace(200)* @_Z1fv() #0 {
  // CHECK-NEXT: %{{.+}} = load atomic i8, i8 addrspace(200)* bitcast (i64 addrspace(200)* @_ZGVZ1fvE1x to i8 addrspace(200)*) acquire, align 8
