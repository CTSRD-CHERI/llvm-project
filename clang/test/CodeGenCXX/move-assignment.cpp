...
// CHERI: define linkonce_odr dereferenceable(28) %struct.B addrspace(200)* @_ZN1BaSEOS_(%struct.B addrspace(200)* %this, %struct.B addrspace(200)* dereferenceable(28) %0)
