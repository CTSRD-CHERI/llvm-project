...
// CHERI: define linkonce_odr nonnull align 8 dereferenceable(28) %struct.B addrspace(200)* @_ZN1BaSEOS_(%struct.B addrspace(200)* nonnull dereferenceable(28) %this, %struct.B addrspace(200)* nonnull align 8 dereferenceable(28) %0) addrspace(200)
...
// CHERI: call nonnull align 1 dereferenceable(1) %struct.A addrspace(200)* @_ZN1AaSEOS_(%struct.A addrspace(200)* nonnull dereferenceable(1) %a, %struct.A addrspace(200)* nonnull align 1 dereferenceable(1) %a2)
// BOTH-NOT: store
