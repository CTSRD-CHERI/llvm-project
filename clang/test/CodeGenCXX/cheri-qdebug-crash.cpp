...
void QDebug::putUcs4() {
  ...
  // PURECAP: call dereferenceable(1) %class.QTextStream addrspace(200)* {{%.+}}(%class.QTextStream addrspace(200)* dereferenceable(1) {{%.+}}, %class.QTextStreamManipulator addrspace(200)* {{%.+}})
}

// TODO: we should probably return an inreg struct for CHERI too
// HYBRID: declare inreg { i64, i64 } @_Z11qSetPadCharv()
// PURECAP: declare dereferenceable(1) %class.QTextStream addrspace(200)* @_ZlsR11QTextStream22QTextStreamManipulator(%class.QTextStream addrspace(200)* dereferenceable(1), %class.QTextStreamManipulator addrspace(200)*)
