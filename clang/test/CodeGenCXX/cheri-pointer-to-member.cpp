...
int main() {
  ...
  // CHECK-NEXT: [[NULL_FUNC_PTR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[FUNC_PTR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[MEMPTR_TMP:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[FUNC_PTR_2:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[MEMPTR_TMP1:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[VIRTUAL_FUNC_PTR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[VIRTUAL_FUNC_PTR_2:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  A a;
...
int data_ptr_dereferece(A* a, int A::* ptr) {
  ...
  // CHECK: [[A_ADDR:%.+]] = alloca %class.A addrspace(200)*, align 32
  // CHECK-NEXT: [[PTR_ADDR:%.+]] = alloca i64, align 8
  // CHECK-NEXT: store %class.A addrspace(200)* [[A:%.+]], %class.A addrspace(200)* addrspace(200)* [[A_ADDR]], align 32
  // CHECK-NEXT: store i64 [[PTR:%.+]], i64 addrspace(200)* [[PTR_ADDR]], align 8
  // CHECK-NEXT: [[VAR0:%.+]] = load %class.A addrspace(200)*, %class.A addrspace(200)* addrspace(200)* [[A_ADDR]], align 32
...
bool func_ptr_is_nonnull(AMemberFuncPtr ptr) {
  ...
  // CHECK: [[PTR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[PTR_ADDR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32

  // CHECK: [[VAR2:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR_ADDR]], align 32
...
bool func_ptr_equal(AMemberFuncPtr ptr1, AMemberFuncPtr ptr2) {
  ...
  // CHECK: [[PTR1:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[PTR2:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[PTR1_ADDR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[PTR2_ADDR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32

  // CHECK: [[VAR4:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR1_ADDR]], align 32
  // CHECK-NEXT: [[VAR5:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR2_ADDR]], align 32
...
int func_ptr_dereference(A* a, AMemberFuncPtr ptr) {
  ...
  // CHECK: [[PTR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[A_ADDR:%.+]] = alloca %class.A addrspace(200)*, align 32
  // CHECK-NEXT: [[PTR_ADDR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK: [[VAR2:%.+]] = load %class.A addrspace(200)*, %class.A addrspace(200)* addrspace(200)* [[A_ADDR]], align 32
  // CHECK-NEXT: [[VAR3:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR_ADDR]], align 32
  ...
  // CHECK-NEXT: [[VTABLE:%.+]] = load i8 addrspace(200)*, i8 addrspace(200)* addrspace(200)* [[VAR5]], align 32
  ...
  // CHECK-NEXT: [[MEMPTR_VIRTUALFN:%.+]] = load i32 (%class.A addrspace(200)*) addrspace(200)*, i32 (%class.A addrspace(200)*) addrspace(200)* addrspace(200)* [[VAR7]], align 32
...
AMemberFuncPtr return_func_ptr() {
  ...
  // CHECK: [[RETVAL:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: store { i8 addrspace(200)*, i64 } { i8 addrspace(200)* inttoptr (i64 32 to i8 addrspace(200)*), i64 1 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[RETVAL]], align 32
  // CHECK-NEXT: [[VAR0:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[RETVAL]], align 32
  // CHECK-NEXT: store { i8 addrspace(200)*, i64 } [[VAR0]], { i8 addrspace(200)*, i64 } addrspace(200)* [[AGG_RESULT:%.+]], align 32
  // CHECK-NEXT: ret void
...
AMemberFuncPtr passthrough_func_ptr(AMemberFuncPtr ptr) {
  ...
  // CHECK: [[RETVAL:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[PTR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[PTR_ADDR:%.+]] = alloca { i8 addrspace(200)*, i64 }, align 32
  // CHECK-NEXT: [[VAR1:%.+]] = getelementptr inbounds { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR]], i32 0, i32 0
  // CHECK-NEXT: store i8 addrspace(200)* [[PTR_COERCE0:%.+]], i8 addrspace(200)* addrspace(200)* [[VAR1]], align 32
  // CHECK-NEXT: [[VAR2:%.+]] = getelementptr inbounds { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR]], i32 0, i32 1
  // CHECK-NEXT: store i64 [[PTR_COERCE1:%.+]], i64 addrspace(200)* [[VAR2]], align 32
  // CHECK-NEXT: [[PTR1:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR]], align 32
  // CHECK-NEXT: store { i8 addrspace(200)*, i64 } [[PTR1]], { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR_ADDR]], align 32
  // CHECK-NEXT: [[VAR3:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[PTR_ADDR]], align 32
  // CHECK-NEXT: store { i8 addrspace(200)*, i64 } [[VAR3]], { i8 addrspace(200)*, i64 } addrspace(200)* [[RETVAL]], align 32
  // CHECK-NEXT: [[VAR4:%.+]] = load { i8 addrspace(200)*, i64 }, { i8 addrspace(200)*, i64 } addrspace(200)* [[RETVAL]], align 32
  // CHECK-NEXT: store { i8 addrspace(200)*, i64 } [[VAR4]], { i8 addrspace(200)*, i64 } addrspace(200)* [[AGG_RESULT:%.+]], align 32
  // CHECK-NEXT: ret void
  return ptr;
}
