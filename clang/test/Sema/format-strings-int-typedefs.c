...
void test(void) {
  ...
  printf("%Pd", 42.0); // expected-warning {{format specifies type 'intptr_t' (aka 'long')}}
  printf("%Pu", 42.0); // expected-warning {{format specifies type 'uintptr_t' (aka 'unsigned long')}}
  ...
  scanf("%Pd", 0); // expected-warning {{format specifies type 'intptr_t *' (aka 'long *')}}
  scanf("%Pu", 0); // expected-warning {{format specifies type 'uintptr_t *' (aka 'unsigned long *')}}
