...
// CHECK: @a = dso_local addrspace(200) global %struct.anon zeroinitializer, align 8
struct {
...
// CHECK: @b1 = dso_local addrspace(200) global %struct.anon.0 zeroinitializer, align 8
// CHECK: @b2 = dso_local addrspace(200) global %struct.anon.1 zeroinitializer, align 2
// CHECK: @c1 = dso_local addrspace(200) global %struct.anon.2 zeroinitializer, align 2
// CHECK: @c2 = dso_local addrspace(200) global %struct.anon.3 zeroinitializer, align [[#CAP_SIZE]]
