...
struct no_caps a;
// CHECK: @a = [[$GLOBALS_AS]]global %struct.no_caps zeroinitializer, align [[$CAP_SIZE]]

struct with_cap {
  int *__capability i;
} __attribute__((__aligned__));
struct with_cap b;
// CHECK: @b = [[$GLOBALS_AS]]global %struct.with_cap zeroinitializer, align [[$CAP_SIZE]]
...
// CHECK: @no_caps_global_default_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[$CAP_SIZE]]
// CHECK: @with_cap_global_default_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[$CAP_SIZE]]
...
// CHECK: @no_caps_global_biggest_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[$CAP_SIZE]]
// CHECK: @with_cap_global_biggest_align = [[$GLOBALS_AS]]global %struct.anon.{{[0-9]+}} zeroinitializer, align [[$CAP_SIZE]]
