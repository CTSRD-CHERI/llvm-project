...
// CHECK: @cap_struct_global = dso_local addrspace(200) global %struct.cap_struct zeroinitializer, align [[#CAP_SIZE]]
...
// CHECK: @padded_cap_global = dso_local addrspace(200) global %struct.padded_cap zeroinitializer, align [[#CAP_SIZE]]
...
// CHECK: @packed_cap_global = dso_local addrspace(200) global %struct.packed_cap zeroinitializer, align 1
...
// CHECK: @padded_cap_struct_global = dso_local addrspace(200) global %struct.padded_cap_struct zeroinitializer, align [[#CAP_SIZE]]
...
// CHECK: @packed_cap_struct_global = dso_local addrspace(200) global %struct.packed_cap_struct zeroinitializer, align 1
...
// CHECK: @padded_uintptr_t_global = dso_local addrspace(200) global %struct.padded_uintptr_t zeroinitializer, align [[#CAP_SIZE]]
...
// CHECK: @packed_uintptr_t_global = dso_local addrspace(200) global %struct.packed_uintptr_t zeroinitializer, align 1
...
// CHECK: @correctly_aligned_but_size_not_multiple_global = dso_local addrspace(200) global %struct.correctly_aligned_but_size_not_multiple zeroinitializer, align [[#CAP_SIZE]]
...
// CHECK: @correct_when_used_in_array_but_bad_alignof_global = dso_local addrspace(200) global %struct.correct_when_used_in_array_but_bad_alignof zeroinitializer, align 1
...
// CHECK: @bad_uintptr_array_1_global = dso_local addrspace(200) global %struct.bad_uintptr_array_1 zeroinitializer, align 1
...
// CHECK: @bad_uintptr_array_2_global = dso_local addrspace(200) global %struct.bad_uintptr_array_2 zeroinitializer, align 8
...
// CHECK: @good_uintptr_array_global = dso_local addrspace(200) global %struct.good_uintptr_array zeroinitializer, align 32
...
// CHECK: @bad_cap_struct_array_1_global = dso_local addrspace(200) global %struct.bad_cap_struct_array_1 zeroinitializer, align 1
...
// CHECK: @bad_cap_struct_array_2_global = dso_local addrspace(200) global %struct.bad_cap_struct_array_2 zeroinitializer, align 8
...
// CHECK: @good_cap_struct_array_global = dso_local addrspace(200) global %struct.good_cap_struct_array zeroinitializer, align 32
