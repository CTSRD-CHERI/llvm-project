...
struct {
  int x;
    ...
    // purecap-c-warning@-2 {{incompatible pointer to integer conversion initializing 'int' with an expression of type 'void * __capability __attribute__((cheri_no_provenance))' (aka 'void *')}}
    // hybrid-cxx-error@-3 {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void * __capability'}}
    // purecap-cxx-error@-4 {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void * __capability' (aka 'void *')}}
    ...
    // purecap-cxx-error@-4 {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void * __capability __attribute__((cheri_no_provenance))' (aka 'void *')}}
    ...
    // purecap-c-warning@-2 {{incompatible pointer to integer conversion initializing 'int' with an expression of type 'void * __capability' (aka 'void *')}}
    // hybrid-cxx-error@-3 {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void * __capability'}}
    // purecap-cxx-error@-4 {{cannot initialize a member subobject of type 'int' with an rvalue of type 'void * __capability' (aka 'void *')}}
    {(__intcap)0},
    {(__intcap)42},
...
struct {
  void * __capability p;
    ...
    // purecap-c-warning@-2 {{expression which evaluates to zero treated as a null pointer constant of type 'void * __capability' (aka 'void *')}}
    ...
    // purecap-cxx-error@-4 {{cannot initialize a member subobject of type 'void * __capability' (aka 'void *') with an rvalue of type '__intcap __attribute__((cheri_no_provenance))'}}
    {(__intcap)42},
    ...
    // purecap-c-warning@-2 {{incompatible integer to pointer conversion initializing 'void * __capability' (aka 'void *') with an expression of type '__intcap __attribute__((cheri_no_provenance))'}}
    // hybrid-cxx-error@-3 {{cannot initialize a member subobject of type 'void * __capability' with an rvalue of type '__intcap __attribute__((cheri_no_provenance))'}}
    // purecap-cxx-error@-4 {{cannot initialize a member subobject of type 'void * __capability' (aka 'void *') with an rvalue of type '__intcap __attribute__((cheri_no_provenance))'}}
    {(__intcap)((long)__INT_MAX__ + 1)},
// hybrid-c-warning@-1 {{incompatible integer to pointer conversion initializing 'void * __capability' with an expression of type '__intcap __attribute__((cheri_no_provenance))'}}
...
// purecap-cxx-error@-2 {{cannot initialize a member subobject of type 'void * __capability' (aka 'void *') with an rvalue of type '__intcap __attribute__((cheri_no_provenance))'}}
#endif
};
