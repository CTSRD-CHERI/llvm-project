...
// IR: @data = dso_local addrspace(200) global i8 addrspace(200)* null, align 4
...
DBT dbt;
// IR: @dbt = dso_local addrspace(200) global %struct.DBT zeroinitializer, align 2
...
struct DBT2 dbt2;
// IR: @dbt2 = dso_local addrspace(200) global %struct.DBT2 zeroinitializer, align [[#CAP_SIZE]]
...
struct DBT3 dbt3;
// IR: @dbt3 = dso_local addrspace(200) global %struct.DBT3 zeroinitializer, align 4
...
// IR: @dbt4 = dso_local addrspace(200) global %struct.DBT4 zeroinitializer, align 4
...
struct DBT5 dbt5;
// IR: @dbt5 = dso_local addrspace(200) global %struct.DBT5 zeroinitializer, align 4
...
struct DBT6 dbt6;
// IR: @dbt6 = dso_local addrspace(200) global %struct.DBT6 zeroinitializer, align [[#CAP_SIZE]]
...
struct DBT7 dbt7;
// IR: @dbt7 = dso_local addrspace(200) global %struct.DBT7 zeroinitializer, align 1
struct DBT8 {
...
struct DBT8 dbt8;
// IR: @dbt8 = dso_local addrspace(200) global %struct.DBT8 zeroinitializer, align 1
