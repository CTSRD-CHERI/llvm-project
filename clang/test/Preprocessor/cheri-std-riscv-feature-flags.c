...
// ZCLEVEL: #define __CHERI_BW_CAP_PERMISSION_ELEVATE_LEVEL__ 64
// CHECK: #define __CHERI_BW_CAP_PERMISSION_EXECUTE__ 8
// CHECK: #define __CHERI_BW_CAP_PERMISSION_LOAD_MUTABLE__ 32
// CHECK: #define __CHERI_BW_CAP_PERMISSION_READ__ 4
// ZCLEVEL: #define __CHERI_BW_CAP_PERMISSION_STORE_LEVEL__ 128
