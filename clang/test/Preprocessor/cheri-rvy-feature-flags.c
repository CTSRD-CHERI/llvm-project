...
// CHECK: #define __CHERI_CAP_PERMISSION_CAPABILITY_LEVEL__ 16
// CHECK: #define __CHERI_CAP_PERMISSION_CAPABILITY__ 32
// CHECK: #define __CHERI_CAP_PERMISSION_ELEVATE_LEVEL__ 4
...
// CHECK: #define __CHERI_CAP_PERMISSION_STORE_LEVEL__ 8
