...
const int *j = &i;
// CHECK-LABEL: define {{[^@]+}}@_Z1bv() addrspace(200) #0
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[EXCEPTION:%.*]] = call i8 addrspace(200)* @__cxa_allocate_exception(i64 16) #4
...
// CHECK-NEXT:    call void @_ZN1aC1Ev(%class.a addrspace(200)* [[TMP0]]) #4
// CHECK-NEXT:    call void @__cxa_throw(i8 addrspace(200)* [[EXCEPTION]], i8 addrspace(200)* bitcast (i8 addrspace(200)* addrspace(200)* @_ZTI1a to i8 addrspace(200)*), i8 addrspace(200)* bitcast (void (%class.a addrspace(200)*) addrspace(200)* @_ZN1aD1Ev to i8 addrspace(200)*)) #5
