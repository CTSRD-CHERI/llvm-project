...
// HYBRID: define dso_local void @_Z8ptr_qualU12__capabilityP1a(
// PURECAP: define dso_local void @_Z8ptr_qualP1a(
void ref_qual(struct a & __capability) {}
// HYBRID: define dso_local void @_Z8ref_qualU12__capabilityR1a(
// PURECAP: define dso_local void @_Z8ref_qualR1a(
void rref_qual(struct a && __capability) {}
// HYBRID: define dso_local void @_Z9rref_qualU12__capabilityO1a(
// PURECAP: define dso_local void @_Z9rref_qualO1a(

// No additional mangling for default representation:
void ptr_default(struct a *) {}   // CHECK: define dso_local void @_Z11ptr_defaultP1a(
void ref_default(struct a &) {}   // CHECK: define dso_local void @_Z11ref_defaultR1a(
void rref_default(struct a &&) {} // CHECK: define dso_local void @_Z12rref_defaultO1a(
...
// PURECAP: define dso_local void @_Z7ptr_piil(
// HYBRID: define dso_local void @_Z7ptr_piiP1a(

// Note: #pragma pointer_interpretation doesn't apply to references
void ref_pii(struct a &) {}   // CHECK: define dso_local void @_Z7ref_piiR1a(
void rref_pii(struct a &&) {} // CHECK: define dso_local void @_Z8rref_piiO1a(
...
// PURECAP: define dso_local void @_Z7ptr_picP1a(
// HYBRID: define dso_local void @_Z7ptr_picU12__capabilityP1a(
// Note: #pragma pointer_interpretation doesn't apply to references
void ref_pic(struct a &) {}   // CHECK: define dso_local void @_Z7ref_picR1a(
void rref_pic(struct a &&) {} // CHECK: define dso_local void @_Z8rref_picO1a(
...
// HYBRID: define dso_local void @_Z4uptrm(
// PURECAP: define dso_local void @_Z4uptru11__uintcap_t(
void sptr(__INTPTR_TYPE__ s) {}
// HYBRID: define dso_local void @_Z4sptrl(
// PURECAP: define dso_local void @_Z4sptru10__intcap_t(
