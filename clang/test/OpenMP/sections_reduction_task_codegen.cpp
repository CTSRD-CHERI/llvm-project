...
// CHECK1-NEXT:    [[TMP17:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK1-NEXT:    store i8* [[TMP25]], i8** [[_TMP4]], align 8
...
// CHECK1-NEXT:    [[TMP36:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 0
// CHECK1-NEXT:    [[TMP37:%.*]] = load i8**, i8*** [[TMP4]], align 8
// CHECK1-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds i8*, i8** [[TMP37]], i64 0
// CHECK1-NEXT:    [[TMP38:%.*]] = load i8*, i8** [[ARRAYIDX6]], align 8
...
// CHECK1-NEXT:    [[LB_ADD_LEN8:%.*]] = add nsw i64 -1, [[TMP40]]
// CHECK1-NEXT:    [[TMP41:%.*]] = load i8**, i8*** [[TMP4]], align 8
// CHECK1-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds i8*, i8** [[TMP41]], i64 9
// CHECK1-NEXT:    [[TMP42:%.*]] = load i8*, i8** [[ARRAYIDX9]], align 8
// CHECK1-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds i8, i8* [[TMP42]], i64 [[LB_ADD_LEN8]]
// CHECK1-NEXT:    store i8* [[VLA]], i8** [[TMP36]], align 8
// CHECK1-NEXT:    [[TMP43:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 1
// CHECK1-NEXT:    store i8* [[ARRAYIDX7]], i8** [[TMP43]], align 8
// CHECK1-NEXT:    [[TMP44:%.*]] = ptrtoint i8* [[ARRAYIDX10]] to i64
// CHECK1-NEXT:    [[TMP45:%.*]] = ptrtoint i8* [[ARRAYIDX7]] to i64
...
// CHECK1-NEXT:    [[TMP50:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 2
// CHECK1-NEXT:    store i64 [[TMP49]], i64* [[TMP50]], align 8
// CHECK1-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 3
// CHECK1-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_init..1 to i8*), i8** [[TMP51]], align 8
// CHECK1-NEXT:    [[TMP52:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 4
// CHECK1-NEXT:    store i8* null, i8** [[TMP52]], align 8
// CHECK1-NEXT:    [[TMP53:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 5
// CHECK1-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_comb..2 to i8*), i8** [[TMP53]], align 8
// CHECK1-NEXT:    [[TMP54:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 6
...
// CHECK1-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP60]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// CHECK1-NEXT:    [[TMP61:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK1-NEXT:    [[TMP62:%.*]] = icmp slt i32 [[TMP61]], 0
// CHECK1-NEXT:    [[TMP63:%.*]] = select i1 [[TMP62]], i32 [[TMP61]], i32 0
// CHECK1-NEXT:    store i32 [[TMP63]], i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK1-NEXT:    [[TMP64:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_LB_]], align 4
// CHECK1-NEXT:    store i32 [[TMP64]], i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK1:       omp.inner.for.cond:
// CHECK1-NEXT:    [[TMP65:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    [[TMP66:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK1-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP65]], [[TMP66]]
// CHECK1-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK1:       omp.inner.for.body:
// CHECK1-NEXT:    [[TMP67:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    switch i32 [[TMP67]], label [[DOTOMP_SECTIONS_EXIT:%.*]] [
// CHECK1-NEXT:    i32 0, label [[DOTOMP_SECTIONS_CASE:%.*]]
// CHECK1-NEXT:    ]
// CHECK1:       .omp.sections.case:
// CHECK1-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[AGG_CAPTURED]], i32 0, i32 0
// CHECK1-NEXT:    store i8** [[DOTTASK_RED_]], i8*** [[TMP68]], align 8
// CHECK1-NEXT:    [[TMP69:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[AGG_CAPTURED]], i32 0, i32 1
// CHECK1-NEXT:    store i32* [[ARGC]], i32** [[TMP69]], align 8
// CHECK1-NEXT:    [[TMP70:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[AGG_CAPTURED]], i32 0, i32 2
// CHECK1-NEXT:    [[TMP71:%.*]] = load i8**, i8*** [[TMP]], align 8
...
// CHECK1-NEXT:    [[TMP79:%.*]] = bitcast %struct.anon.0* [[AGG_CAPTURED]] to i8*
...
// CHECK1-NEXT:    [[TMP86:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK1-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP86]], 1
...
// CHECK1-NEXT:    [[TMP95:%.*]] = inttoptr i64 [[TMP15]] to i8*
...
// CHECK1-NEXT:    [[TMP99:%.*]] = call i32 @__kmpc_reduce(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP97]], i32 2, i64 24, i8* [[TMP98]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP100]], [[TMP101]]
// CHECK1-NEXT:    store i32 [[ADD]], i32* [[TMP2]], align 4
// CHECK1-NEXT:    [[TMP102:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP15]]
...
// CHECK1-NEXT:    [[TMP103:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST11]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP103]] to i32
// CHECK1-NEXT:    [[TMP104:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV12:%.*]] = sext i8 [[TMP104]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE16:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT15]], [[TMP102]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE16]], label [[OMP_ARRAYCPY_DONE17]], label [[OMP_ARRAYCPY_BODY]]
// CHECK1:       omp.arraycpy.done17:
// CHECK1-NEXT:    call void @__kmpc_end_reduce(%struct.ident_t* @[[GLOB3]], i32 [[TMP97]], [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[TMP107:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP15]]
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY18:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP107]]
...
// CHECK1-NEXT:    [[TMP108:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST20]], align 1
// CHECK1-NEXT:    [[CONV22:%.*]] = sext i8 [[TMP108]] to i32
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP109:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY19]] ], [ [[TMP114:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP109]], i8* [[_TMP23]], align 1
// CHECK1-NEXT:    [[TMP110:%.*]] = load i8, i8* [[_TMP23]], align 1
// CHECK1-NEXT:    [[CONV24:%.*]] = sext i8 [[TMP110]] to i32
// CHECK1-NEXT:    [[TMP111:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST20]], align 1
// CHECK1-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP111]] to i32
...
// CHECK1-NEXT:    [[TMP113:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST21]], i8 [[TMP109]], i8 [[TMP112]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE30:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT28]], [[TMP107]]
...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP116]])
// CHECK1-NEXT:    [[TMP117:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP118:%.*]] = load i32, i32* [[TMP117]], align 4
// CHECK1-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 [[TMP118]])
...
// CHECK2-NEXT:    [[TMP17:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK2-NEXT:    store i8* [[TMP25]], i8** [[_TMP4]], align 8
...
// CHECK2-NEXT:    [[TMP36:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 0
// CHECK2-NEXT:    [[TMP37:%.*]] = load i8**, i8*** [[TMP4]], align 8
// CHECK2-NEXT:    [[ARRAYIDX6:%.*]] = getelementptr inbounds i8*, i8** [[TMP37]], i64 0
// CHECK2-NEXT:    [[TMP38:%.*]] = load i8*, i8** [[ARRAYIDX6]], align 8
...
// CHECK2-NEXT:    [[LB_ADD_LEN8:%.*]] = add nsw i64 -1, [[TMP40]]
// CHECK2-NEXT:    [[TMP41:%.*]] = load i8**, i8*** [[TMP4]], align 8
// CHECK2-NEXT:    [[ARRAYIDX9:%.*]] = getelementptr inbounds i8*, i8** [[TMP41]], i64 9
// CHECK2-NEXT:    [[TMP42:%.*]] = load i8*, i8** [[ARRAYIDX9]], align 8
// CHECK2-NEXT:    [[ARRAYIDX10:%.*]] = getelementptr inbounds i8, i8* [[TMP42]], i64 [[LB_ADD_LEN8]]
// CHECK2-NEXT:    store i8* [[VLA]], i8** [[TMP36]], align 8
// CHECK2-NEXT:    [[TMP43:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 1
// CHECK2-NEXT:    store i8* [[ARRAYIDX7]], i8** [[TMP43]], align 8
// CHECK2-NEXT:    [[TMP44:%.*]] = ptrtoint i8* [[ARRAYIDX10]] to i64
// CHECK2-NEXT:    [[TMP45:%.*]] = ptrtoint i8* [[ARRAYIDX7]] to i64
...
// CHECK2-NEXT:    [[TMP50:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 2
// CHECK2-NEXT:    store i64 [[TMP49]], i64* [[TMP50]], align 8
// CHECK2-NEXT:    [[TMP51:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 3
// CHECK2-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_init..1 to i8*), i8** [[TMP51]], align 8
// CHECK2-NEXT:    [[TMP52:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 4
// CHECK2-NEXT:    store i8* null, i8** [[TMP52]], align 8
// CHECK2-NEXT:    [[TMP53:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 5
// CHECK2-NEXT:    store i8* bitcast (void (i8*, i8*)* @.red_comb..2 to i8*), i8** [[TMP53]], align 8
// CHECK2-NEXT:    [[TMP54:%.*]] = getelementptr inbounds [[STRUCT_KMP_TASKRED_INPUT_T]], %struct.kmp_taskred_input_t* [[DOTRD_INPUT_GEP_5]], i32 0, i32 6
...
// CHECK2-NEXT:    call void @__kmpc_for_static_init_4(%struct.ident_t* @[[GLOB2:[0-9]+]], i32 [[TMP60]], i32 34, i32* [[DOTOMP_SECTIONS_IL_]], i32* [[DOTOMP_SECTIONS_LB_]], i32* [[DOTOMP_SECTIONS_UB_]], i32* [[DOTOMP_SECTIONS_ST_]], i32 1, i32 1)
// CHECK2-NEXT:    [[TMP61:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK2-NEXT:    [[TMP62:%.*]] = icmp slt i32 [[TMP61]], 0
// CHECK2-NEXT:    [[TMP63:%.*]] = select i1 [[TMP62]], i32 [[TMP61]], i32 0
// CHECK2-NEXT:    store i32 [[TMP63]], i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK2-NEXT:    [[TMP64:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_LB_]], align 4
// CHECK2-NEXT:    store i32 [[TMP64]], i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    br label [[OMP_INNER_FOR_COND:%.*]]
// CHECK2:       omp.inner.for.cond:
// CHECK2-NEXT:    [[TMP65:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    [[TMP66:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_UB_]], align 4
// CHECK2-NEXT:    [[CMP:%.*]] = icmp sle i32 [[TMP65]], [[TMP66]]
// CHECK2-NEXT:    br i1 [[CMP]], label [[OMP_INNER_FOR_BODY:%.*]], label [[OMP_INNER_FOR_END:%.*]]
// CHECK2:       omp.inner.for.body:
// CHECK2-NEXT:    [[TMP67:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    switch i32 [[TMP67]], label [[DOTOMP_SECTIONS_EXIT:%.*]] [
// CHECK2-NEXT:    i32 0, label [[DOTOMP_SECTIONS_CASE:%.*]]
// CHECK2-NEXT:    ]
// CHECK2:       .omp.sections.case:
// CHECK2-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[AGG_CAPTURED]], i32 0, i32 0
// CHECK2-NEXT:    store i8** [[DOTTASK_RED_]], i8*** [[TMP68]], align 8
// CHECK2-NEXT:    [[TMP69:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[AGG_CAPTURED]], i32 0, i32 1
// CHECK2-NEXT:    store i32* [[ARGC]], i32** [[TMP69]], align 8
// CHECK2-NEXT:    [[TMP70:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[AGG_CAPTURED]], i32 0, i32 2
// CHECK2-NEXT:    [[TMP71:%.*]] = load i8**, i8*** [[TMP]], align 8
...
// CHECK2-NEXT:    [[TMP79:%.*]] = bitcast %struct.anon.0* [[AGG_CAPTURED]] to i8*
...
// CHECK2-NEXT:    [[TMP86:%.*]] = load i32, i32* [[DOTOMP_SECTIONS_IV_]], align 4
// CHECK2-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP86]], 1
...
// CHECK2-NEXT:    [[TMP95:%.*]] = inttoptr i64 [[TMP15]] to i8*
...
// CHECK2-NEXT:    [[TMP99:%.*]] = call i32 @__kmpc_reduce(%struct.ident_t* @[[GLOB3:[0-9]+]], i32 [[TMP97]], i32 2, i64 24, i8* [[TMP98]], void (i8*, i8*)* @.omp.reduction.reduction_func, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i32 [[TMP100]], [[TMP101]]
// CHECK2-NEXT:    store i32 [[ADD]], i32* [[TMP2]], align 4
// CHECK2-NEXT:    [[TMP102:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP15]]
...
// CHECK2-NEXT:    [[TMP103:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST11]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = sext i8 [[TMP103]] to i32
// CHECK2-NEXT:    [[TMP104:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK2-NEXT:    [[CONV12:%.*]] = sext i8 [[TMP104]] to i32
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE16:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT15]], [[TMP102]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYCPY_DONE16]], label [[OMP_ARRAYCPY_DONE17]], label [[OMP_ARRAYCPY_BODY]]
// CHECK2:       omp.arraycpy.done17:
// CHECK2-NEXT:    call void @__kmpc_end_reduce(%struct.ident_t* @[[GLOB3]], i32 [[TMP97]], [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK2-NEXT:    [[TMP107:%.*]] = getelementptr i8, i8* [[ARRAYIDX1]], i64 [[TMP15]]
// CHECK2-NEXT:    [[OMP_ARRAYCPY_ISEMPTY18:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP107]]
...
// CHECK2-NEXT:    [[TMP108:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST20]], align 1
// CHECK2-NEXT:    [[CONV22:%.*]] = sext i8 [[TMP108]] to i32
...
// CHECK2:       atomic_cont:
// CHECK2-NEXT:    [[TMP109:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY19]] ], [ [[TMP114:%.*]], [[ATOMIC_CONT]] ]
// CHECK2-NEXT:    store i8 [[TMP109]], i8* [[_TMP23]], align 1
// CHECK2-NEXT:    [[TMP110:%.*]] = load i8, i8* [[_TMP23]], align 1
// CHECK2-NEXT:    [[CONV24:%.*]] = sext i8 [[TMP110]] to i32
// CHECK2-NEXT:    [[TMP111:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST20]], align 1
// CHECK2-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP111]] to i32
...
// CHECK2-NEXT:    [[TMP113:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST21]], i8 [[TMP109]], i8 [[TMP112]] monotonic monotonic, align 1
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE30:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT28]], [[TMP107]]
...
// CHECK2-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP116]])
// CHECK2-NEXT:    [[TMP117:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP118:%.*]] = load i32, i32* [[TMP117]], align 4
// CHECK2-NEXT:    call void @__kmpc_barrier(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 [[TMP118]])
