...
// CHECK1-NEXT:    call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr @[[GLOB1:[0-9]+]], i32 2, ptr @.omp_outlined., ptr [[TMP0]], ptr [[TMP1]])
...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP111]])
// CHECK1-NEXT:    ret void
//
//
