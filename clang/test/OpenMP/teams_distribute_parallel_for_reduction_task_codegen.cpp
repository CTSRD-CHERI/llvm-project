...
// CHECK1-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_LB]], i64** [[TMP67]], align 8
// CHECK1-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK1-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP68]], align 8
// CHECK1-NEXT:    [[TMP69:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK1-NEXT:    store i32* [[ARGC]], i32** [[TMP69]], align 8
// CHECK1-NEXT:    [[TMP70:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 3
...
// CHECK1-NEXT:    [[TMP72:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK1-NEXT:    [[TMP73:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK1-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP72]], [[TMP73]]
...
// CHECK1-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP75]])
// CHECK1-NEXT:    [[TMP76:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK1-NEXT:    [[TMP77:%.*]] = load i32, i32* [[TMP76]], align 4
// CHECK1-NEXT:    call void @__kmpc_task_reduction_modifier_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP77]], i32 1)
...
// CHECK1-NEXT:    [[TMP86:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 [[TMP84]], i32 2, i64 24, i8* [[TMP85]], void (i8*, i8*)* @.omp.reduction.reduction_func.9, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[ADD13:%.*]] = add nsw i32 [[TMP87]], [[TMP88]]
...
// CHECK1-NEXT:    [[TMP90:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST14]], align 1
// CHECK1-NEXT:    [[CONV:%.*]] = sext i8 [[TMP90]] to i32
// CHECK1-NEXT:    [[TMP91:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK1-NEXT:    [[CONV15:%.*]] = sext i8 [[TMP91]] to i32
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP89]]
// CHECK1-NEXT:    br i1 [[OMP_ARRAYCPY_DONE19]], label [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_BODY]]
// CHECK1:       omp.arraycpy.done20:
// CHECK1-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP84]], [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP94]]
...
// CHECK1-NEXT:    [[TMP95:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
...
// CHECK1:       atomic_cont:
// CHECK1-NEXT:    [[TMP96:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP101:%.*]], [[ATOMIC_CONT]] ]
// CHECK1-NEXT:    store i8 [[TMP96]], i8* [[_TMP26]], align 1
// CHECK1-NEXT:    [[TMP97:%.*]] = load i8, i8* [[_TMP26]], align 1
// CHECK1-NEXT:    [[CONV27:%.*]] = sext i8 [[TMP97]] to i32
// CHECK1-NEXT:    [[TMP98:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK1-NEXT:    [[CONV28:%.*]] = sext i8 [[TMP98]] to i32
...
// CHECK1-NEXT:    [[TMP100:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP96]], i8 [[TMP99]] monotonic monotonic, align 1
...
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DONE33:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT31]], [[TMP94]]
...
// CHECK1-NEXT:    [[TMP22:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP120]])
// CHECK1-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_LB]], i64** [[TMP67]], align 8
// CHECK2-NEXT:    [[TMP68:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 1
// CHECK2-NEXT:    store i64* [[DOTCAPTURED_OMP_PREVIOUS_UB]], i64** [[TMP68]], align 8
// CHECK2-NEXT:    [[TMP69:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 2
// CHECK2-NEXT:    store i32* [[ARGC]], i32** [[TMP69]], align 8
// CHECK2-NEXT:    [[TMP70:%.*]] = getelementptr inbounds [[STRUCT_ANON_0]], %struct.anon.0* [[OMP_OUTLINED_ARG_AGG_]], i32 0, i32 3
...
// CHECK2-NEXT:    [[TMP72:%.*]] = load i64, i64* [[DOTOMP_IV]], align 8
// CHECK2-NEXT:    [[TMP73:%.*]] = load i64, i64* [[DOTOMP_STRIDE]], align 8
// CHECK2-NEXT:    [[ADD:%.*]] = add nsw i64 [[TMP72]], [[TMP73]]
...
// CHECK2-NEXT:    call void @__kmpc_for_static_fini(%struct.ident_t* @[[GLOB2]], i32 [[TMP75]])
// CHECK2-NEXT:    [[TMP76:%.*]] = load i32*, i32** [[DOTGLOBAL_TID__ADDR]], align 8
// CHECK2-NEXT:    [[TMP77:%.*]] = load i32, i32* [[TMP76]], align 4
// CHECK2-NEXT:    call void @__kmpc_task_reduction_modifier_fini(%struct.ident_t* @[[GLOB1]], i32 [[TMP77]], i32 1)
...
// CHECK2-NEXT:    [[TMP86:%.*]] = call i32 @__kmpc_reduce_nowait(%struct.ident_t* @[[GLOB4:[0-9]+]], i32 [[TMP84]], i32 2, i64 24, i8* [[TMP85]], void (i8*, i8*)* @.omp.reduction.reduction_func.9, [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK2-NEXT:    [[ADD13:%.*]] = add nsw i32 [[TMP87]], [[TMP88]]
...
// CHECK2-NEXT:    [[TMP90:%.*]] = load i8, i8* [[OMP_ARRAYCPY_DESTELEMENTPAST14]], align 1
// CHECK2-NEXT:    [[CONV:%.*]] = sext i8 [[TMP90]] to i32
// CHECK2-NEXT:    [[TMP91:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST]], align 1
// CHECK2-NEXT:    [[CONV15:%.*]] = sext i8 [[TMP91]] to i32
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE19:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT18]], [[TMP89]]
// CHECK2-NEXT:    br i1 [[OMP_ARRAYCPY_DONE19]], label [[OMP_ARRAYCPY_DONE20]], label [[OMP_ARRAYCPY_BODY]]
// CHECK2:       omp.arraycpy.done20:
// CHECK2-NEXT:    call void @__kmpc_end_reduce_nowait(%struct.ident_t* @[[GLOB4]], i32 [[TMP84]], [8 x i32]* @.gomp_critical_user_.reduction.var)
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_ISEMPTY21:%.*]] = icmp eq i8* [[ARRAYIDX1]], [[TMP94]]
...
// CHECK2-NEXT:    [[TMP95:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK2-NEXT:    [[CONV25:%.*]] = sext i8 [[TMP95]] to i32
...
// CHECK2:       atomic_cont:
// CHECK2-NEXT:    [[TMP96:%.*]] = phi i8 [ [[ATOMIC_LOAD]], [[OMP_ARRAYCPY_BODY22]] ], [ [[TMP101:%.*]], [[ATOMIC_CONT]] ]
// CHECK2-NEXT:    store i8 [[TMP96]], i8* [[_TMP26]], align 1
// CHECK2-NEXT:    [[TMP97:%.*]] = load i8, i8* [[_TMP26]], align 1
// CHECK2-NEXT:    [[CONV27:%.*]] = sext i8 [[TMP97]] to i32
// CHECK2-NEXT:    [[TMP98:%.*]] = load i8, i8* [[OMP_ARRAYCPY_SRCELEMENTPAST23]], align 1
// CHECK2-NEXT:    [[CONV28:%.*]] = sext i8 [[TMP98]] to i32
...
// CHECK2-NEXT:    [[TMP100:%.*]] = cmpxchg i8* [[OMP_ARRAYCPY_DESTELEMENTPAST24]], i8 [[TMP96]], i8 [[TMP99]] monotonic monotonic, align 1
...
// CHECK2-NEXT:    [[OMP_ARRAYCPY_DONE33:%.*]] = icmp eq i8* [[OMP_ARRAYCPY_DEST_ELEMENT31]], [[TMP94]]
...
// CHECK2-NEXT:    [[TMP22:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK2-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP120]])
// CHECK2-NEXT:    ret void
//
//
