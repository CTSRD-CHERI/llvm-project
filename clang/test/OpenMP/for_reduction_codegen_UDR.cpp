...
// CHECK1-NEXT:    call void @.omp_initializer.(%struct.S* noundef [[S]], %struct.S* noundef [[TMP2]])
...
// CHECK1-NEXT:    call void @.omp_combiner.(%struct.S* noundef [[TMP2]], %struct.S* noundef [[S]])
// CHECK1-NEXT:    call void @_ZN1SIiED1Ev(%struct.S* noundef nonnull align 4 dereferenceable(12) [[S]]) #[[ATTR4]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    [[CALL16:%.*]] = call noundef i32 @_Z5tmainIiLi42EET_v()
...
// CHECK1-NEXT:    call void @_ZN1SIfED1Ev(%struct.S.0* noundef nonnull align 4 dereferenceable(12) [[ARRAYDESTROY_ELEMENT28]]) #[[ATTR4]]
...
// CHECK1-NEXT:    call void @.omp_initializer..3(float* noundef [[T_VAR]], float* noundef [[TMP2]])
...
// CHECK1-NEXT:    call void @.omp_initializer..5(%struct.BaseS1* noundef [[TMP16]], %struct.BaseS1* noundef [[TMP18]])
// CHECK1-NEXT:    store %struct.S.0* [[VAR]], %struct.S.0** [[_TMP4]], align 8
// CHECK1-NEXT:    call void @.omp_initializer..7(%struct.S.0* noundef [[VAR1]], %struct.S.0* noundef [[TMP6]])
...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(12) %struct.S.0* @_ZN1SIfEaSERKS0_(%struct.S.0* noundef nonnull align 4 dereferenceable(12) [[ARRAYIDX7]], %struct.S.0* noundef nonnull align 4 dereferenceable(12) [[TMP30]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    call void @.omp_combiner..2(float* noundef [[TMP2]], float* noundef [[T_VAR]])
...
// CHECK1-NEXT:    call void @.omp_combiner..6(%struct.S.0* noundef [[TMP6]], %struct.S.0* noundef [[VAR1]])
// CHECK1-NEXT:    call void @.omp_combiner..8(float* noundef [[TMP8]], float* noundef [[T_VAR1]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP48]], %struct.BaseS1* noundef [[TMP50]])
// CHECK1-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB1]], i32 [[TMP21]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    call void @__kmpc_critical(%struct.ident_t* @[[GLOB1]], i32 [[TMP21]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
// CHECK1-NEXT:    call void @.omp_combiner..6(%struct.S.0* noundef [[TMP6]], %struct.S.0* noundef [[VAR1]])
// CHECK1-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB1]], i32 [[TMP21]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
...
// CHECK1-NEXT:    call void @_ZN1SIfED1Ev(%struct.S.0* noundef nonnull align 4 dereferenceable(12) [[VAR1]]) #[[ATTR4]]
// CHECK1-NEXT:    call void @_ZN1SIfED1Ev(%struct.S.0* noundef nonnull align 4 dereferenceable(12) [[VAR]]) #[[ATTR4]]
...
// CHECK1-NEXT:    call void @.omp_initializer..5(%struct.BaseS1* noundef [[TMP38]], %struct.BaseS1* noundef [[TMP40]])
...
// CHECK1-NEXT:    call void @.omp_combiner..10(i32* noundef [[OMP_ARRAYCPY_DESTELEMENTPAST28]], i32* noundef [[OMP_ARRAYCPY_SRCELEMENTPAST27]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP77]], %struct.BaseS1* noundef [[TMP79]])
...
// CHECK1-NEXT:    call void @.omp_combiner..10(i32* noundef [[OMP_ARRAYCPY_DESTELEMENTPAST45]], i32* noundef [[OMP_ARRAYCPY_SRCELEMENTPAST44]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP87]], %struct.BaseS1* noundef [[TMP89]])
...
// CHECK1-NEXT:    call void @.omp_initializer..5(%struct.BaseS1* noundef [[TMP17]], %struct.BaseS1* noundef [[TMP19]])
...
// CHECK1-NEXT:    call void @.omp_combiner..10(i32* noundef [[OMP_ARRAYCPY_DESTELEMENTPAST15]], i32* noundef [[OMP_ARRAYCPY_SRCELEMENTPAST14]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP47]], %struct.BaseS1* noundef [[TMP49]])
...
// CHECK1-NEXT:    call void @.omp_combiner..10(i32* noundef [[OMP_ARRAYCPY_DESTELEMENTPAST32]], i32* noundef [[OMP_ARRAYCPY_SRCELEMENTPAST31]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP57]], %struct.BaseS1* noundef [[TMP59]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP54]], %struct.BaseS1* noundef [[TMP56]])
// CHECK1-NEXT:    call void @__kmpc_end_critical(%struct.ident_t* @[[GLOB1]], i32 [[TMP52]], [8 x i32]* @.gomp_critical_user_.atomic_reduction.var)
...
// CHECK1-SAME: (i32* noalias noundef [[DOTGLOBAL_TID_:%.*]], i32* noalias noundef [[DOTBOUND_TID_:%.*]], %struct.anon.5* noalias noundef [[__CONTEXT:%.*]]) #[[ATTR2]] {
// CHECK1-NEXT:  entry:
// CHECK1-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK1-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK1-NEXT:    [[ADD_PTR2:%.*]] = getelementptr inbounds i8, i8* [[TMP6]], i64 4
// CHECK1-NEXT:    [[TMP7:%.*]] = bitcast i8* [[ADD_PTR2]] to %struct.BaseS1*
// CHECK1-NEXT:    call void @.omp_initializer..5(%struct.BaseS1* noundef [[TMP5]], %struct.BaseS1* noundef [[TMP7]])
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP35]], %struct.BaseS1* noundef [[TMP37]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP39]], %struct.BaseS1* noundef [[TMP41]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP46]], %struct.BaseS1* noundef [[TMP48]])
...
// CHECK1-NEXT:    call void @.omp_initializer..5(%struct.BaseS1* noundef [[TMP10]], %struct.BaseS1* noundef [[TMP12]])
// CHECK1-NEXT:    [[OMP_ARRAYCPY_DEST_ELEMENT]] = getelementptr [[STRUCT_S_0]], %struct.S.0* [[OMP_ARRAYCPY_SRCELEMENTPAST]], i32 1
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP26]], %struct.BaseS1* noundef [[TMP28]])
...
// CHECK1-NEXT:    call void @_ZN1SIiED1Ev(%struct.S* noundef nonnull align 4 dereferenceable(12) [[ARRAYDESTROY_ELEMENT8]]) #[[ATTR4]]
...
// CHECK1-NEXT:    store i32 1, i32* [[DOTOMP_STRIDE]], align 4
// CHECK1-NEXT:    store i32 0, i32* [[DOTOMP_IS_LAST]], align 4
// CHECK1-NEXT:    call void @.omp_initializer..25(i32* noundef [[T_VAR]], i32* noundef [[TMP2]])
...
// CHECK1-NEXT:    call void @.omp_initializer..27(%struct.S* noundef [[VAR1]], %struct.S* noundef [[TMP6]])
// CHECK1-NEXT:    call void @.omp_initializer..29(i32* noundef [[T_VAR1]], i32* noundef [[TMP8]])
...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(12) %struct.S* @_ZN1SIiEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(12) [[ARRAYIDX7]], %struct.S* noundef nonnull align 4 dereferenceable(12) [[TMP29]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    call void @.omp_combiner..24(i32* noundef [[TMP2]], i32* noundef [[T_VAR]])
...
// CHECK1-NEXT:    call void @.omp_combiner..4(%struct.BaseS1* noundef [[TMP43]], %struct.BaseS1* noundef [[TMP45]])
// CHECK1-NEXT:    call void @.omp_combiner..26(%struct.S* noundef [[TMP6]], %struct.S* noundef [[VAR1]])
// CHECK1-NEXT:    call void @.omp_combiner..28(i32* noundef [[TMP8]], i32* noundef [[T_VAR1]])
...
// CHECK1:       .omp.reduction.default:
// CHECK1-NEXT:    call void @_ZN1SIiED1Ev(%struct.S* noundef nonnull align 4 dereferenceable(12) [[VAR1]]) #[[ATTR4]]
// CHECK1-NEXT:    call void @_ZN1SIiED1Ev(%struct.S* noundef nonnull align 4 dereferenceable(12) [[VAR]]) #[[ATTR4]]
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-SAME: (i32* noalias noundef [[DOTGLOBAL_TID_:%.*]], i32* noalias noundef [[DOTBOUND_TID_:%.*]], %struct.anon.9* noalias noundef [[__CONTEXT:%.*]]) #[[ATTR2]] {
// CHECK1-NEXT:  entry:
// CHECK1-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK1-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(12) %struct.S* @_ZN1SIiEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(12) [[ARRAYIDX5]], %struct.S* noundef nonnull align 4 dereferenceable(12) [[TMP21]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    ]
// CHECK1:       .omp.reduction.case1:
// CHECK1-NEXT:    call void @.omp_combiner..34(i32* noundef [[TMP2]], i32* noundef [[T_VAR]])
...
// CHECK1-SAME: (i32* noalias noundef [[DOTGLOBAL_TID_:%.*]], i32* noalias noundef [[DOTBOUND_TID_:%.*]], %struct.anon.10* noalias noundef [[__CONTEXT:%.*]]) #[[ATTR2]] {
// CHECK1-NEXT:  entry:
// CHECK1-NEXT:    [[DOTGLOBAL_TID__ADDR:%.*]] = alloca i32*, align 8
// CHECK1-NEXT:    [[DOTBOUND_TID__ADDR:%.*]] = alloca i32*, align 8
...
// CHECK1-NEXT:    call void @.omp_initializer..37(%struct.BaseS1* noundef [[TMP14]], %struct.BaseS1* noundef [[TMP16]])
...
// CHECK1-NEXT:    [[CALL:%.*]] = call noundef nonnull align 4 dereferenceable(12) %struct.S* @_ZN1SIiEaSERKS0_(%struct.S* noundef nonnull align 4 dereferenceable(12) [[ARRAYIDX9]], %struct.S* noundef nonnull align 4 dereferenceable(12) [[TMP35]])
// CHECK1-NEXT:    br label [[OMP_BODY_CONTINUE:%.*]]
// CHECK1:       omp.body.continue:
// CHECK1-NEXT:    br label [[OMP_INNER_FOR_INC:%.*]]
// CHECK1:       omp.inner.for.inc:
...
// CHECK1-NEXT:    call void @.omp_combiner..36(%struct.BaseS1* noundef [[TMP48]], %struct.BaseS1* noundef [[TMP50]])
...
// CHECK1-NEXT:    call void @.omp_combiner..36(%struct.BaseS1* noundef [[TMP55]], %struct.BaseS1* noundef [[TMP57]])
