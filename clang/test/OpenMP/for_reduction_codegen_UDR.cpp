...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP27]])
...
// CHECK1-NEXT:    [[TMP21:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP91]])
// CHECK1-NEXT:    ret void
//
//
...
// CHECK1-NEXT:    [[TMP12:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP61]])
...
// CHECK1-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP58]])
...
// CHECK2-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP27]])
...
// CHECK2-NEXT:    [[TMP21:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK2-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP91]])
// CHECK2-NEXT:    ret void
//
//
...
// CHECK2-NEXT:    [[TMP12:%.*]] = call i8* @llvm.stacksave.p0i8()
...
// CHECK2-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP61]])
...
// CHECK2-NEXT:    call void @llvm.stackrestore.p0i8(i8* [[TMP58]])
