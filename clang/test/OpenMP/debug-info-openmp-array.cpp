...
// CHECK-NEXT:    call void @llvm.dbg.declare(metadata ptr [[M_ADDR]], metadata [[META11:![0-9]+]], metadata !DIExpression()), !dbg [[DBG12:![0-9]+]]
// CHECK-NEXT:    call void @llvm.dbg.declare(metadata ptr [[I]], metadata [[META13:![0-9]+]], metadata !DIExpression()), !dbg [[DBG14:![0-9]+]]
// CHECK-NEXT:    [[TMP0:%.*]] = load i32, ptr [[M_ADDR]], align 4, !dbg [[DBG15:![0-9]+]]
...
// CHECK-NEXT:    call void @llvm.dbg.declare(metadata ptr [[__VLA_EXPR0]], metadata [[META17:![0-9]+]], metadata !DIExpression()), !dbg [[DBG19:![0-9]+]]
// CHECK-NEXT:    call void @llvm.dbg.declare(metadata ptr [[VLA]], metadata [[META20:![0-9]+]], metadata !DIExpression()), !dbg [[DBG24:![0-9]+]]
// CHECK-NEXT:    store i32 0, ptr [[I]], align 4, !dbg [[DBG25:![0-9]+]]
// CHECK-NEXT:    br label [[FOR_COND:%.*]], !dbg [[DBG28:![0-9]+]]
// CHECK:       for.cond:
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG29:![0-9]+]]
// CHECK-NEXT:    [[TMP4:%.*]] = load i32, ptr [[M_ADDR]], align 4, !dbg [[DBG31:![0-9]+]]
// CHECK-NEXT:    [[CMP:%.*]] = icmp slt i32 [[TMP3]], [[TMP4]], !dbg [[DBG32:![0-9]+]]
// CHECK-NEXT:    br i1 [[CMP]], label [[FOR_BODY:%.*]], label [[FOR_END:%.*]], !dbg [[DBG33:![0-9]+]]
// CHECK:       for.body:
// CHECK-NEXT:    [[TMP5:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG34:![0-9]+]]
// CHECK-NEXT:    [[TMP6:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG36:![0-9]+]]
// CHECK-NEXT:    [[IDXPROM:%.*]] = sext i32 [[TMP6]] to i64, !dbg [[DBG37:![0-9]+]]
// CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds i32, ptr [[VLA]], i64 [[IDXPROM]], !dbg [[DBG37]]
// CHECK-NEXT:    store i32 [[TMP5]], ptr [[ARRAYIDX]], align 4, !dbg [[DBG38:![0-9]+]]
// CHECK-NEXT:    br label [[FOR_INC:%.*]], !dbg [[DBG39:![0-9]+]]
// CHECK:       for.inc:
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr [[I]], align 4, !dbg [[DBG40:![0-9]+]]
// CHECK-NEXT:    [[INC:%.*]] = add nsw i32 [[TMP7]], 1, !dbg [[DBG40]]
// CHECK-NEXT:    store i32 [[INC]], ptr [[I]], align 4, !dbg [[DBG40]]
// CHECK-NEXT:    br label [[FOR_COND]], !dbg [[DBG41:![0-9]+]], !llvm.loop [[LOOP42:![0-9]+]]
// CHECK:       for.end:
// CHECK-NEXT:    [[TMP8:%.*]] = load ptr, ptr [[SAVED_STACK]], align 8, !dbg [[DBG45:![0-9]+]]
// CHECK-NEXT:    call void @llvm.stackrestore.p0(ptr [[TMP8]]), !dbg [[DBG45]]
