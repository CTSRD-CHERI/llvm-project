...
// RUN: diff -w %S/transitive_includes/expected.algorithm %t.actual.algorithm
#if defined(TEST_0)
#include <algorithm>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.any %t.actual.any
#if defined(TEST_1)
#include <any>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.array %t.actual.array
#if defined(TEST_2)
#include <array>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.atomic %t.actual.atomic
#if defined(TEST_3)
#include <atomic>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.barrier %t.actual.barrier
#if defined(TEST_4)
#include <barrier>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.bit %t.actual.bit
#if defined(TEST_5)
#include <bit>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.bitset %t.actual.bitset
#if defined(TEST_6)
#include <bitset>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ccomplex %t.actual.ccomplex
#if defined(TEST_8)
#include <ccomplex>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cctype %t.actual.cctype
#if defined(TEST_9)
#include <cctype>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cerrno %t.actual.cerrno
#if defined(TEST_10)
#include <cerrno>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cfenv %t.actual.cfenv
#if defined(TEST_11)
#include <cfenv>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cfloat %t.actual.cfloat
#if defined(TEST_12)
#include <cfloat>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.charconv %t.actual.charconv
#if defined(TEST_13)
#include <charconv>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.chrono %t.actual.chrono
#if defined(TEST_14)
#include <chrono>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cinttypes %t.actual.cinttypes
#if defined(TEST_15)
#include <cinttypes>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ciso646 %t.actual.ciso646
#if defined(TEST_16)
#include <ciso646>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.climits %t.actual.climits
#if defined(TEST_17)
#include <climits>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.clocale %t.actual.clocale
#if defined(TEST_18)
#include <clocale>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cmath %t.actual.cmath
#if defined(TEST_19)
#include <cmath>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.codecvt %t.actual.codecvt
#if defined(TEST_20)
#include <codecvt>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.compare %t.actual.compare
#if defined(TEST_21)
#include <compare>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.complex %t.actual.complex
#if defined(TEST_22)
#include <complex>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.concepts %t.actual.concepts
#if defined(TEST_24)
#include <concepts>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.condition_variable %t.actual.condition_variable
#if defined(TEST_25)
...
// RUN: diff -w %S/transitive_includes/expected.coroutine %t.actual.coroutine
#if defined(TEST_26)
#include <coroutine>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.csetjmp %t.actual.csetjmp
#if defined(TEST_27)
#include <csetjmp>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.csignal %t.actual.csignal
#if defined(TEST_28)
#include <csignal>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cstdarg %t.actual.cstdarg
#if defined(TEST_29)
#include <cstdarg>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cstdbool %t.actual.cstdbool
#if defined(TEST_30)
#include <cstdbool>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cstddef %t.actual.cstddef
#if defined(TEST_31)
#include <cstddef>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cstdint %t.actual.cstdint
#if defined(TEST_32)
#include <cstdint>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cstdio %t.actual.cstdio
#if defined(TEST_33)
#include <cstdio>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cstdlib %t.actual.cstdlib
#if defined(TEST_34)
#include <cstdlib>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ctgmath %t.actual.ctgmath
#if defined(TEST_36)
#include <ctgmath>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ctime %t.actual.ctime
#if defined(TEST_37)
#include <ctime>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cuchar %t.actual.cuchar
#if defined(TEST_39)
#include <cuchar>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cwchar %t.actual.cwchar
#if defined(TEST_40)
#include <cwchar>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.cwctype %t.actual.cwctype
#if defined(TEST_41)
#include <cwctype>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.deque %t.actual.deque
#if defined(TEST_42)
#include <deque>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.exception %t.actual.exception
#if defined(TEST_44)
#include <exception>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.execution %t.actual.execution
#if defined(TEST_45)
#include <execution>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.filesystem %t.actual.filesystem
#if defined(TEST_47)
#include <filesystem>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.format %t.actual.format
#if defined(TEST_49)
#include <format>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.forward_list %t.actual.forward_list
#if defined(TEST_50)
...
// RUN: diff -w %S/transitive_includes/expected.fstream %t.actual.fstream
#if defined(TEST_51)
#include <fstream>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.functional %t.actual.functional
#if defined(TEST_52)
#include <functional>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.initializer_list %t.actual.initializer_list
#if defined(TEST_54)
...
// RUN: diff -w %S/transitive_includes/expected.iomanip %t.actual.iomanip
#if defined(TEST_56)
#include <iomanip>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ios %t.actual.ios
#if defined(TEST_57)
#include <ios>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.iosfwd %t.actual.iosfwd
#if defined(TEST_58)
#include <iosfwd>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.iostream %t.actual.iostream
#if defined(TEST_59)
#include <iostream>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.istream %t.actual.istream
#if defined(TEST_60)
#include <istream>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.iterator %t.actual.iterator
#if defined(TEST_61)
#include <iterator>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.latch %t.actual.latch
#if defined(TEST_62)
#include <latch>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.limits %t.actual.limits
#if defined(TEST_63)
#include <limits>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.list %t.actual.list
#if defined(TEST_65)
#include <list>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.locale %t.actual.locale
#if defined(TEST_66)
#include <locale>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.map %t.actual.map
#if defined(TEST_68)
#include <map>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.memory %t.actual.memory
#if defined(TEST_70)
#include <memory>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.mutex %t.actual.mutex
#if defined(TEST_71)
#include <mutex>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.new %t.actual.new
#if defined(TEST_72)
#include <new>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.numbers %t.actual.numbers
#if defined(TEST_73)
#include <numbers>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.numeric %t.actual.numeric
#if defined(TEST_74)
#include <numeric>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.optional %t.actual.optional
#if defined(TEST_75)
#include <optional>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ostream %t.actual.ostream
#if defined(TEST_76)
#include <ostream>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.queue %t.actual.queue
#if defined(TEST_77)
#include <queue>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.ratio %t.actual.ratio
#if defined(TEST_80)
#include <ratio>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.regex %t.actual.regex
#if defined(TEST_81)
#include <regex>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.semaphore %t.actual.semaphore
#if defined(TEST_83)
#include <semaphore>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.set %t.actual.set
#if defined(TEST_84)
#include <set>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.shared_mutex %t.actual.shared_mutex
#if defined(TEST_86)
...
// RUN: diff -w %S/transitive_includes/expected.span %t.actual.span
#if defined(TEST_87)
#include <span>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.sstream %t.actual.sstream
#if defined(TEST_88)
#include <sstream>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.stack %t.actual.stack
#if defined(TEST_89)
#include <stack>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.stdexcept %t.actual.stdexcept
#if defined(TEST_93)
#include <stdexcept>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.streambuf %t.actual.streambuf
#if defined(TEST_97)
#include <streambuf>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.string %t.actual.string
#if defined(TEST_98)
#include <string>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.string_view %t.actual.string_view
#if defined(TEST_100)
#include <string_view>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.strstream %t.actual.strstream
#if defined(TEST_101)
#include <strstream>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.system_error %t.actual.system_error
#if defined(TEST_102)
...
// RUN: diff -w %S/transitive_includes/expected.thread %t.actual.thread
#if defined(TEST_104)
#include <thread>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.tuple %t.actual.tuple
#if defined(TEST_105)
#include <tuple>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.type_traits %t.actual.type_traits
#if defined(TEST_106)
#include <type_traits>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.typeindex %t.actual.typeindex
#if defined(TEST_107)
#include <typeindex>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.typeinfo %t.actual.typeinfo
#if defined(TEST_108)
#include <typeinfo>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.unordered_map %t.actual.unordered_map
#if defined(TEST_110)
...
// RUN: diff -w %S/transitive_includes/expected.unordered_set %t.actual.unordered_set
#if defined(TEST_111)
...
// RUN: diff -w %S/transitive_includes/expected.utility %t.actual.utility
#if defined(TEST_112)
#include <utility>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.valarray %t.actual.valarray
#if defined(TEST_113)
#include <valarray>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.variant %t.actual.variant
#if defined(TEST_114)
#include <variant>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.vector %t.actual.vector
#if defined(TEST_115)
#include <vector>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.version %t.actual.version
#if defined(TEST_116)
#include <version>
#endif
...
// RUN: diff -w %S/transitive_includes/expected.experimental_algorithm %t.actual.experimental_algorithm
#if defined(TEST_119)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_coroutine %t.actual.experimental_coroutine
#if defined(TEST_120)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_deque %t.actual.experimental_deque
#if defined(TEST_121)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_forward_list %t.actual.experimental_forward_list
#if defined(TEST_122)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_functional %t.actual.experimental_functional
#if defined(TEST_123)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_iterator %t.actual.experimental_iterator
#if defined(TEST_124)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_list %t.actual.experimental_list
#if defined(TEST_125)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_map %t.actual.experimental_map
#if defined(TEST_126)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_propagate_const %t.actual.experimental_propagate_const
#if defined(TEST_128)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_regex %t.actual.experimental_regex
#if defined(TEST_129)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_set %t.actual.experimental_set
#if defined(TEST_130)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_string %t.actual.experimental_string
#if defined(TEST_132)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_type_traits %t.actual.experimental_type_traits
#if defined(TEST_133)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_utility %t.actual.experimental_utility
#if defined(TEST_136)
...
// RUN: diff -w %S/transitive_includes/expected.experimental_vector %t.actual.experimental_vector
#if defined(TEST_137)
...
// RUN: diff -w %S/transitive_includes/expected.ext_hash_map %t.actual.ext_hash_map
#if defined(TEST_138)
...
// RUN: diff -w %S/transitive_includes/expected.ext_hash_set %t.actual.ext_hash_set
#if defined(TEST_139)
