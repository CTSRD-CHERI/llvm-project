...
#if defined(__LP64__) || defined(_WIN64) || defined(_LIBCXXABI_ARM_EHABI) || defined(__CHERI_PURE_CAPABILITY__)
...
static_assert(offsetof(__cxa_dependent_exception, propagationCount) +
                  ...
                  sizeof(__cxa_dependent_exception),
              "propagationCount has wrong negative offset");
#elif defined(__LP64__) || defined(_WIN64) || defined(__CHERI_PURE_CAPABILITY__)
