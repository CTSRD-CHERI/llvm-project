...
; CHECK-LABEL: Function: testIncOffsetAlias: 5 pointers, 1 call sites
; CHECK-DAG:     MustAlias:	%struct.A addrspace(200)* %a, i8 addrspace(200)* %a.bitcast
; CHECK-DAG:     PartialAlias:	%struct.A addrspace(200)* %a, i8 addrspace(200)* %n
; CHECK-DAG:     NoAlias:	i8 addrspace(200)* %a.bitcast, i8 addrspace(200)* %n
; CHECK-DAG:     MayAlias:	%struct.A addrspace(200)* %a, i8 addrspace(200)* %a.laundered
...
; CHECK-DAG:     MayAlias:	i8 addrspace(200)* %n, i8 addrspace(200)* %n.laundered
; CHECK-DAG:     NoAlias:	i8 addrspace(200)* %a.laundered, i8 addrspace(200)* %n.laundered
; CHECK-DAG:     NoModRef:  Ptr: %struct.A addrspace(200)* %a	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 4)
; CHECK-DAG:     NoModRef:  Ptr: i8 addrspace(200)* %a.bitcast	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 4)
; CHECK-DAG:     NoModRef:  Ptr: i8 addrspace(200)* %n	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 4)
; CHECK-DAG:     NoModRef:  Ptr: i8 addrspace(200)* %a.laundered	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 4)
; CHECK-DAG:     NoModRef:  Ptr: i8 addrspace(200)* %n.laundered	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 4)
...
entry:
  ...
  %n.laundered = getelementptr inbounds i8, i8 addrspace(200)* %a.laundered, i64 8
  %v = load i8, i8 addrspace(200)* %n.laundered
; Also check that incoffset does not alias (TODO: it should for an offset of zero!
; Due to the bounds shrinking performed by setbounds the value is not accessible!
...
; CHECK-LABEL: Function: testIncOffsetZeroAlias: 5 pointers, 1 call sites
; CHECK-DAG:  MustAlias:	%struct.A addrspace(200)* %a, i8 addrspace(200)* %a.bitcast
; CHECK-DAG:  PartialAlias:	%struct.A addrspace(200)* %a, i8 addrspace(200)* %n
; CHECK-DAG:  NoAlias:	i8 addrspace(200)* %a.bitcast, i8 addrspace(200)* %n
...
; CHECK-DAG:  NoAlias:	i8 addrspace(200)* %a.laundered, i8 addrspace(200)* %n.laundered
; CHECK-DAG:  NoModRef:  Ptr: %struct.A addrspace(200)* %a	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 0)
; CHECK-DAG:  NoModRef:  Ptr: i8 addrspace(200)* %a.bitcast	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 0)
; CHECK-DAG:  NoModRef:  Ptr: i8 addrspace(200)* %n	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 0)
; CHECK-DAG:  NoModRef:  Ptr: i8 addrspace(200)* %a.laundered	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 0)
; CHECK-DAG:  NoModRef:  Ptr: i8 addrspace(200)* %n.laundered	<->  %a.laundered = call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* nonnull %a.bitcast, i64 0)
