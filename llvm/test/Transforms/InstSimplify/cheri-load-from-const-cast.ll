...
; transform generated a bad i128->ptr addrspace(200) bitcast after merging
...
define ptr addrspace(200) @test_nozero() addrspace(200) {
; CHECK-LABEL: @test_nozero(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[FOO:%.*]] = load ptr addrspace(200), ptr addrspace(200) @__const.nonzero, align 16
; CHECK-NEXT:    ret ptr addrspace(200) [[FOO]]
;
entry:
  %foo = load ptr addrspace(200), ptr addrspace(200) @__const.nonzero, align 16
  ret ptr addrspace(200) %foo
}

; However, for an all zero value we should be able to return null
define ptr addrspace(200) @test_zero() addrspace(200) {
; CHECK-LABEL: @test_zero(
; CHECK-NEXT:  entry:
; CHECK-NEXT:    ret ptr addrspace(200) null
;
entry:
  %foo = load ptr addrspace(200), ptr addrspace(200) @__const.zero, align 16
  ret ptr addrspace(200) %foo
}
