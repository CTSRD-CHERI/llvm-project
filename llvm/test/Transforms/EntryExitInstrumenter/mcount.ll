...
; CHECK-NEXT: %1 = call i8* @llvm.returnaddress.p0i8(i32 0)
...
; CHECK-NEXT %2 = call i8* @llvm.returnaddress.p0i8(i32 0)
; CHECK-NEXT call void @__cyg_profile_func_exit(i8* bitcast (void ()* @leaf_function to i8*), i8* %2)
; CHECK-NEXT %3 = call i8* @llvm.returnaddress.p0i8(i32 0)
