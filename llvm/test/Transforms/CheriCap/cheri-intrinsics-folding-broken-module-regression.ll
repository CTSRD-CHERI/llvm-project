...
;  %1 = sext i32 %0 to i64
;  %2 = call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* null, i64 %1)
;  %3 = call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* bitcast (i32 addrspace(200)* @d to i8 addrspace(200)*))
;  %4 = call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* %2)
;  %add = add i64 %3, %4
;  %5 = call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* bitcast (i32 addrspace(200)* @d to i8 addrspace(200)*), i64 %add)
;  %6 = load i32, i32 addrspace(200)* %y.addr, align 4
;  %7 = sext i32 %6 to i64
;  %8 = call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* null, i64 %7)
;  %9 = call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* %5)
;  %10 = call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* %8)
;  %add1 = add i64 %9, %10
;  %11 = call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* %5, i64 %add1)
...
;  %2 = tail call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* bitcast (i32 addrspace(200)* @d to i8 addrspace(200)*))
;  %add = add i64 %0, %2
;  %3 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* bitcast (i32 addrspace(200)* @d to i8 addrspace(200)*), i64 %0)
;  %4 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* bitcast (i32 addrspace(200)* @d to i8 addrspace(200)*), i64 %add)
;  %5 = sext i32 %y to i64
;  %6 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* null, i64 %5)
;  %7 = tail call i64 @llvm.cheri.cap.offset.get.i64(i8 addrspace(200)* %3)
;  %add1 = add i64 %5, %7
;  %8 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* %3, i64 %5)
;  %9 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* %3, i64 %add1)
...
entry:
  %0 = sext i32 %x to i64
  %1 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* bitcast (i32 addrspace(200)* @d to i8 addrspace(200)*), i64 %0)
  %2 = sext i32 %y to i64
  %3 = tail call i8 addrspace(200)* @llvm.cheri.cap.offset.increment.i64(i8 addrspace(200)* %1, i64 %2)
