...
; RUNnot: opt -opaque-pointers=0 -passes=instcombine -S %s -o - -debug-only=instcombine
; RUN: opt -opaque-pointers=0 -passes=instcombine -S %s -o - | FileCheck %s -check-prefixes CHECK
; RUNnot: %cheri_purecap_llc -opaque-pointers=0 %s -o -
