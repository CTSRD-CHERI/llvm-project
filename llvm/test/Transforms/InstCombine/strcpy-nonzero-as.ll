...
; CHECK-NEXT:  entry:
; CHECK-NEXT:    [[STRCPY:%.*]] = call i8 addrspace(200)* @strcpy(i8 addrspace(200)* noundef nonnull dereferenceable(1) [[DST]], i8 addrspace(200)* noundef nonnull dereferenceable(1) [[SRC]])
; CHECK-NEXT:    ret void
;
entry:
