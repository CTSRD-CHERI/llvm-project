...
; replacing ptr with ptr addrspace(200) etc. and changing the datalayout and
...
;
entry:
  %call = call ptr addrspace(200) @strchr(ptr addrspace(200) getelementptr inbounds ([7 x i8], ptr addrspace(200) @.str, i32 0, i32 0), i32 %arg)
  %tobool = icmp ne ptr addrspace(200) %call, null
  ret i1 %tobool
}

declare ptr addrspace(200) @strchr(ptr addrspace(200), i32) #1
