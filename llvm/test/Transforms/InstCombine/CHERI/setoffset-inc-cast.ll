...
; RUN: opt -opaque-pointers=0 -S -passes=instcombine %s -o - | FileCheck %s
; RUNNOT: opt -opaque-pointers=0 -S -passes=instcombine -o - < %s | %riscv64_cheri_purecap_llc -o %t-ic.ll
; RUNNOT: %riscv64_cheri_purecap_llc -opaque-pointers=0 < %s -o %t-no-ic.ll
