...
; CHECK: getelementptr [256 x float], [256 x float]* addrspacecast ([256 x float] addrspace(3)* @array to [256 x float]*), i64 0, i64 %i
  %1 = getelementptr [0 x float], [0 x float]* addrspacecast (float addrspace(3)* @scalar to [0 x float]*), i64 0, i64 %i
; CHECK: getelementptr [0 x float], [0 x float]* addrspacecast ([0 x float] addrspace(3)* bitcast (float addrspace(3)* @scalar to [0 x float] addrspace(3)*) to [0 x float]*), i64 0, i64 %i
