...
; RUN: opt -opaque-pointers=0 -S -passes=instcombine --data-layout="pf200:128:128:128:64" < %s | FileCheck %s --check-prefix=CHECK128
;; NB: This (incorrectly) uses a 128-bit index which previously crashed.
; RUN: opt -opaque-pointers=0 -S -passes=instcombine --data-layout="pf200:256:256:256:128" < %s | FileCheck %s --check-prefix=CHECK256
