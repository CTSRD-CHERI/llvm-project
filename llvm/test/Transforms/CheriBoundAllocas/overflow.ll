...
; RUN: %riscv32_cheri_purecap_opt -opaque-pointers=1 -cheri-bound-allocas -S < %s | FileCheck %s --check-prefix=OPAQUE
...
; OPAQUE-NEXT:    [[TMP3:%.*]] = bitcast ptr addrspace(200) [[TMP2]] to ptr addrspace(200)
; OPAQUE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr addrspace(200) [[TMP3]], i32 2147483646
; OPAQUE-NEXT:    [[TMP5:%.*]] = bitcast ptr addrspace(200) [[TMP4]] to ptr addrspace(200)
; OPAQUE-NEXT:    store volatile i32 [[A:%.*]], ptr addrspace(200) [[TMP5]], align 2
...
; OPAQUE-NEXT:    [[TMP3:%.*]] = bitcast ptr addrspace(200) [[TMP2]] to ptr addrspace(200)
; OPAQUE-NEXT:    [[TMP4:%.*]] = getelementptr i8, ptr addrspace(200) [[TMP3]], i32 2147483646
; OPAQUE-NEXT:    [[TMP5:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.i32(ptr addrspace(200) [[TMP4]], i32 4)
; OPAQUE-NEXT:    call void @use(ptr addrspace(200) [[TMP5]])
; OPAQUE-NEXT:    ret void
;
  %1 = alloca [4 x i8], align 1, addrspace(200)
  %2 = bitcast [4 x i8] addrspace(200)* %1 to i8 addrspace(200)*
