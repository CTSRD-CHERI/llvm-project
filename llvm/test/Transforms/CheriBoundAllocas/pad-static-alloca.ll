...
; RUN: %riscv64_cheri_purecap_opt -opaque-pointers=0 -cheri-bound-allocas -S < %s | FileCheck %s --check-prefixes=TYPED,OPT128
; RUN: %riscv64_cheri_purecap_opt -opaque-pointers=1 -cheri-bound-allocas -S < %s | FileCheck %s --check-prefix OPAQUE
...
; OPAQUE-NEXT:    [[PTR:%.*]] = getelementptr inbounds [10 x i8], ptr addrspace(200) [[TMP1]], i64 0, i64 0
; OPAQUE-NEXT:    call void @keep_live(ptr addrspace(200) nonnull [[PTR]])
...
; OPAQUE-NEXT:    [[PTR:%.*]] = getelementptr inbounds [16388 x i8], ptr addrspace(200) [[TMP1]], i64 0, i64 0
; OPAQUE-NEXT:    call void @keep_live(ptr addrspace(200) nonnull [[PTR]])
; OPAQUE-NEXT:    ret void
;
entry:
...
; OPAQUE-NEXT:    [[PTR:%.*]] = getelementptr inbounds [16388 x i8], ptr addrspace(200) [[TMP0]], i64 0, i64 0
; OPAQUE-NEXT:    store volatile i8 0, ptr addrspace(200) [[PTR]], align 1
; OPAQUE-NEXT:    ret void
;
entry:
  %0 = alloca [16388 x i8], align 1, addrspace(200)
