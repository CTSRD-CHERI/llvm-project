...
entry:
  ...
  call void @llvm.lifetime.start.p0i8(i64 6400, i8* %0) #3
  br label %for.body

for.cond.cleanup:                                 ; preds = %for.body
  %1 = bitcast [1600 x i32]* %c to i8*
  call void @llvm.lifetime.start.p0i8(i64 6400, i8* %1) #3
...
for.cond.cleanup5:                                ; preds = %for.body6
  call void @llvm.lifetime.end.p0i8(i64 6400, i8* nonnull %1) #3
  call void @llvm.lifetime.end.p0i8(i64 6400, i8* %0) #3
  ret i32 %add
