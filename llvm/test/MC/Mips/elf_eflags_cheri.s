...
# RUN: llvm-mc -filetype=obj -triple cheri-unknown-freebsd -mcpu=cheri -target-abi sandbox %s -o -| llvm-readobj -h | FileCheck --check-prefix=CHERI256-SANDBOX %s
# CHERI256-SANDBOX: Flags [ (0x30C2C004)
# RUN: llvm-mc -filetype=obj -triple cheri-unknown-freebsd -mcpu=cheri128 -target-abi sandbox %s -o -| llvm-readobj -h | FileCheck --check-prefix=CHERI128-SANDBOX %s
