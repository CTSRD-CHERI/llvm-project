...
.globl end
  subu  $4, $4, %lo($start)   # O32: [[@LINE]]:{{[0-9]+}}: error: unknown token in expression
  ...
  subu  $4, $4, %hi(end)      # O32: [[@LINE]]:{{[0-9]+}}: error: unknown token in expression
                              # N64: [[@LINE-1]]:{{[0-9]+}}: error: unknown token in expression
  ...
  subu  $4, %lo($start)       # O32: [[@LINE]]:{{[0-9]+}}: error: unknown token in expression
                              # N64: [[@LINE-1]]:{{[0-9]+}}: error: unknown token in expression
