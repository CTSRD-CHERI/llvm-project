...
hlv.wu  ca0, 0(ca1) # CHECK: :[[@LINE]]:1: error: instruction requires the following: 'H' (Hypervisor), 'zcheripurecap' (CHERI aware Instructions), Capability Pointer Mode, RV64I Base Instruction Set
