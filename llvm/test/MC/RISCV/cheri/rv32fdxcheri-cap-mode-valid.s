...
# CHECK-ASM-AND-OBJ: fsd fa0, 40(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x34,0xa5,0x02]
cfsd fa0, 40(ca0)
# CHECK-ASM-AND-OBJ: fsd fa0, 40(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x34,0xa5,0x02]
fsd fa0, 40(ca0)
# CHECK-ASM-AND-OBJ: fld fa0, 40(ca0)
...
# CHECK-ASM-AND-OBJ: fsw ft1, 40(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x24,0x15,0x02]
cfsw ft1, 40(ca0)
# CHECK-ASM-AND-OBJ: fsw ft1, 40(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x24,0x15,0x02]
fsw ft1, 40(ca0)
# CHECK-ASM-AND-OBJ: flw ft1, 40(ca0)
...
# CHECK-ASM-AND-OBJ: fsd fa0, 0(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x30,0xa5,0x00]
cfsd fa0, (ca0)
# CHECK-ASM-AND-OBJ: fsd fa0, 0(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x30,0xa5,0x00]
fsd fa0, (ca0)
# CHECK-ASM-AND-OBJ: fld fa0, 0(ca0)
...
# CHECK-ASM-AND-OBJ: fsw ft1, 0(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x20,0x15,0x00]
cfsw ft1, (ca0)
# CHECK-ASM-AND-OBJ: fsw ft1, 0(ca0)
# CHECK-ASM-SAME: encoding: [0x27,0x20,0x15,0x00]
fsw ft1, (ca0)
# CHECK-ASM-AND-OBJ: flw ft1, 0(ca0)
