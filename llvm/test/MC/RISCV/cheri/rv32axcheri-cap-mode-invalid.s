...
amoswap.w a1, a2, c3 # CHECK: :[[@LINE]]:19: error: expected '(' or optional integer offset
...
lr.w a4, (a5) # CHECK: :[[@LINE]]:1: error: instruction requires the following: Not Capability Mode

# Only .aq, .rl, and .aqrl suffixes are valid
amoxor.w.rlqa a2, a3, (c4) # CHECK: :[[@LINE]]:1: error: unrecognized instruction mnemonic
amoor.w.aq.rl a4, a5, (c6) # CHECK: :[[@LINE]]:1: error: unrecognized instruction mnemonic
amoor.w. a4, a5, (c6) # CHECK: :[[@LINE]]:1: error: unrecognized instruction mnemonic

# lr only takes two operands
lr.w s0, (cs1), s2 # CHECK: :[[@LINE]]:17: error: invalid operand for instruction
