...
; PURECAP-LIBCALLS-NEXT:    caddi ca1, csp, 7
...
; PURECAP-LIBCALLS-NEXT:    caddi ca1, csp, 6
...
; PURECAP-LIBCALLS-NEXT:    caddi ca1, csp, 4
...
; PURECAP-NEXT:    cmv ct0, ca1
; PURECAP-NEXT:    cmv cs0, ca0
; PURECAP-NEXT:    sw a3, 12(csp)
; PURECAP-NEXT:    sw a2, 8(csp)
; PURECAP-NEXT:    caddi ca0, csp, 8
; PURECAP-NEXT:    scbndsi ca1, ca0, 8
; PURECAP-NEXT:    li a4, 4
; PURECAP-NEXT:    li a5, 2
; PURECAP-NEXT:    cmv ca0, ct0
