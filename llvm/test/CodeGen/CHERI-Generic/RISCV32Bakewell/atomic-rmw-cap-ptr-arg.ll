...
; See https:
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+zcheripurecap,+cap-mode,+f -mattr=+a < %s | FileCheck %s --check-prefixes=PURECAP,PURECAP-ATOMICS --allow-unused-prefixes
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+zcheripurecap,+cap-mode,+f -mattr=-a < %s | FileCheck %s --check-prefixes=PURECAP,PURECAP-LIBCALLS --allow-unused-prefixes
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi ilp32f -mattr=+zcheripurecap,+zcherihybrid,+f -mattr=+a < %s | FileCheck %s --check-prefixes=HYBRID,HYBRID-ATOMICS --allow-unused-prefixes
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi ilp32f -mattr=+zcheripurecap,+zcherihybrid,+f -mattr=-a < %s | FileCheck %s --check-prefixes=HYBRID,HYBRID-LIBCALLS --allow-unused-prefixes
...
; PURECAP-ATOMICS-NEXT:    amoswap.c.aqrl ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
; PURECAP-LIBCALLS-LABEL: atomic_cap_ptr_xchg_sc:
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, -16
; PURECAP-LIBCALLS-NEXT:    sc cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_exchange_cap
; PURECAP-LIBCALLS-NEXT:    lc cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 16
...
; PURECAP-ATOMICS:       # %bb.0:
; PURECAP-ATOMICS-NEXT:    amoswap.c ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
...
; PURECAP-ATOMICS:       # %bb.0:
; PURECAP-ATOMICS-NEXT:    amoswap.c.aq ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
...
; PURECAP-ATOMICS:       # %bb.0:
; PURECAP-ATOMICS-NEXT:    amoswap.c.rl ca0, ca1, (ca0)
; PURECAP-ATOMICS-NEXT:    ret
;
...
; PURECAP-ATOMICS-NEXT:    lr.c.aqrl ca2, (ca0)
; PURECAP-ATOMICS-NEXT:    cadd ca3, ca2, a1
; PURECAP-ATOMICS-NEXT:    sc.c.aqrl a3, ca3, (ca0)
; PURECAP-ATOMICS-NEXT:    bnez a3, .LBB6_1
; PURECAP-ATOMICS-NEXT:  # %bb.2:
; PURECAP-ATOMICS-NEXT:    cmv ca0, ca2
; PURECAP-ATOMICS-NEXT:    ret
;
; PURECAP-LIBCALLS-LABEL: atomic_cap_ptr_add:
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, -48
; PURECAP-LIBCALLS-NEXT:    sc cra, 40(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sc cs0, 32(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sc cs1, 24(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sc cs2, 16(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    cmv cs0, ca0
; PURECAP-LIBCALLS-NEXT:    lc ca3, 0(ca0)
; PURECAP-LIBCALLS-NEXT:    cmv cs2, ca1
; PURECAP-LIBCALLS-NEXT:    caddi ca0, csp, 8
; PURECAP-LIBCALLS-NEXT:    scbndsi cs1, ca0, 8
...
; PURECAP-LIBCALLS-NEXT:    scaddr ca2, ca3, a0
; PURECAP-LIBCALLS-NEXT:    sc ca3, 8(csp)
; PURECAP-LIBCALLS-NEXT:    li a3, 5
; PURECAP-LIBCALLS-NEXT:    li a4, 5
; PURECAP-LIBCALLS-NEXT:    cmv ca0, cs0
; PURECAP-LIBCALLS-NEXT:    cmv ca1, cs1
; PURECAP-LIBCALLS-NEXT:    call __atomic_compare_exchange_cap
; PURECAP-LIBCALLS-NEXT:    lc ca3, 8(csp)
; PURECAP-LIBCALLS-NEXT:    beqz a0, .LBB6_1
; PURECAP-LIBCALLS-NEXT:  # %bb.2: # %atomicrmw.end
; PURECAP-LIBCALLS-NEXT:    cmv ca0, ca3
; PURECAP-LIBCALLS-NEXT:    lc cra, 40(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    lc cs0, 32(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    lc cs1, 24(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    lc cs2, 16(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    caddi csp, csp, 48
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-ATOMICS-NEXT:    scaddr ca3, ca2, a3
; PURECAP-ATOMICS-NEXT:    sc.c.aqrl a3, ca3, (ca0)
...
; PURECAP-ATOMICS-NEXT:    lr.c.aqrl ca2, (ca0)
; PURECAP-ATOMICS-NEXT:    cmv ca3, ca2
...
; PURECAP-LIBCALLS-NEXT:    sc cs1, 24(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sc cs2, 16(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    cmv cs2, ca0
; PURECAP-LIBCALLS-NEXT:    lc ca3, 0(ca0)
; PURECAP-LIBCALLS-NEXT:    cmv cs1, ca1
; PURECAP-LIBCALLS-NEXT:    caddi ca0, csp, 8
; PURECAP-LIBCALLS-NEXT:    scbndsi cs0, ca0, 8
