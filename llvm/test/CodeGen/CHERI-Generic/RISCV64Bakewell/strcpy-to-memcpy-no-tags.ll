...
; RUN: opt < %s -passes=instcombine -S | llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+zcheripurecap,+cap-mode,+f,+d - -o - | FileCheck %s --check-prefix=CHECK-ASM
...
; CHECK-ASM-NEXT:    auipc ca1, %pcrel_hi(.LCPI0_0)
; CHECK-ASM-NEXT:    caddi ca1, ca1, %pcrel_lo(.LBB0_1)
; CHECK-ASM-NEXT:    ld a1, 0(ca1)
; CHECK-ASM-NEXT:  .LBB0_2: # %entry
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca2, %pcrel_hi(.LCPI0_1)
; CHECK-ASM-NEXT:    caddi ca2, ca2, %pcrel_lo(.LBB0_2)
...
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca1, %pcrel_hi(.LCPI1_0)
; CHECK-ASM-NEXT:    caddi ca1, ca1, %pcrel_lo(.LBB1_1)
; CHECK-ASM-NEXT:    ld a1, 0(ca1)
; CHECK-ASM-NEXT:  .LBB1_2: # %entry
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca2, %pcrel_hi(.LCPI1_1)
; CHECK-ASM-NEXT:    caddi ca2, ca2, %pcrel_lo(.LBB1_2)
; CHECK-ASM-NEXT:    ld a2, 0(ca2)
; CHECK-ASM-NEXT:    sd a1, 8(ca0)
; CHECK-ASM-NEXT:    sb zero, 16(ca0)
; CHECK-ASM-NEXT:    sd a2, 0(ca0)
...
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca1, %pcrel_hi(.LCPI3_0)
; CHECK-ASM-NEXT:    caddi ca1, ca1, %pcrel_lo(.LBB3_1)
; CHECK-ASM-NEXT:    ld a1, 0(ca1)
; CHECK-ASM-NEXT:  .LBB3_2: # %entry
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca2, %pcrel_hi(.LCPI3_1)
; CHECK-ASM-NEXT:    caddi ca2, ca2, %pcrel_lo(.LBB3_2)
; CHECK-ASM-NEXT:    ld a2, 0(ca2)
; CHECK-ASM-NEXT:    sd a1, 8(ca0)
; CHECK-ASM-NEXT:    sb zero, 16(ca0)
; CHECK-ASM-NEXT:    sd a2, 0(ca0)
...
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca1, %pcrel_hi(.LCPI4_0)
; CHECK-ASM-NEXT:    caddi ca1, ca1, %pcrel_lo(.LBB4_1)
; CHECK-ASM-NEXT:    ld a1, 0(ca1)
; CHECK-ASM-NEXT:  .LBB4_2: # %entry
; CHECK-ASM-NEXT:    # Label of block must be emitted
; CHECK-ASM-NEXT:    auipc ca2, %pcrel_hi(.LCPI4_1)
; CHECK-ASM-NEXT:    caddi ca2, ca2, %pcrel_lo(.LBB4_2)
; CHECK-ASM-NEXT:    ld a2, 0(ca2)
; CHECK-ASM-NEXT:    sd a1, 8(ca0)
; CHECK-ASM-NEXT:    sb zero, 16(ca0)
; CHECK-ASM-NEXT:    sd a2, 0(ca0)
