...
; CHECK-NEXT:    sy cra, 40(csp) # 8-byte Folded Spill
; CHECK-NEXT:    sy cs0, 32(csp) # 8-byte Folded Spill
; CHECK-NEXT:    sy cs1, 24(csp) # 8-byte Folded Spill
; CHECK-NEXT:    sy cs2, 16(csp) # 8-byte Folded Spill
; CHECK-NEXT:    sy cs3, 8(csp) # 8-byte Folded Spill
; CHECK-NEXT:    sy cs4, 0(csp) # 8-byte Folded Spill
...
; CHECK-NEXT:    ly cra, 40(csp) # 8-byte Folded Reload
; CHECK-NEXT:    ly cs0, 32(csp) # 8-byte Folded Reload
; CHECK-NEXT:    ly cs1, 24(csp) # 8-byte Folded Reload
; CHECK-NEXT:    ly cs2, 16(csp) # 8-byte Folded Reload
; CHECK-NEXT:    ly cs3, 8(csp) # 8-byte Folded Reload
; CHECK-NEXT:    ly cs4, 0(csp) # 8-byte Folded Reload
; CHECK-NEXT:    addiy csp, csp, 48
; CHECK-NEXT:    ret
