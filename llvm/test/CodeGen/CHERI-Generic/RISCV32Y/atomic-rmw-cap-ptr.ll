...
; PURECAP-LIBCALLS-NEXT:    call __atomic_exchange_4
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_add_4
; PURECAP-LIBCALLS-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_sub_4
; PURECAP-LIBCALLS-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_and_4
; PURECAP-LIBCALLS-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_nand_4
; PURECAP-LIBCALLS-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_or_4
; PURECAP-LIBCALLS-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_fetch_xor_4
; PURECAP-LIBCALLS-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, -48
; PURECAP-LIBCALLS-NEXT:    sy cra, 40(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs0, 32(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs1, 24(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs2, 16(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    ymv cs0, ca0
; PURECAP-LIBCALLS-NEXT:    lw a3, 0(ca0)
; PURECAP-LIBCALLS-NEXT:    mv s1, a1
; PURECAP-LIBCALLS-NEXT:    addiy ca0, csp, 12
; PURECAP-LIBCALLS-NEXT:    ybndsiw cs2, ca0, 4
...
; PURECAP-LIBCALLS-NEXT:    ymv ca0, cs0
; PURECAP-LIBCALLS-NEXT:    ymv ca1, cs2
...
; PURECAP-LIBCALLS-NEXT:    ly cra, 40(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs0, 32(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs1, 24(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs2, 16(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 48
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; HYBRID-NEXT:    sy ca0, 8(sp) # 8-byte Folded Spill
; HYBRID-NEXT:    .option capmode
; HYBRID-NEXT:    modesw.cap
; HYBRID-NEXT:    lw a3, 0(ca0)
...
; HYBRID-NEXT:    li a3, 5
; HYBRID-NEXT:    li a4, 5
; HYBRID-NEXT:    ly ca0, 8(sp) # 8-byte Folded Reload
...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, -32
; PURECAP-LIBCALLS-NEXT:    sy cra, 24(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs0, 16(csp) # 8-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs1, 8(csp) # 8-byte Folded Spill
...
; PURECAP-LIBCALLS-NEXT:    addiy ca0, csp, 0
; PURECAP-LIBCALLS-NEXT:    ybndsiw cs1, ca0, 4
...
; PURECAP-LIBCALLS-NEXT:    li a4, 5
; PURECAP-LIBCALLS-NEXT:    ymv ca0, cs0
; PURECAP-LIBCALLS-NEXT:    ymv ca1, cs1
; PURECAP-LIBCALLS-NEXT:    call __atomic_compare_exchange_4
...
; PURECAP-LIBCALLS-NEXT:    ly cra, 24(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs0, 16(csp) # 8-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs1, 8(csp) # 8-byte Folded Reload
