...
; PURECAP-LIBCALLS-NEXT:    ly ca3, 0(ca0)
; PURECAP-LIBCALLS-NEXT:    ymv cs1, ca1
; PURECAP-LIBCALLS-NEXT:    addiy ca0, csp, 8
; PURECAP-LIBCALLS-NEXT:    ybndsiw cs2, ca0, 8
...
; PURECAP-LIBCALLS-NEXT:    yaddrw ca2, ca3, a0
; PURECAP-LIBCALLS-NEXT:    sy ca3, 8(csp)
...
; HYBRID-NEXT:    ly ca3, 0(ca0)
; HYBRID-NEXT:    .option nocapmode
; HYBRID-NEXT:    modesw.int
; HYBRID-NEXT:    sy ca1, 0(sp) # 8-byte Folded Spill
...
; HYBRID-NEXT:    yaddrw ca2, ca3, a0
; HYBRID-NEXT:    sy ca3, 16(sp)
...
; PURECAP-ATOMICS-NEXT:    yaddrw ca3, ca2, a3
; PURECAP-ATOMICS-NEXT:    sc.y.aqrl a3, ca3, (ca0)
...
; PURECAP-ATOMICS-NEXT:    lr.c.aqrl ca2, (ca0)
; PURECAP-ATOMICS-NEXT:    ymv ca3, ca2
...
; HYBRID-NEXT:    .option nocapmode
; HYBRID-NEXT:    modesw.int
; HYBRID-NEXT:    sy ca1, 8(sp) # 8-byte Folded Spill
...
; HYBRID-NEXT:    # =>This Inner Loop Header: Depth=1
; HYBRID-NEXT:    ymv ca2, ca3
; HYBRID-NEXT:    ly ca0, 8(sp) # 8-byte Folded Reload
; HYBRID-NEXT:    blt a0, a3, .LBB12_1
; HYBRID-NEXT:  # %bb.3: # %atomicrmw.start
; HYBRID-NEXT:    # in Loop: Header=BB12_2 Depth=1
; HYBRID-NEXT:    ly ca2, 8(sp) # 8-byte Folded Reload
