...
; CHECK:       # %bb.0:
; CHECK-NEXT:    sy cnull, 40(ca0)
; CHECK-NEXT:    sy cnull, 32(ca0)
; CHECK-NEXT:    sy cnull, 24(ca0)
; CHECK-NEXT:    sy cnull, 16(ca0)
; CHECK-NEXT:    sy cnull, 8(ca0)
...
; CHECK-NEXT:    ly ca1, %pcrel_lo(.LBB1_1)(ca1)
; CHECK-NEXT:    ly ca2, 40(ca1)
; CHECK-NEXT:    sy ca2, 40(ca0)
; CHECK-NEXT:    ly ca2, 32(ca1)
; CHECK-NEXT:    sy ca2, 32(ca0)
; CHECK-NEXT:    ly ca2, 24(ca1)
; CHECK-NEXT:    sy ca2, 24(ca0)
