...
; RUN: opt -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+y,+cap-mode,+f -cheri-bound-allocas -o - -S %s | FileCheck %s
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+y,+cap-mode,+f -O0 %s -o - | FileCheck %s -check-prefix ASM
; RUN: llc -mtriple=riscv32 --relocation-model=pic -target-abi il32pc64f -mattr=+y,+cap-mode,+f -O2 %s -o - | FileCheck %s -check-prefix ASM-OPT
...
; ASM:       # %bb.0: # %entry
; ASM-NEXT:    addiy csp, csp, -32
; ASM-NEXT:    sy cra, 24(csp) # 8-byte Folded Spill
; ASM-NEXT:    mv a1, a0
...
; ASM-NEXT:    addiy ca0, csp, 0
; ASM-NEXT:    ybndsiw ca0, ca0, 16
; ASM-NEXT:    call use_alloca
; ASM-NEXT:    j .LBB0_4
; ASM-NEXT:  .LBB0_4: # %exit
; ASM-NEXT:    li a0, 123
; ASM-NEXT:    ly cra, 24(csp) # 8-byte Folded Reload
; ASM-NEXT:    addiy csp, csp, 32
; ASM-NEXT:    ret
;
...
; ASM-OPT-NEXT:    addiy csp, csp, -32
; ASM-OPT-NEXT:    sy cra, 24(csp) # 8-byte Folded Spill
; ASM-OPT-NEXT:    sw zero, 12(csp)
; ASM-OPT-NEXT:    li a0, 1234
; ASM-OPT-NEXT:    sw a0, 8(csp)
; ASM-OPT-NEXT:    addiy ca0, csp, 0
; ASM-OPT-NEXT:    ybndsiw ca0, ca0, 16
; ASM-OPT-NEXT:    call use_alloca
; ASM-OPT-NEXT:    ly cra, 24(csp) # 8-byte Folded Reload
; ASM-OPT-NEXT:    addiy csp, csp, 32
; ASM-OPT-NEXT:  .LBB0_2: # %exit
; ASM-OPT-NEXT:    li a0, 123
; ASM-OPT-NEXT:    ret
; CHECK-LABEL: define i32 @alloca_in_entry
...
; ASM-NEXT:    addiy csp, csp, -32
; ASM-NEXT:    sy cra, 24(csp) # 8-byte Folded Spill
; ASM-NEXT:    sy cs0, 16(csp) # 8-byte Folded Spill
; ASM-NEXT:    addiy cs0, csp, 32
; ASM-NEXT:    mv a1, a0
; ASM-NEXT:    andi a0, a1, 1
; ASM-NEXT:    beqz a0, .LBB1_4
; ASM-NEXT:    j .LBB1_1
; ASM-NEXT:  .LBB1_1: # %do_alloca
; ASM-NEXT:    ymv ca0, csp
; ASM-NEXT:    mv a1, a0
; ASM-NEXT:    addi a1, a1, -16
; ASM-NEXT:    yaddrw ca1, ca0, a1
; ASM-NEXT:    li a0, 16
; ASM-NEXT:    ybndsrw ca0, ca1, a0
; ASM-NEXT:    sy ca0, -32(cs0) # 8-byte Folded Spill
; ASM-NEXT:    ymv csp, ca1
; ASM-NEXT:    ybndsiw ca0, ca0, 16
; ASM-NEXT:    sy ca0, -24(cs0) # 8-byte Folded Spill
; ASM-NEXT:    j .LBB1_2
; ASM-NEXT:  .LBB1_2: # %use_alloca_no_bounds
; ASM-NEXT:    ly ca1, -32(cs0) # 8-byte Folded Reload
; ASM-NEXT:    li a0, 0
; ASM-NEXT:    sw a0, 12(ca1)
; ASM-NEXT:    li a0, 1234
; ASM-NEXT:    sw a0, 8(ca1)
; ASM-NEXT:    j .LBB1_3
; ASM-NEXT:  .LBB1_3: # %use_alloca_need_bounds
; ASM-NEXT:    ly ca0, -24(cs0) # 8-byte Folded Reload
; ASM-NEXT:    call use_alloca
; ASM-NEXT:    j .LBB1_4
; ASM-NEXT:  .LBB1_4: # %exit
; ASM-NEXT:    li a0, 123
; ASM-NEXT:    addiy csp, cs0, -32
; ASM-NEXT:    ly cra, 24(csp) # 8-byte Folded Reload
; ASM-NEXT:    ly cs0, 16(csp) # 8-byte Folded Reload
; ASM-NEXT:    addiy csp, csp, 32
; ASM-NEXT:    ret
;
...
; ASM-OPT-NEXT:  # %bb.1: # %do_alloca
; ASM-OPT-NEXT:    addiy csp, csp, -16
; ASM-OPT-NEXT:    sy cra, 8(csp) # 8-byte Folded Spill
; ASM-OPT-NEXT:    sy cs0, 0(csp) # 8-byte Folded Spill
; ASM-OPT-NEXT:    addiy cs0, csp, 16
; ASM-OPT-NEXT:    addi a0, sp, -16
; ASM-OPT-NEXT:    yaddrw ca0, csp, a0
; ASM-OPT-NEXT:    li a1, 16
; ASM-OPT-NEXT:    ybndsrw ca1, ca0, a1
; ASM-OPT-NEXT:    ymv csp, ca0
; ASM-OPT-NEXT:    ybndsiw ca0, ca1, 16
; ASM-OPT-NEXT:    sw zero, 12(ca1)
; ASM-OPT-NEXT:    li a2, 1234
; ASM-OPT-NEXT:    sw a2, 8(ca1)
; ASM-OPT-NEXT:    call use_alloca
; ASM-OPT-NEXT:    addiy csp, cs0, -16
; ASM-OPT-NEXT:    ly cra, 8(csp) # 8-byte Folded Reload
; ASM-OPT-NEXT:    ly cs0, 0(csp) # 8-byte Folded Reload
; ASM-OPT-NEXT:    addiy csp, csp, 16
; ASM-OPT-NEXT:  .LBB1_2: # %exit
; ASM-OPT-NEXT:    li a0, 123
; ASM-OPT-NEXT:    ret
; CHECK-LABEL: define i32 @alloca_not_in_entry
...
; ASM-NEXT:    ly ca0, -32(cs0) # 8-byte Folded Reload
; ASM-NEXT:    call use_alloca
