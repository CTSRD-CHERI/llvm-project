...
; RUN: not --crash llc -mtriple=riscv32 --relocation-model=pic -target-abi ilp32f -mattr=+y,+zyhybrid,+f < %s -o - 2>&1 | FileCheck %s --check-prefix HYBRID-ERROR
