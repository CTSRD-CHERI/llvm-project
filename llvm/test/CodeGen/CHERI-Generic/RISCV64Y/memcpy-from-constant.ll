...
; CHECK-NEXT:    ly ca1, %pcrel_lo(.LBB3_1)(ca1)
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auipcc ca1, %got_pcrel_hi(constant_ptrs)
; CHECK-NEXT:    ly ca1, %pcrel_lo(.LBB8_1)(ca1)
; CHECK-NEXT:    ly ca1, 0(ca1)
; CHECK-NEXT:    sy ca1, 0(ca0)
; CHECK-NEXT:    ret
do.body:
...
; CHECK-NEXT:    # Label of block must be emitted
; CHECK-NEXT:    auipcc ca1, %got_pcrel_hi(constant_ptrs)
; CHECK-NEXT:    ly ca1, %pcrel_lo(.LBB9_1)(ca1)
; CHECK-NEXT:    ly ca1, 16(ca1)
; CHECK-NEXT:    sy ca1, 0(ca0)
; CHECK-NEXT:    ret
do.body:
