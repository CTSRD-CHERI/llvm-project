...
; HYBRID-NEXT:    sy ca0, 0(sp) # 16-byte Folded Spill
; HYBRID-NEXT:  .LBB0_1: # %loop
; HYBRID-NEXT:    # =>This Inner Loop Header: Depth=1
; HYBRID-NEXT:    ly ca0, 0(sp) # 16-byte Folded Reload
...
; PURECAP-NEXT:    sy cra, 16(csp) # 16-byte Folded Spill
; PURECAP-NEXT:    sy cs0, 0(csp) # 16-byte Folded Spill
; PURECAP-NEXT:    addiy cs0, ca0, 4
; PURECAP-NEXT:  .LBB0_1: # %loop
; PURECAP-NEXT:    # =>This Inner Loop Header: Depth=1
; PURECAP-NEXT:    ymv ca0, cs0
