...
; PURECAP-LIBCALLS-NEXT:    sy cra, 0(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    li a2, 5
; PURECAP-LIBCALLS-NEXT:    call __atomic_exchange_8
; PURECAP-LIBCALLS-NEXT:    ly cra, 0(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 16
...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, -80
; PURECAP-LIBCALLS-NEXT:    sy cra, 64(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs0, 48(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs1, 32(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs2, 16(csp) # 16-byte Folded Spill
...
; PURECAP-LIBCALLS-NEXT:    ly cra, 64(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs0, 48(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs1, 32(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs2, 16(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 80
; PURECAP-LIBCALLS-NEXT:    ret
;
...
; PURECAP-LIBCALLS:       # %bb.0:
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, -64
; PURECAP-LIBCALLS-NEXT:    sy cra, 48(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs0, 32(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sy cs1, 16(csp) # 16-byte Folded Spill
...
; PURECAP-LIBCALLS-NEXT:    addiy ca0, csp, 4
...
; PURECAP-LIBCALLS-NEXT:    ly cra, 48(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs0, 32(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    ly cs1, 16(csp) # 16-byte Folded Reload
