...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+y,+cap-mode,+f,+d -mattr=+a < %s | FileCheck %s --check-prefixes=PURECAP,PURECAP-ATOMICS --allow-unused-prefixes
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+y,+cap-mode,+f,+d -mattr=-a < %s | FileCheck %s --check-prefixes=PURECAP,PURECAP-LIBCALLS --allow-unused-prefixes
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+y,+zyhybrid,+f,+d -mattr=+a < %s | FileCheck %s --check-prefixes=HYBRID,HYBRID-ATOMICS --allow-unused-prefixes
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+y,+zyhybrid,+f,+d -mattr=+a < %s | FileCheck %s --check-prefixes=HYBRID,HYBRID-LIBCALLS --allow-unused-prefixes
...
; PURECAP-LIBCALLS-NEXT:    sy cra, 16(csp) # 16-byte Folded Spill
; PURECAP-LIBCALLS-NEXT:    sb a1, 15(csp)
; PURECAP-LIBCALLS-NEXT:    addiy ca1, csp, 15
...
; PURECAP-LIBCALLS-NEXT:    ly cra, 16(csp) # 16-byte Folded Reload
; PURECAP-LIBCALLS-NEXT:    addiy csp, csp, 32
...
; PURECAP-LIBCALLS-NEXT:    addiy ca1, csp, 14
...
; PURECAP-LIBCALLS-NEXT:    addiy ca1, csp, 12
...
; PURECAP-LIBCALLS-NEXT:    addiy ca1, csp, 8
...
; PURECAP-LIBCALLS-NEXT:    ybndsiw ca1, ca1, 16
; PURECAP-LIBCALLS-NEXT:    li a3, 4
; PURECAP-LIBCALLS-NEXT:    li a4, 2
