...
; ASM-NEXT:    sy cra, 64(csp) # 16-byte Folded Spill
; ASM-NEXT:    sy cs0, 48(csp) # 16-byte Folded Spill
; ASM-NEXT:    li a0, 40
...
; ASM-NEXT:    ly cra, 64(csp) # 16-byte Folded Reload
; ASM-NEXT:    ly cs0, 48(csp) # 16-byte Folded Reload
; ASM-NEXT:    addiy csp, csp, 80
; ASM-NEXT:    ret
