...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+y,+zyhybrid,+f,+d %s -o - | FileCheck %s
...
; CHECK-NEXT:    lbu a1, 0(ca0)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca2, ca0, 1
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    lbu a2, 0(ca2)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca3, ca0, 2
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    lbu a3, 0(ca3)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca4, ca0, 3
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
...
; CHECK-NEXT:    addiy ca2, ca0, 4
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    lbu a2, 0(ca2)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca3, ca0, 5
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    lbu a3, 0(ca3)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca4, ca0, 6
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    lbu a4, 0(ca4)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca0, ca0, 7
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
...
; CHECK-NEXT:    yaddrw ca0, ca1, a0
; CHECK-NEXT:  .LBB2_3:
; CHECK-NEXT:    addiy ca1, ca0, 4
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    lwu a1, 0(ca1)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
...
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca2, ca1, 7
; CHECK-NEXT:    srli a3, a0, 56
; CHECK-NEXT:    .option capmode
; CHECK-NEXT:    modesw.cap
; CHECK-NEXT:    sb ca2, 0(a3)
; CHECK-NEXT:    .option nocapmode
; CHECK-NEXT:    modesw.int
; CHECK-NEXT:    addiy ca2, ca1, 6
