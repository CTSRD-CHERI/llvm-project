...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+y,+cap-mode,+f,+d -o - < %s | FileCheck %s
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    ld a2, 8(ca1)
; CHECK-NEXT:    sd a2, 8(ca0)
; CHECK-NEXT:    ld a1, 0(ca1)
; CHECK-NEXT:    sd a1, 0(ca0)
; CHECK-NEXT:    ret
entry:
  %a_i8 = bitcast %struct.pair addrspace(200)* %a to i8 addrspace(200)*
  %b_i8 = bitcast %struct.pair addrspace(200)* %b to i8 addrspace(200)*
