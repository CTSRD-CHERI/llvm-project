...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+y,+cap-mode,+f,+d < %s | FileCheck %s --check-prefix=PURECAP
;; Hybrid baseline to compare against
; RUN: sed 's/addrspace(200)//g' %s | llc -mtriple=riscv64 --relocation-model=pic -target-abi lp64d -mattr=+y,+zyhybrid,+f,+d | FileCheck %s --check-prefix=HYBRID
...
; PURECAP:       # %bb.0:
; PURECAP-NEXT:    slli a1, a1, 48
; PURECAP-NEXT:    srli a1, a1, 48
...
; HYBRID:       # %bb.0:
; HYBRID-NEXT:    slli a1, a1, 48
; HYBRID-NEXT:    srli a1, a1, 48
...
; PURECAP-NEXT:    srli a1, a1, 48
; PURECAP-NEXT:    slli a1, a1, 2
; PURECAP-NEXT:    ori a1, a1, 4
; PURECAP-NEXT:    li a2, 4
; PURECAP-NEXT:    sub a2, a2, a1
; PURECAP-NEXT:    addy ca0, ca0, a2
