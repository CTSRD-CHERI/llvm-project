...
; ASM-NEXT:    sc cra, 24(csp) # 8-byte Folded Spill
; ASM-NEXT:    mv a1, a0
...
; ASM-NEXT:    li a0, 123
; ASM-NEXT:    lc cra, 24(csp) # 8-byte Folded Reload
; ASM-NEXT:    cincoffset csp, csp, 32
; ASM-NEXT:    ret
;
...
; ASM-OPT-NEXT:    sc cra, 24(csp) # 8-byte Folded Spill
...
; ASM-OPT-NEXT:    lc cra, 24(csp) # 8-byte Folded Reload
; ASM-OPT-NEXT:    cincoffset csp, csp, 32
...
; ASM-NEXT:    cincoffset csp, csp, -32
; ASM-NEXT:    sc cra, 24(csp) # 8-byte Folded Spill
; ASM-NEXT:    sc cs0, 16(csp) # 8-byte Folded Spill
...
; ASM-NEXT:    sc ca0, -32(cs0) # 8-byte Folded Spill
; ASM-NEXT:    cmove csp, ca1
; ASM-NEXT:    csetbounds ca0, ca0, 16
; ASM-NEXT:    sc ca0, -24(cs0) # 8-byte Folded Spill
; ASM-NEXT:    j .LBB1_2
; ASM-NEXT:  .LBB1_2: # %use_alloca_no_bounds
; ASM-NEXT:    lc ca1, -32(cs0) # 8-byte Folded Reload
; ASM-NEXT:    li a0, 0
...
; ASM-NEXT:    lc ca0, -24(cs0) # 8-byte Folded Reload
; ASM-NEXT:    ccall use_alloca
; ASM-NEXT:    j .LBB1_4
...
; ASM-NEXT:    lc cra, 24(csp) # 8-byte Folded Reload
; ASM-NEXT:    lc cs0, 16(csp) # 8-byte Folded Reload
; ASM-NEXT:    cincoffset csp, csp, 32
; ASM-NEXT:    ret
;
...
; ASM-OPT-NEXT:    sc cra, 8(csp) # 8-byte Folded Spill
; ASM-OPT-NEXT:    sc cs0, 0(csp) # 8-byte Folded Spill
...
; ASM-OPT-NEXT:    lc cra, 8(csp) # 8-byte Folded Reload
; ASM-OPT-NEXT:    lc cs0, 0(csp) # 8-byte Folded Reload
; ASM-OPT-NEXT:    cincoffset csp, csp, 16
...
; ASM-NEXT:    lc ca0, -32(cs0) # 8-byte Folded Reload
; ASM-NEXT:    ccall use_alloca
