...
; CHECK-NEXT:    ret
  ...
  call void @llvm.memcpy.p200.p200.i32(ptr addrspace(200) align 1 %align1, ptr addrspace(200) align 16 %local_cap_ptr, i32 32, i1 false) must_preserve_cheri_tags
  ret void
}
...
; CHECK-NEXT:    ret
  ...
  %maskcond = icmp eq i32 %maskedptr, 0
  tail call void @llvm.assume(i1 %maskcond)
  call void @llvm.memmove.p200.p200.i32(ptr addrspace(200) align 1 %align1, ptr addrspace(200) align 16 %local_cap_ptr, i32 32, i1 false) must_preserve_cheri_tags
  ret void
}
