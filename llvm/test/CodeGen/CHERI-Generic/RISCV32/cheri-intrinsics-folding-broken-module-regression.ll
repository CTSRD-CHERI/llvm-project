...
; RUN: %riscv32_cheri_purecap_opt -S -instcombine -O3 %s -o - | FileCheck %s
; RUN: %riscv32_cheri_purecap_opt -S -O3 %s | %riscv32_cheri_purecap_llc -O3 -o - | FileCheck %s --check-prefix ASM
...
; CHECK-SAME: (i32 [[X:%.*]], i32 [[Y:%.*]]) local_unnamed_addr addrspace(200)
; CHECK-NEXT:  entry:
...
; CHECK-NEXT:    [[ADD1:%.*]] = add i32 [[ADD]], [[TMP3]]
