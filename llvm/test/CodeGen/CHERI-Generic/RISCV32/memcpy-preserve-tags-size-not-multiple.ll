...
define void @test_string_memmove(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) nounwind {
...
; CHECK-NEXT:    ret
  call void @llvm.memmove.p200.p200.i64(ptr addrspace(200) align 16 %dst, ptr addrspace(200) align 16 %src, i64 45, i1 false) must_preserve_cheri_tags
  ret void
}

define void @test_string_memcpy(ptr addrspace(200) %dst, ptr addrspace(200) %src) addrspace(200) nounwind {
...
; CHECK-NEXT:    cincoffset csp, csp, 16
; CHECK-NEXT:    ret
  call void @llvm.memcpy.p200.p200.i64(ptr addrspace(200) align 16 %dst, ptr addrspace(200) align 16 %src, i64 45, i1 false) must_preserve_cheri_tags
  ret void
}
