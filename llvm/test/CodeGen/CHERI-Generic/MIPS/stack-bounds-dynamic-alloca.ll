...
; RUN: llc -mtriple=mips64 -mcpu=cheri128 -mattr=+cheri128 --relocation-model=pic -target-abi purecap -O0 %s -cheri-stack-bounds-allow-remat=true -o - | FileCheck %s -check-prefix ASM
; RUN: llc -mtriple=mips64 -mcpu=cheri128 -mattr=+cheri128 --relocation-model=pic -target-abi purecap -O2 %s -cheri-stack-bounds-allow-remat=true -o - | FileCheck %s -check-prefix ASM-OPT
