...
; RUN: %cheri128_purecap_llc -o %t.mir -stop-before=early-machinelicm < %s
; RUN: echo "DONOTAUTOGEN" | %cheri128_purecap_llc -run-pass=early-machinelicm \
...
; RUN: %cheri128_purecap_llc -O1 -o - < %s | FileCheck %s
