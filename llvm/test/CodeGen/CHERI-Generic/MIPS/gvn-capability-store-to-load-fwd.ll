...
; RUN: %cheri128_purecap_opt -S -memdep -basic-aa -gvn -o - %s | FileCheck %s
; RUN: %cheri128_purecap_opt -S -memdep -basic-aa -gvn -o - %s | %cheri128_purecap_llc -O0 -o - | FileCheck %s --check-prefix=ASM
