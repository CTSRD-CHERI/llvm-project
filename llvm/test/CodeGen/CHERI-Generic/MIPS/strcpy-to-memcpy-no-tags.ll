...
; RUN: opt -opaque-pointers=0 < %s -passes=instcombine -S | llc -mtriple=mips64 -mcpu=cheri128 -mattr=+cheri128 --relocation-model=pic -target-abi purecap - -o - | FileCheck %s --check-prefix=CHECK-ASM
