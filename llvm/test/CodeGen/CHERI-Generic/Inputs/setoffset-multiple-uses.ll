...
define void @infer_values_from_null_set_offset() addrspace(200) nounwind {
  %with_offset = call ptr addrspace(200) @llvm.cheri.cap.offset.set.iCAPRANGE(ptr addrspace(200) null, iCAPRANGE 123456)
  %offset = call iCAPRANGE @llvm.cheri.cap.offset.get.iCAPRANGE(ptr addrspace(200) nonnull %with_offset)
...
define void @multiple_uses_small_constant() addrspace(200) nounwind {
  %with_offset = call ptr addrspace(200) @llvm.cheri.cap.offset.set.iCAPRANGE(ptr addrspace(200) null, iCAPRANGE 123)
  call void @check_fold_i8ptr(ptr addrspace(200) %with_offset)
  call void @check_fold_i8ptr(ptr addrspace(200) %with_offset)
  call void @check_fold_i8ptr(ptr addrspace(200) %with_offset)
  ret void
