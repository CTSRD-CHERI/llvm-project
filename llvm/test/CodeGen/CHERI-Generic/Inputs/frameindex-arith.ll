...
define void @foo() nounwind {
  ...
  %x_plus_1 = getelementptr inbounds [2 x i8], ptr addrspace(200) %x, iCAPRANGE 0, iCAPRANGE 1
  %p = call ptr addrspace(200) @llvm.cheri.cap.bounds.set.iCAPRANGE(ptr addrspace(200) %x_plus_1, iCAPRANGE 0)
  call void @bar(ptr addrspace(200) %p)
  ret void
}
