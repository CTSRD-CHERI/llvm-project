...
; RUN: llc @PURECAP_HARDFLOAT_ARGS@ < %s -o - -filetype=obj | llvm-readobj -r - | FileCheck %s --check-prefix=RELOCS
...
; CHECK-NEXT:  .chericap _Z8do_catchv + .Ltmp2-.Lfunc_begin0   #     jumps to .Ltmp2
...
@IF-MIPS@; RELOCS-NEXT:    R_MIPS_CHERI_CAPABILITY/R_MIPS_NONE/R_MIPS_NONE _Z8do_catchv 0x4C
@IF-MIPS@; RELOCS-NEXT:    R_MIPS_PC32/R_MIPS_NONE/R_MIPS_NONE .L_ZTIi.DW.stub 0x0
@IF-RISCV@; RELOCS-NEXT:   R_RISCV_CHERI_CAPABILITY _Z8do_catchv 0x38
