...
;   %tmp34 = load ptr addrspace(200), ptr addrspace(200) %ai, align 16
;   %0 = ptrtoint ptr addrspace(200) %tmp34 to i64 ; INCORRECT transformation (does not transfer all bits)
