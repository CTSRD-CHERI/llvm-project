...
declare void @llvm.memcpy.p200i8.p200i8.iCAPRANGE(i8 addrspace(200)* nocapture writeonly, i8 addrspace(200)* nocapture readonly, iCAPRANGE, i1)
declare void @llvm.memmove.p200i8.p200i8.iCAPRANGE(i8 addrspace(200)* nocapture writeonly, i8 addrspace(200)* nocapture readonly, iCAPRANGE, i1)
...
define void @memcpy_assume(i8 addrspace(200)* addrspace(200)* %local_cap_ptr, i8 addrspace(200)* %align1) addrspace(200) nounwind {
  %ptrint = ptrtoint i8 addrspace(200)* %align1 to iCAPRANGE
  ...
  call void @llvm.memcpy.p200i8.p200i8.iCAPRANGE(i8 addrspace(200)* align 1 %align1, i8 addrspace(200)* align 16 %1, iCAPRANGE 32, i1 false) must_preserve_cheri_tags
  ret void
}
...
define void @memmove_assume(i8 addrspace(200)* addrspace(200)* %local_cap_ptr, i8 addrspace(200)* %align1) addrspace(200) nounwind {
  ...
  tail call void @llvm.assume(i1 %maskcond)
  %1 = bitcast i8 addrspace(200)* addrspace(200)* %local_cap_ptr to i8 addrspace(200)*
  call void @llvm.memmove.p200i8.p200i8.iCAPRANGE(i8 addrspace(200)* align 1 %align1, i8 addrspace(200)* align 16 %1, iCAPRANGE 32, i1 false) must_preserve_cheri_tags
  ret void
}
