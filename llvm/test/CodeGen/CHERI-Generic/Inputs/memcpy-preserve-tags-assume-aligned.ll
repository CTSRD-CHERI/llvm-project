...
define void @memcpy_assume(ptr addrspace(200) %local_cap_ptr, ptr addrspace(200) %align1) addrspace(200) nounwind {
  ...
  call void @llvm.memcpy.p200.p200.iCAPRANGE(ptr addrspace(200) align 1 %align1, ptr addrspace(200) align 16 %local_cap_ptr, iCAPRANGE 32, i1 false) must_preserve_cheri_tags
  ret void
}
...
define void @memmove_assume(ptr addrspace(200) %local_cap_ptr, ptr addrspace(200) %align1) addrspace(200) nounwind {
  ...
  %maskcond = icmp eq iCAPRANGE %maskedptr, 0
  tail call void @llvm.assume(i1 %maskcond)
  call void @llvm.memmove.p200.p200.iCAPRANGE(ptr addrspace(200) align 1 %align1, ptr addrspace(200) align 16 %local_cap_ptr, iCAPRANGE 32, i1 false) must_preserve_cheri_tags
  ret void
}
