...
loop:
  %0 = getelementptr inbounds i32, ptr addrspace(200) %a, iCAPRANGE 1
  %1 = load iCAPRANGE, ptr addrspace(200) %b, align 16
  %2 = mul iCAPRANGE 0, %1
  %3 = getelementptr inbounds i32, ptr addrspace(200) %0, iCAPRANGE %2
