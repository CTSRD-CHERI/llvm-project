...
; RUN: llc @PURECAP_HARDFLOAT_ARGS@ -O0 %s -cheri-stack-bounds-allow-remat=true -o - | FileCheck %s -check-prefix ASM
; RUN: llc @PURECAP_HARDFLOAT_ARGS@ -O2 %s -cheri-stack-bounds-allow-remat=true -o - | FileCheck %s -check-prefix ASM-OPT
