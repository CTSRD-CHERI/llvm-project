...
; RUN: opt -opaque-pointers=0 @PURECAP_HARDFLOAT_ARGS@ -cheri-bound-allocas -o - -S %s | FileCheck %s
; RUN: llc -opaque-pointers=0 @PURECAP_HARDFLOAT_ARGS@ -O0 %s -o - | FileCheck %s -check-prefix ASM
; RUN: llc -opaque-pointers=0 @PURECAP_HARDFLOAT_ARGS@ -O2 %s -o - | FileCheck %s -check-prefix ASM-OPT
