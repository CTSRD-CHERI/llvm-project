...
; PURECAP-NEXT:    sc cra, 32(csp) # 16-byte Folded Spill
; PURECAP-NEXT:    sc cs0, 16(csp) # 16-byte Folded Spill
; PURECAP-NEXT:    cincoffset cs0, csp, 48
; PURECAP-NEXT:    sc cs0, -48(cs0)
; PURECAP-NEXT:    cmove ca0, cs0
; PURECAP-NEXT:    lc cra, 32(csp) # 16-byte Folded Reload
; PURECAP-NEXT:    lc cs0, 16(csp) # 16-byte Folded Reload
; PURECAP-NEXT:    cincoffset csp, csp, 48
; PURECAP-NEXT:    ret
;
