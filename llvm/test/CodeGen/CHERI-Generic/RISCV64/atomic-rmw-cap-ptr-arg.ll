...
; PURECAP-LIBCALLS-NEXT:    csetbounds cs2, ca0, 16
...
; PURECAP-LIBCALLS-NEXT:    sc ca3, 0(csp)
...
; PURECAP-LIBCALLS-NEXT:    lc ca3, 0(csp)
...
; HYBRID-NEXT:    sc ca0, 16(sp) # 16-byte Folded Spill
; HYBRID-NEXT:    lc.cap ca3, (ca0)
; HYBRID-NEXT:    sc ca1, 0(sp) # 16-byte Folded Spill
