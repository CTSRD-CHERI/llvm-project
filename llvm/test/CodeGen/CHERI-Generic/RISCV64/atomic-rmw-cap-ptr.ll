...
; HYBRID-ATOMICS-NEXT:    ld.cap a2, (ca0)
...
; HYBRID-ATOMICS-NEXT:    sc.d.cap a4, (ca0)
...
; HYBRID-LIBCALLS-NEXT:    sd ra, 40(sp)
; HYBRID-LIBCALLS-NEXT:    sd s0, 32(sp)
; HYBRID-LIBCALLS-NEXT:    sc ca0, 0(sp)
; HYBRID-LIBCALLS-NEXT:    ld.cap a3, (ca0)
...
; HYBRID-LIBCALLS-NEXT:    sd a3, 24(sp)
...
; HYBRID-LIBCALLS-NEXT:    ld s0, 32(sp)
; HYBRID-LIBCALLS-NEXT:    ld ra, 40(sp)
; HYBRID-LIBCALLS-NEXT:    addi sp, sp, 48
; HYBRID-LIBCALLS-NEXT:    ret
bb:
...
; HYBRID-LIBCALLS-NEXT:    fsw ft0, 36(sp)
; HYBRID-LIBCALLS-NEXT:    fmv.x.w a2, ft1
; HYBRID-LIBCALLS-NEXT:    addi a1, sp, 36
; HYBRID-LIBCALLS-NEXT:    addi a3, zero, 5
; HYBRID-LIBCALLS-NEXT:    addi a4, zero, 5
