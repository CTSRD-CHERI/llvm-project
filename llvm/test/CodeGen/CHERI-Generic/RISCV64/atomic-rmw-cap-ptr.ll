...
; RUN_FIXME_THIS_CRASHES: %riscv64_cheri_llc %s -o - -mattr=+f,+a -verify-machineinstrs | FileCheck %s --check-prefixes=HYBRID,HYBRID-ATOMICS
...
; HYBRID-NEXT:    sd s1, 24(sp)
; HYBRID-NEXT:    sc ca0, 0(sp)
; HYBRID-NEXT:    lw.cap s1, (ca0)
