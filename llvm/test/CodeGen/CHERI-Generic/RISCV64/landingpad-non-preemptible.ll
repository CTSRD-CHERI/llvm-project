...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+xcheri,+cap-mode,+f,+d < %s -o - -filetype=obj | llvm-readobj -r -t - | FileCheck %s --check-prefix=RELOCS
