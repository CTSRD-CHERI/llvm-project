...
; RUN: llc -mtriple=riscv64 --relocation-model=pic -target-abi l64pc128d -mattr=+xcheri,+cap-mode,+f,+d < %s -o - -filetype=obj | llvm-readobj -r - | FileCheck %s --check-prefix=RELOCS
...
; RELOCS-NEXT:   R_RISCV_CHERI_CAPABILITY _Z8do_catchv 0x38
