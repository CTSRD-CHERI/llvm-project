...
; RUN: %riscv64_cheri_purecap_opt -S -memdep -basic-aa -gvn -o - %s | FileCheck %s
; RUN: %riscv64_cheri_purecap_opt -S -memdep -basic-aa -gvn -o - %s | %riscv64_cheri_purecap_llc -O0 -o - | FileCheck %s --check-prefix=ASM
