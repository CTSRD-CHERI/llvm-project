...
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    addi sp, sp, -32
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    sd ra, 24(sp) # 8-byte Folded Spill
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    sd s0, 16(sp) # 8-byte Folded Spill
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    sd s1, 8(sp) # 8-byte Folded Spill
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    mv s0, a2
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    mv s1, a1
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    li a3, 5
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    call __atomic_store_16_c@plt
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    mv a0, s1
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    mv a1, s0
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    ld ra, 24(sp) # 8-byte Folded Reload
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    ld s0, 16(sp) # 8-byte Folded Reload
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    ld s1, 8(sp) # 8-byte Folded Reload
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    addi sp, sp, 32
...
; HYBRID-IR-NEXT:    [[TMP1:%.*]] = getelementptr i8, ptr addrspace(200) null, i128 [[VAL]]
; HYBRID-IR-NEXT:    [[TMP2:%.*]] = lshr i128 [[VAL]], 64
; HYBRID-IR-NEXT:    [[TMP3:%.*]] = trunc i128 [[TMP2]] to i64
; HYBRID-IR-NEXT:    [[TMP4:%.*]] = call ptr addrspace(200) @llvm.cheri.cap.high.set.i64(ptr addrspace(200) [[TMP1]], i64 [[TMP3]])
; HYBRID-IR-NEXT:    store atomic ptr addrspace(200) [[TMP4]], ptr addrspace(200) [[PTR]] monotonic, align 16
...
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    sd ra, 8(sp) # 8-byte Folded Spill
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    li a1, 5
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    call __atomic_load_16_c@plt
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    ld ra, 8(sp) # 8-byte Folded Reload
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    addi sp, sp, 16
; HYBRID-CAP-PTR-LIBCALLS-NEXT:    ret
...
; HYBRID-IR-NEXT:    [[TMP1:%.*]] = load atomic ptr addrspace(200), ptr addrspace(200) [[PTR]] monotonic, align 16
; HYBRID-IR-NEXT:    [[TMP2:%.*]] = call i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) [[TMP1]])
; HYBRID-IR-NEXT:    [[TMP3:%.*]] = call i64 @llvm.cheri.cap.high.get.i64(ptr addrspace(200) [[TMP1]])
; HYBRID-IR-NEXT:    [[TMP4:%.*]] = zext i64 [[TMP2]] to i128
; HYBRID-IR-NEXT:    [[TMP5:%.*]] = zext i64 [[TMP3]] to i128
; HYBRID-IR-NEXT:    [[TMP6:%.*]] = shl i128 [[TMP5]], 64
; HYBRID-IR-NEXT:    [[TMP7:%.*]] = or i128 [[TMP4]], [[TMP6]]
; HYBRID-IR-NEXT:    fence acquire
; HYBRID-IR-NEXT:    ret i128 [[TMP7]]
;
