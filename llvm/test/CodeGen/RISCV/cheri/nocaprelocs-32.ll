...
; BWL-NEXT:    ret
entry:
  %y = alloca ptr addrspace(200), align 8, addrspace(200)
  store ptr addrspace(200) @value, ptr addrspace(200) %y, align 8
  ret void
}
...
attributes #0 = { nocaprelocs noinline nounwind optnone "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+cap-mode,+xcheri" }
attributes #1 = { noinline nounwind optnone "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-features"="+cap-mode,+xcheri" }
