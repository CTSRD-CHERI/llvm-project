...
; IL32PC64-PIC-NEXT:    auipc ca0, %tls_gd_captab_pcrel_hi(unspecified)
...
; L64PC128-PIC-NEXT:    auipc ca0, %tls_gd_captab_pcrel_hi(unspecified)
...
; IL32PC64-NOPIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(unspecified)
...
; L64PC128-NOPIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(unspecified)
...
; IL32PC64-PIC-NEXT:    # Label of block must be emitted
; IL32PC64-PIC-NEXT:    auipc ca0, %tls_gd_captab_pcrel_hi(ld)
...
; L64PC128-PIC-NEXT:    # Label of block must be emitted
; L64PC128-PIC-NEXT:    auipc ca0, %tls_gd_captab_pcrel_hi(ld)
...
; IL32PC64-NOPIC-NEXT:    # Label of block must be emitted
; IL32PC64-NOPIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(ld)
...
; L64PC128-NOPIC-NEXT:    # Label of block must be emitted
; L64PC128-NOPIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(ld)
...
; IL32PC64-PIC-NEXT:    # Label of block must be emitted
; IL32PC64-PIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(ie)
...
; L64PC128-PIC-NEXT:    # Label of block must be emitted
; L64PC128-PIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(ie)
...
; IL32PC64-NOPIC-NEXT:    # Label of block must be emitted
; IL32PC64-NOPIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(ie)
...
; L64PC128-NOPIC-NEXT:    # Label of block must be emitted
; L64PC128-NOPIC-NEXT:    auipc ca1, %tls_ie_captab_pcrel_hi(ie)
...
; IL32PC64-PIC-NEXT:    cadd ca0, ctp, a0, %tprel_cincoffset(le)
...
; L64PC128-PIC-NEXT:    cadd ca0, ctp, a0, %tprel_cincoffset(le)
...
; IL32PC64-NOPIC-NEXT:    cadd ca0, ctp, a0, %tprel_cincoffset(le)
...
; L64PC128-NOPIC-NEXT:    cadd ca0, ctp, a0, %tprel_cincoffset(le)
