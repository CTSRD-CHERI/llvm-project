...
; RUN: %riscv64_cheri_llc -verify-machineinstrs \
; RUN:   | FileCheck --check-prefix=CHECK-LP64 %s
; RUN: %riscv64_cheri_purecap_llc -verify-machineinstrs \
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lb a1, 1(a0)
; CHECK-LP64-NEXT:    lb a0, 0(a0)
; CHECK-LP64-NEXT:    ret
;
; CHECK-L64PC128-LABEL: ddc_lb:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    addi a1, a0, 1
; CHECK-L64PC128-NEXT:    lb.ddc a1, a1
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lh a1, 4(a0)
; CHECK-LP64-NEXT:    lh a0, 0(a0)
; CHECK-LP64-NEXT:    ret
;
; CHECK-L64PC128-LABEL: ddc_lh:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    addi a1, a0, 4
; CHECK-L64PC128-NEXT:    lh.ddc a1, a1
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lw a1, 12(a0)
; CHECK-LP64-NEXT:    lw a0, 0(a0)
; CHECK-LP64-NEXT:    ret
;
; CHECK-L64PC128-LABEL: ddc_lw:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    addi a1, a0, 12
; CHECK-L64PC128-NEXT:    lw.ddc a1, a1
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    ld a1, 32(a0)
; CHECK-LP64-NEXT:    ld a0, 0(a0)
; CHECK-LP64-NEXT:    ret
;
; CHECK-L64PC128-LABEL: ddc_ld:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    addi a1, a0, 32
; CHECK-L64PC128-NEXT:    ld.ddc a1, a1
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lbu a1, 5(a0)
; CHECK-LP64-NEXT:    lbu a0, 0(a0)
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lhu a1, 12(a0)
; CHECK-LP64-NEXT:    lhu a0, 0(a0)
; CHECK-LP64-NEXT:    add a0, a0, a1
; CHECK-LP64-NEXT:    ret
;
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lwu a1, 28(a0)
; CHECK-LP64-NEXT:    lwu a0, 0(a0)
; CHECK-LP64-NEXT:    add a0, a0, a1
; CHECK-LP64-NEXT:    ret
;
...
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    lc ca1, 128(a0)
; CHECK-LP64-NEXT:    lc ca0, 0(a0)
...
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    clbu a1, 18(ca0)
; CHECK-L64PC128-NEXT:    clbu a0, 0(ca0)
...
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    clhu a1, 38(ca0)
; CHECK-L64PC128-NEXT:    clhu a0, 0(ca0)
; CHECK-L64PC128-NEXT:    add a0, a0, a1
; CHECK-L64PC128-NEXT:    cret
  %1 = load i16, i16 addrspace(200) *%cap
  %2 = zext i16 %1 to i64
...
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    clwu a1, 80(ca0)
; CHECK-L64PC128-NEXT:    clwu a0, 0(ca0)
; CHECK-L64PC128-NEXT:    add a0, a0, a1
; CHECK-L64PC128-NEXT:    cret
  %1 = load i32, i32 addrspace(200) *%cap
  %2 = zext i32 %1 to i64
...
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    clc ca1, 336(ca0)
; CHECK-L64PC128-NEXT:    clc ca0, 0(ca0)
