...
declare i8 addrspace(200) *@llvm.cheri.cap.offset.increment.iXLEN(i8 addrspace(200) *, iXLEN)
...
define i8 addrspace(200) *@offset_increment(i8 addrspace(200) *%cap, iXLEN %offset) nounwind {
; CHECK-ILP32-LABEL: offset_increment:
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    cincoffset ca0, ca0, a1
; CHECK-ILP32-NEXT:    ret
;
; CHECK-LP64-LABEL: offset_increment:
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    cincoffset ca0, ca0, a1
; CHECK-LP64-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: offset_increment:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    cincoffset ca0, ca0, a1
; CHECK-IL32PC64-NEXT:    cret
;
; CHECK-L64PC128-LABEL: offset_increment:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    cincoffset ca0, ca0, a1
; CHECK-L64PC128-NEXT:    cret
  %newcap = call i8 addrspace(200) *@llvm.cheri.cap.offset.increment.iXLEN(i8 addrspace(200) *%cap, iXLEN %offset)
  ret i8 addrspace(200) *%newcap
}

define i8 addrspace(200) *@offset_increment_immediate(i8 addrspace(200) *%cap) nounwind {
; CHECK-ILP32-LABEL: offset_increment_immediate:
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    cincoffset ca0, ca0, 42
; CHECK-ILP32-NEXT:    ret
;
; CHECK-LP64-LABEL: offset_increment_immediate:
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    cincoffset ca0, ca0, 42
; CHECK-LP64-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: offset_increment_immediate:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    cincoffset ca0, ca0, 42
; CHECK-IL32PC64-NEXT:    cret
;
; CHECK-L64PC128-LABEL: offset_increment_immediate:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    cincoffset ca0, ca0, 42
; CHECK-L64PC128-NEXT:    cret
  %newcap = call i8 addrspace(200) *@llvm.cheri.cap.offset.increment.iXLEN(i8 addrspace(200) *%cap, iXLEN 42)
  ret i8 addrspace(200) *%newcap
}
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    cspecialrw ca0, cnull, ddc
; CHECK-ILP32-NEXT:    ret
;
; CHECK-LP64-LABEL: ddc_get:
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    cspecialrw ca0, cnull, ddc
; CHECK-LP64-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: ddc_get:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    cspecialrw ca0, cnull, ddc
; CHECK-IL32PC64-NEXT:    cret
;
; CHECK-L64PC128-LABEL: ddc_get:
; CHECK-L64PC128:       # %bb.0:
; CHECK-L64PC128-NEXT:    cspecialrw ca0, cnull, ddc
; CHECK-L64PC128-NEXT:    cret
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    cspecialrw ca0, cnull, pcc
; CHECK-ILP32-NEXT:    ret
;
; CHECK-LP64-LABEL: pcc_get:
; CHECK-LP64:       # %bb.0:
; CHECK-LP64-NEXT:    cspecialrw ca0, cnull, pcc
; CHECK-LP64-NEXT:    ret
;
...
define iXLEN @subset_test(i8 addrspace(200) *%cap1, i8 addrspace(200) *%cap2) {
