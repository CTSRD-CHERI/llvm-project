...
; RUN: %riscv32_cheri_llc -verify-machineinstrs \
; RUN:   | FileCheck --check-prefix=CHECK-ILP32 %s
; RUN: %riscv32_cheri_purecap_llc -verify-machineinstrs \
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    lb a1, 1(a0)
; CHECK-ILP32-NEXT:    lb a0, 0(a0)
; CHECK-ILP32-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: ddc_lb:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    addi a1, a0, 1
; CHECK-IL32PC64-NEXT:    lb.ddc a1, a1
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    lh a1, 4(a0)
; CHECK-ILP32-NEXT:    lh a0, 0(a0)
; CHECK-ILP32-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: ddc_lh:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    addi a1, a0, 4
; CHECK-IL32PC64-NEXT:    lh.ddc a1, a1
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    lw a1, 12(a0)
; CHECK-ILP32-NEXT:    lw a0, 0(a0)
; CHECK-ILP32-NEXT:    ret
;
; CHECK-IL32PC64-LABEL: ddc_lw:
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    addi a1, a0, 12
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    lbu a1, 4(a0)
; CHECK-ILP32-NEXT:    lbu a0, 0(a0)
; CHECK-ILP32-NEXT:    add a0, a0, a1
; CHECK-ILP32-NEXT:    ret
;
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    lhu a1, 10(a0)
; CHECK-ILP32-NEXT:    lhu a0, 0(a0)
; CHECK-ILP32-NEXT:    add a0, a0, a1
; CHECK-ILP32-NEXT:    ret
;
...
; CHECK-ILP32:       # %bb.0:
; CHECK-ILP32-NEXT:    lc ca1, 48(a0)
; CHECK-ILP32-NEXT:    lc ca0, 0(a0)
...
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    clbu a1, 14(ca0)
; CHECK-IL32PC64-NEXT:    clbu a0, 0(ca0)
; CHECK-IL32PC64-NEXT:    add a0, a0, a1
; CHECK-IL32PC64-NEXT:    cret
  %1 = load i8, i8 addrspace(200) *%cap
  %2 = zext i8 %1 to i32
...
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    clhu a1, 30(ca0)
; CHECK-IL32PC64-NEXT:    clhu a0, 0(ca0)
; CHECK-IL32PC64-NEXT:    add a0, a0, a1
; CHECK-IL32PC64-NEXT:    cret
  %1 = load i16, i16 addrspace(200) *%cap
  %2 = zext i16 %1 to i32
...
; CHECK-IL32PC64:       # %bb.0:
; CHECK-IL32PC64-NEXT:    clc ca1, 128(ca0)
