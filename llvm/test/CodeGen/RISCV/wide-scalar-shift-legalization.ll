...
; RV64I-NEXT:    sb s10, 112(sp)
; RV64I-NEXT:    sb ra, 111(sp)
; RV64I-NEXT:    sb s11, 110(sp)
...
; RV32I-NEXT:    or t1, a7, a1
; RV32I-NEXT:    slli a1, a5, 1
; RV32I-NEXT:    xori t2, a4, 31
; RV32I-NEXT:    sll a1, a1, t2
; RV32I-NEXT:    lbu a7, 13(a3)
; RV32I-NEXT:    lbu t3, 12(a3)
; RV32I-NEXT:    lbu t4, 14(a3)
...
; RV32I-NEXT:    lbu a7, 17(a3)
; RV32I-NEXT:    lbu t4, 16(a3)
...
; RV32I-NEXT:    srli t2, t4, 8
; RV32I-NEXT:    sb t2, 17(a2)
; RV32I-NEXT:    srli t2, t5, 16
; RV32I-NEXT:    sb t2, 22(a2)
; RV32I-NEXT:    or t0, t5, t0
; RV32I-NEXT:    sb t5, 20(a2)
; RV32I-NEXT:    srli t2, t5, 8
