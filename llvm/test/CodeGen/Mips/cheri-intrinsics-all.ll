...
define i64 @test(i8 addrspace(200)* %foo) #0 {
  ...
  ; CHECK: cgetlen
  %3 = call i64 @llvm.cheri.get.cap.length(i8 addrspace(200)* %2)
  %4 = load i64* %x, align 8
  %5 = and i64 %4, %3
  store i64 %5, i64* %x, align 8
  %6 = load i8 addrspace(200)** %1, align 32
  ; CHECK: cgetperm
  %7 = call i64 @llvm.cheri.get.cap.perms(i8 addrspace(200)* %6)
  ...
  ; CHECK: cgettype
  %13 = call i64 @llvm.cheri.get.cap.type(i8 addrspace(200)* %12)
  %14 = load i64* %x, align 8
  %15 = and i64 %14, %13
  store i64 %15, i64* %x, align 8
  %16 = load i8 addrspace(200)** %1, align 32
  ; CHECK: cgettag
  %17 = call i64 @llvm.cheri.get.cap.tag(i8 addrspace(200)* %16)
  ...
  ; CHECK: csetlen
  %23 = call i8 addrspace(200)* @llvm.cheri.set.cap.length(i8 addrspace(200)* %22, i64 42)
  ...
  ; CHECK: candperm
  %25 = call i8 addrspace(200)* @llvm.cheri.and.cap.perms(i8 addrspace(200)* %24, i64 12)
  ...
  ; CHECK: csettype
  %27 = call i8 addrspace(200)* @llvm.cheri.set.cap.type(i8 addrspace(200)* %26, i64 35)
  ...
  ; CHECK: csealcode
  %29 = call i8 addrspace(200)* @llvm.cheri.seal.cap.code(i8 addrspace(200)* %28)
  ...
  ; CHECK: csealdata
  %32 = call i8 addrspace(200)* @llvm.cheri.seal.cap.data(i8 addrspace(200)* %30, i8 addrspace(200)* %31)
  ...
  ; CHECK: cunseal
  %35 = call i8 addrspace(200)* @llvm.cheri.unseal.cap(i8 addrspace(200)* %33, i8 addrspace(200)* %34)
  store i8 addrspace(200)* %35, i8 addrspace(200)** getelementptr inbounds ([12 x i8 addrspace(200)*]* @results, i32 0, i64 5), align 32
  ; CHECK: csetcause
  call void @llvm.cheri.set.cause(i64 42)
...
declare i64 @llvm.cheri.get.cap.length(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i64 @llvm.cheri.get.cap.perms(i8 addrspace(200)*) #1
...
; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.cheri.set.cap.length(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.cheri.and.cap.perms(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.cheri.set.cap.type(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.cheri.seal.cap.code(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.cheri.seal.cap.data(i8 addrspace(200)*, i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.cheri.unseal.cap(i8 addrspace(200)*, i8 addrspace(200)*) #1

; Function Attrs: nounwind
declare void @llvm.cheri.set.cause(i64) #2

; Function Attrs: nounwind
declare i64 @llvm.cheri.get.cause() #2
