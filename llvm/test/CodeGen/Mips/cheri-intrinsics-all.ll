...
define i64 @test(i8 addrspace(200)* %rfoo) #0 {
  ...
  ; CHECK: cgetlen
  %r3 = call i64 @llvm.memcap.cap.length.get(i8 addrspace(200)* %r2)
  %r4 = load i64, i64* %rx, align 8
  %r5 = and i64 %r4, %r3
  store i64 %r5, i64* %rx, align 8
  %r6 = load i8 addrspace(200)*, i8 addrspace(200)** %r1, align 32
  ; CHECK: cgetperm
  %r7 = call i64 @llvm.memcap.cap.perms.get(i8 addrspace(200)* %r6)
  ...
  ; CHECK: cgettype
  %r13 = call i64 @llvm.memcap.cap.type.get(i8 addrspace(200)* %r12)
  %r14 = load i64, i64* %rx, align 8
  %r15 = and i64 %r14, %r13
  store i64 %r15, i64* %rx, align 8
  %r16 = load i8 addrspace(200)*, i8 addrspace(200)** %r1, align 32
  ; CHECK: cgettag
  %r17 = call i64 @llvm.memcap.cap.tag.get(i8 addrspace(200)* %r16)
  ...
  ; CHECK: candperm
  %r25 = call i8 addrspace(200)* @llvm.memcap.cap.perms.and(i8 addrspace(200)* %r24, i64 12)
  ...
  ; CHECK: cseal
  %r32 = call i8 addrspace(200)* @llvm.memcap.cap.seal(i8 addrspace(200)* %r30, i8 addrspace(200)* %r31)
  ...
  ; CHECK: cunseal
  %r35 = call i8 addrspace(200)* @llvm.memcap.cap.unseal(i8 addrspace(200)* %r33, i8 addrspace(200)* %r34)
  ...
  ; spill
  ; CHECK: cgetsealed
  %r39 = call i64 @llvm.memcap.cap.sealed.get(i8 addrspace(200)* %r16)
  %r40 = trunc i64 %r39 to i1
  %r41 = zext i1 %r40 to i64
  %r42 = and i64 %r41, %r38
  ; CHECK: ccheckperm
  call void @llvm.memcap.cap.perms.check(i8 addrspace(200)* %r30, i64 12)
  ; CHECK: cchecktype
  call void @llvm.memcap.cap.type.check(i8 addrspace(200)* %r30, i8 addrspace(200)* %r31)
  ; CHECK: jr
  ret i64 %r42
}

; Function Attrs: nounwind readnone
declare i64 @llvm.memcap.cap.length.get(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i64 @llvm.memcap.cap.perms.get(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i64 @llvm.memcap.cap.type.get(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i64 @llvm.memcap.cap.sealed.get(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i64 @llvm.memcap.cap.tag.get(i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.length.set(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.perms.and(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.type.set(i8 addrspace(200)*, i64) #1


; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.seal(i8 addrspace(200)*, i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.unseal(i8 addrspace(200)*, i8 addrspace(200)*) #1

; Function Attrs: nounwind readnone
declare void @llvm.memcap.cap.perms.check(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare void @llvm.memcap.cap.type.check(i8 addrspace(200)*, i8 addrspace(200)*) #1
