...
define void @a(i8 addrspace(200)* %a1, i8 addrspace(200)* %a2) #0 {
  ...
  ; CHECK: jalr	$25
  tail call chericcallcc void @b(i8 addrspace(200)* %a1, i8 addrspace(200)* %a2) #2
  ret void
}

declare chericcallcc void @b(i8 addrspace(200)*, i8 addrspace(200)*) #1
