; RUN: llc -mtriple=mips64-unknown-freebsd -relocation-model=pic -o - %s -O0 | FileCheck %s
; ModuleID = 'printf.c'
...
; CHECK: jalr	$25
  %call = call i32 @my_printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0))
  ret i32 %call
}
