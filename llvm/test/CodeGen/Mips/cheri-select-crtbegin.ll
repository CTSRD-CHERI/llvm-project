...
; <label>:5:                                      ; preds = %1
  %6 = tail call i8 addrspace(200)* @llvm.memcap.pcc.get()
  %7 = tail call i8 addrspace(200)* @llvm.memcap.cap.offset.set(i8 addrspace(200)* %6, i64 %3)
...
; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.pcc.get() #1

; Function Attrs: nounwind
define void @crt_init_globals() local_unnamed_addr #0 {
  %1 = tail call i8 addrspace(200)* @llvm.memcap.ddc.get()
  %2 = tail call i8 addrspace(200)* @llvm.memcap.pcc.get()
  %3 = tail call i8 addrspace(200)* @llvm.memcap.cap.perms.and(i8 addrspace(200)* %1, i64 -3)
  %4 = tail call i8 addrspace(200)* @llvm.memcap.cap.perms.and(i8 addrspace(200)* %2, i64 -41)
...
; <label>:8:                                      ; preds = %5, %32
  ...
  %15 = tail call i8 addrspace(200)* @llvm.memcap.cap.offset.set(i8 addrspace(200)* %3, i64 %14)
  ...
  %20 = tail call i8 addrspace(200)* @llvm.memcap.cap.offset.set(i8 addrspace(200)* %17, i64 %19)
  %21 = icmp eq i64 %19, 314736
  br i1 %21, label %22, label %26

; <label>:22:                                     ; preds = %8
  %23 = tail call i8 addrspace(200)* @llvm.memcap.cap.offset.set(i8 addrspace(200)* %17, i64 %11)
...
; <label>:30:                                     ; preds = %27
  %31 = tail call i8 addrspace(200)* @llvm.memcap.cap.bounds.set(i8 addrspace(200)* %20, i64 %29)
  br label %32
...
; <label>:32:                                     ; preds = %27, %27, %30, %26
  ...
  %36 = tail call i8 addrspace(200)* @llvm.memcap.cap.offset.increment(i8 addrspace(200)* %33, i64 %35)
...
; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.ddc.get() #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.perms.and(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.bounds.set(i8 addrspace(200)*, i64) #1

; Function Attrs: nounwind readnone
declare i8 addrspace(200)* @llvm.memcap.cap.offset.increment(i8 addrspace(200)*, i64) #1
