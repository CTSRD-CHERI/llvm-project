...
; RUN: %cheri128_purecap_opt -cheri-purecap-alloca -data-layout="E-m:m-pf200:128:128-i8:8:32-i16:16:32-i64:64-n32:64-S128-A200-P200-G200" -S < %s | FileCheck %s --check-prefix OPT128
; RUN: %cheri128_purecap_opt -cheri-purecap-alloca -data-layout="E-m:m-pf200:256:256-i8:8:32-i16:16:32-i64:64-n32:64-S256-A200-P200-G200" -S < %s | FileCheck %s --check-prefix OPT256
