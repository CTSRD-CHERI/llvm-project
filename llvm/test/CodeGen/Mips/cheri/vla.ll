...
; RUN: %cheri_llc -verify-machineinstrs -target-abi n64 -relocation-model=static -o - %s -O0 | FileCheck %s -check-prefixes N64
...
; N64-NEXT:    csc $c1, $sp, 0($ddc) # 16-byte Folded Spill
; N64-NEXT:    jal test
; N64-NEXT:    nop
...
; LEGACY-NEXT:    cincoffset $c11, $c11, 32
; LEGACY-NEXT:    cjr $c17
; LEGACY-NEXT:    nop
;
; CAPTABLE-LABEL: foo:
...
; CAPTABLE-NEXT:    cincoffset $c11, $c11, 32
