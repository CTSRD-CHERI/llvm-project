...
; RUN: %cheri128_purecap_llc %s -o - | %cheri_FileCheck %s
; ModuleID = 'bit.c'
...
; CHECK-NEXT:    cincoffset $c2, $c11, 44
; CHECK-NEXT:    csetbounds $c2, $c2, 4
; CHECK-NEXT:    cincoffset $c4, $c11, 40
; CHECK-NEXT:    csetbounds $c4, $c4, 4
; CHECK-NEXT:    cincoffset $c5, $c11, 0
; CHECK-NEXT:    csetbounds $c5, $c5, 16
; CHECK-NEXT:    clcbi $c1, %captab20(x)($c1)
; CHECK-NEXT:    csw $zero, $zero, 0($c2)
; CHECK-NEXT:    csw $4, $zero, 0($c4)
; CHECK-NEXT:    csc $c3, $zero, 0($c5)
