...
; RUN: %cheri_opt -S -passes=instsimplify %s -o - | FileCheck %s -check-prefix IR
; RUN: %cheri_opt -S -passes=instsimplify %s -o - | %cheri_llc -O3 -filetype=asm -o - | FileCheck %s -check-prefix OPT
...
; IR-NEXT:    ret i64 [[RET_CHECK]]
  %ret = call i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) null)
...
; IR-NEXT:    [[RET_CHECK:%.*]] = call i64 @check_fold_cap(ptr addrspace(200) getelementptr (i8, ptr addrspace(200) null, i64 1023))
; IR-NEXT:    ret i64 [[RET_CHECK]]
  %ret = call ptr addrspace(200) @llvm.cheri.cap.address.set.i64(ptr addrspace(200) null, i64 1023)
  %ret_check = call i64 @check_fold_cap(ptr addrspace(200) %ret)
  ret i64 %ret_check
}
...
; IR-NEXT:    ret void
  %with_offset = call ptr addrspace(200) @llvm.cheri.cap.offset.set.i64(ptr addrspace(200) null, i64 50)
  %vaddr = call i64 @llvm.cheri.cap.address.get.i64(ptr addrspace(200) %with_offset)
