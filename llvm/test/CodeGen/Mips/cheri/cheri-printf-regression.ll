...
; RUN: %cheri_purecap_llc -o - -O2 -mips-ssection-threshold=0 -mxgot -mxmxgot %s | FileCheck %s
...
; CHECK-NEXT: 	csc	$c24, $zero, 0($c11)    # 16-byte Folded Spill
...
; CHECK-NEXT: 	clc	$c24, $zero, 0($c11)    # 16-byte Folded Reload
; CHECK-NEXT: 	cjr	$c17
; CHECK-NEXT: 	cincoffset	$c11, $c11, 16
; CHECK-NEXT: .Ltmp2:
