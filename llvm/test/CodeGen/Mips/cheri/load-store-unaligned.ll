...
; FIXME: should also add a csetbounds here to ensure that memcpy can't overflow the stack
...
; CHECK-NEXT:    clcbi $c12, %capcall20(memcpy)($c1)
; CHECK-NEXT:    cincoffset $c4, $c11, 0
; CHECK-NEXT:    cjalr $c12, $c17
; CHECK-NEXT:    daddiu $4, $zero, [[$CAP_SIZE]]
; CHECK-NEXT:    clc $c17, $zero, [[@EXPR 1 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    cjr $c17
...
; CHECK-NEXT:    cincoffset $c3, $c11, [[OFFSET_LOAD:0|32]]
; CHECK-NEXT:    cjalr $c12, $c17
; CHECK-NEXT:    daddiu $4, $zero, [[$CAP_SIZE]]
; CHECK-NEXT:    clc $c1, $zero, [[OFFSET_LOAD]]($c11)
