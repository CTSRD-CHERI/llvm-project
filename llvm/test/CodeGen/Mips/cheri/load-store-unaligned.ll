...
; RUN: rm -f %t.dbg
; RUN: %cheri_purecap_llc -opaque-pointers=0 %s -o - -collect-csetbounds-stats=csv 2>%t.dbg | %cheri_FileCheck %s
; RUN: %cheri_llc -opaque-pointers=0 %s -o - | %cheri_FileCheck %s -check-prefix=HYBRID
