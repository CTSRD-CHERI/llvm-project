...
; CHECK-LABEL: a:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    cincoffset $c11, $c11, -[[FRAME_SIZE:48|96]]
; CHECK-NEXT:    .cfi_def_cfa_offset [[FRAME_SIZE]]
; CHECK-NEXT:    csd $16, $zero, [[FIRST_REG_OFFSET:.+]]($c11)
; CHECK-NEXT:    csc $c18, $zero, [[$CAP_SIZE]]($c11)
; CHECK-NEXT:    csc $c17, $zero, 0($c11)
; CHECK-NEXT:    .cfi_offset 16, -8
; CHECK-NEXT:    .cfi_offset 90, -[[@EXPR FRAME_SIZE - $CAP_SIZE]]
; CHECK-NEXT:    .cfi_offset 89, -[[FRAME_SIZE]]
...
; CHECK-NEXT:    cld $16, $zero, [[FIRST_REG_OFFSET]]($c11)
; CHECK-NEXT:    cjr $c17
; CHECK-NEXT:    cincoffset $c11, $c11, [[FRAME_SIZE]]
entry:
