...
; RUN: llc -o - -mtriple=cheri-unknown-rtems5 -relocation-model=pic -thread-model=posix -mattr=-noabicalls -mattr=+cheri128 -target-abi purecap -float-abi=soft -mcpu=cheri128 -O0 -cheri-cap-table-abi=pcrel -verify-machineinstrs %s | FileCheck %s
