...
; IR-NEXT:    [[TMP:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set.i64(i8 addrspace(200)* null, i64 42)
...
; IR-NEXT:    [[TMP:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.address.set.i64(i8 addrspace(200)* null, i64 %arg)
; IR-NEXT:    ret i8 addrspace(200)* [[TMP]]
...
; IR-NEXT:    [[RET:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* null, i64 42)
...
; IR-NEXT:    [[RET:%.*]] = call i8 addrspace(200)* @llvm.cheri.cap.offset.set.i64(i8 addrspace(200)* null, i64 %arg)
; IR-NEXT:    ret i8 addrspace(200)* [[RET]]
