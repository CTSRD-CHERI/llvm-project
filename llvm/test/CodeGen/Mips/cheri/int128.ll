...
; RUN: %cheri_purecap_llc -disable-cheri-addressing-mode-folder=true -o - %s  | FileCheck %s -check-prefixes CHECK,NO-FOLDER
; RUN: %cheri_purecap_llc -disable-cheri-addressing-mode-folder=false -o - %s | FileCheck %s -check-prefixes CHECK,ADDRFOLDER
