...
; RUN: %cheri_purecap_llc -disable-cheri-addressing-mode-folder=true < %s | FileCheck %s -check-prefixes CHECK,NO-FOLDER
; RUN: %cheri_purecap_llc -disable-cheri-addressing-mode-folder=false < %s | FileCheck %s -check-prefixes CHECK,ADDRFOLDER
