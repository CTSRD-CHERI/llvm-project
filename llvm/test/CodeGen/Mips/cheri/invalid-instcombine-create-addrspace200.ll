...
; RUN: %cheri256_opt -instcombine -o - -S %s -data-layout="Eme-pf200:256:256:256:64-i8:8:32-i16:16:32-i64:64-n32:64-S128" | FileCheck %s -check-prefix CHERI256
...
;
; CHERI256-LABEL: define i128 @_ZN8durationInE1fEv(
; CHERI256-NEXT:  entry:
