...
; RUN: %cheri128_opt -opaque-pointers=0 -passes=instcombine -o - -S %s -data-layout="Eme-pf200:128:128:128:64-i8:8:32-i16:16:32-i64:64-n32:64-S128" | FileCheck %s -check-prefix CHERI128
; RUN: %cheri128_opt -opaque-pointers=0 -data-layout="Eme-pf200:128:128:128:64-i8:8:32-i16:16:32-i64:64-n32:64-S128" -o - \
; RUN:     -O2 -S %s | %cheri128_llc -opaque-pointers=0 - -o - | FileCheck %s -check-prefixes ASM,N64-CHERI128-BAD-CODE
