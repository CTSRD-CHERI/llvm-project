...
; CHERI128-NEXT:    sd $ra, 248($sp) # 8-byte Folded Spill
; CHERI128-NEXT:    sd $fp, 240($sp) # 8-byte Folded Spill
...
; CHERI128-NEXT:    ld $fp, 240($sp) # 8-byte Folded Reload
; CHERI128-NEXT:    ld $ra, 248($sp) # 8-byte Folded Reload
; CHECK-NEXT:    jr $ra
; CHECK-NEXT:    daddiu $sp, $sp, {{256|288}}
bb:
