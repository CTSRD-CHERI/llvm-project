...
; RUN: %cheri_purecap_opt -sroa -S %s -o - | FileCheck %s -check-prefix SROA
; RUN: %cheri_purecap_opt -sroa -S %s -o - | %cheri_purecap_llc -O2 - -o - | FileCheck %s -check-prefixes=CHECK,WITH-SROA
