...
; RUsN: %cheri128_purecap_llc %s -O2 -o - -filetype=obj | llvm-objdump -d -
; RUN: %cheri128_purecap_llc %s -O2 -o - -debug-only="cheri-purecap-alloca" | FileCheck %s '-D$CAP_SIZE=16'
; RUsN: %cheri128_purecap_llc %s -O2 -o - -filetype=obj | llvm-objdump -d - | FileCheck %s -check-prefix DUMP
...
; DUMP-NEXT:       4:	ea 2b 00 8b 	csd	$17, $zero, 136($c11)
; DUMP-NEXT:       8:	ea 0b 00 83 	csd	$16, $zero, 128($c11)
; DUMP-NEXT:       c:	fb 0b 00 07 	csc	$c24, $zero, 112($c11)
; DUMP-NEXT:      10:	fa 8b 00 06 	csc	$c20, $zero, 96($c11)
; DUMP-NEXT:      14:	fa 6b 00 05 	csc	$c19, $zero, 80($c11)
; DUMP-NEXT:      18:	fa 4b 00 04 	csc	$c18, $zero, 64($c11)
; DUMP-NEXT:      1c:	fa 2b 00 03 	csc	$c17, $zero, 48($c11)
; DUMP-NEXT:      20:	48 18 58 11 	cincoffset	$c24, $c11, $zero
; DUMP-NEXT:      24:	48 12 1a bf 	cmove	$c18,  $c3
; DUMP-NEXT:      28:	d8 23 00 05 	clc	$c1, $zero, 80($c3)
; DUMP-NEXT:      2c:	3c 01 00 00 	lui	$1, 0
; DUMP-NEXT:      30:	64 21 00 00 	daddiu	$1, $1, 0
; DUMP-NEXT:      34:	49 21 00 25 	cbtu	$c1, 152 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xcc>
; DUMP-NEXT:      38:	48 14 60 51 	cincoffset	$c20, $c12, $1
; DUMP-NEXT:      3c:	48 01 0b ff 	cgetaddr	$1, $c1
; DUMP-NEXT:      40:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:      44:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:      48:	48 02 08 51 	cincoffset	$c2, $c1, $1
; DUMP-NEXT:      4c:	4a 63 10 c8 	cincoffset	$c3, $c2, 200
; DUMP-NEXT:      50:	c8 23 00 00 	clbu	$1, $zero, 0($c3)
; DUMP-NEXT:      54:	10 20 00 0b 	beqz	$1, 48 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x84>
; DUMP-NEXT:      58:	00 00 00 00 	nop
; DUMP-NEXT:      5c:	c8 21 00 30 	clbu	$1, $zero, 6($c1)
; DUMP-NEXT:      60:	30 21 00 20 	andi	$1, $1, 32
; DUMP-NEXT:      64:	14 20 00 07 	bnez	$1, 32 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x84>
; DUMP-NEXT:      68:	00 00 00 00 	nop
; DUMP-NEXT:      6c:	4a 62 08 20 	cincoffset	$c2, $c1, 32
; DUMP-NEXT:      70:	d8 42 00 00 	clc	$c2, $zero, 0($c2)
; DUMP-NEXT:      74:	4a 42 00 0c 	cbnz	$c2, 52 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xa8>
; DUMP-NEXT:      78:	00 00 00 00 	nop
; DUMP-NEXT:      7c:	10 00 00 13 	b	80 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xcc>
; DUMP-NEXT:      80:	00 00 00 00 	nop
; DUMP-NEXT:      84:	d8 42 00 13 	clc	$c2, $zero, 304($c2)
; DUMP-NEXT:      88:	c8 21 00 02 	clwu	$1, $zero, 0($c1)
; DUMP-NEXT:      8c:	d8 42 00 0e 	clc	$c2, $zero, 224($c2)
; DUMP-NEXT:      90:	00 01 09 38 	dsll	$1, $1, 4
; DUMP-NEXT:      94:	d8 42 08 00 	clc	$c2, $1, 0($c2)
; DUMP-NEXT:      98:	4a 62 10 70 	cincoffset	$c2, $c2, 112
; DUMP-NEXT:      9c:	d8 42 00 00 	clc	$c2, $zero, 0($c2)
; DUMP-NEXT:      a0:	4a 22 00 0a 	cbez	$c2, 44 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xcc>
; DUMP-NEXT:      a4:	00 00 00 00 	nop
; DUMP-NEXT:      a8:	74 74 00 00 	clcbi	$c3, 0($c20)
; DUMP-NEXT:      ac:	4a 64 c0 20 	cincoffset	$c4, $c24, 32
; DUMP-NEXT:      b0:	4a 93 20 10 	csetbounds	$c19, $c4, 16
; DUMP-NEXT:      b4:	48 01 10 d4 	ceq	$1, $c2, $c3
; DUMP-NEXT:      b8:	14 20 00 0b 	bnez	$1, 48 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xe8>
; DUMP-NEXT:      bc:	00 00 00 00 	nop
; DUMP-NEXT:      c0:	d8 42 00 01 	clc	$c2, $zero, 16($c2)
; DUMP-NEXT:      c4:	4a 42 ff fb 	cbnz	$c2, -16 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xb4>
; DUMP-NEXT:      c8:	00 00 00 00 	nop
; DUMP-NEXT:      cc:	74 94 00 00 	clcbi	$c4, 0($c20)
; DUMP-NEXT:      d0:	74 b4 00 00 	clcbi	$c5, 0($c20)
; DUMP-NEXT:      d4:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:      d8:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:      dc:	48 03 92 bf 	cmove	$c3,  $c18
; DUMP-NEXT:      e0:	10 00 00 60 	b	388 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x264>
; DUMP-NEXT:      e4:	00 00 00 00 	nop
; DUMP-NEXT:      e8:	4a 21 ff f8 	cbez	$c1, -28 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xcc>
; DUMP-NEXT:      ec:	00 00 00 00 	nop
; DUMP-NEXT:      f0:	c8 32 00 9e 	clw	$1, $zero, 76($c18)
; DUMP-NEXT:      f4:	24 02 00 01 	addiu	$2, $zero, 1
; DUMP-NEXT:      f8:	10 22 00 64 	beq	$1, $2, 404 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x28c>
; DUMP-NEXT:      fc:	00 00 00 00 	nop
; DUMP-NEXT:     100:	d8 52 00 06 	clc	$c2, $zero, 96($c18)
; DUMP-NEXT:     104:	f8 58 00 00 	csc	$c2, $zero, 0($c24)
; DUMP-NEXT:     108:	4a 63 c0 00 	cincoffset	$c3, $c24, 0
; DUMP-NEXT:     10c:	c8 43 00 0b 	cld	$2, $zero, 8($c3)
; DUMP-NEXT:     110:	da 61 00 03 	clc	$c19, $zero, 48($c1)
; DUMP-NEXT:     114:	64 01 ff ff 	daddiu	$1, $zero, -1
; DUMP-NEXT:     118:	00 01 1c 3c 	dsll32	$3, $1, 16
; DUMP-NEXT:     11c:	00 43 08 2b 	sltu	$1, $2, $3
; DUMP-NEXT:     120:	14 20 00 04 	bnez	$1, 20 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x134>
; DUMP-NEXT:     124:	00 00 00 00 	nop
; DUMP-NEXT:     128:	00 02 08 00 	sll	$1, $2, 0
; DUMP-NEXT:     12c:	10 00 00 3b 	b	240 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x21c>
; DUMP-NEXT:     130:	00 01 10 2b 	sltu	$2, $zero, $1
; DUMP-NEXT:     134:	00 43 80 2d 	daddu	$16, $2, $3
; DUMP-NEXT:     138:	64 01 7f ff 	daddiu	$1, $zero, 32767
; DUMP-NEXT:     13c:	00 01 0c 7c 	dsll32	$1, $1, 17
; DUMP-NEXT:     140:	64 21 ff ff 	daddiu	$1, $1, -1
; DUMP-NEXT:     144:	00 30 08 2b 	sltu	$1, $1, $16
; DUMP-NEXT:     148:	14 20 00 0d 	bnez	$1, 56 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x180>
; DUMP-NEXT:     14c:	00 00 00 00 	nop
; DUMP-NEXT:     150:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     154:	64 05 00 00 	daddiu	$5, $zero, 0
; DUMP-NEXT:     158:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     15c:	02 00 20 25 	move	$4, $16
; DUMP-NEXT:     160:	00 02 88 2a 	slt	$17, $zero, $2
; DUMP-NEXT:     164:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     168:	64 05 00 00 	daddiu	$5, $zero, 0
; DUMP-NEXT:     16c:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     170:	02 00 20 25 	move	$4, $16
; DUMP-NEXT:     174:	28 41 00 00 	slti	$1, $2, 0
; DUMP-NEXT:     178:	10 00 00 28 	b	164 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x21c>
; DUMP-NEXT:     17c:	00 31 10 25 	or	$2, $1, $17
; DUMP-NEXT:     180:	49 22 00 08 	cbtu	$c2, 36 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x1a4>
; DUMP-NEXT:     184:	00 00 00 00 	nop
; DUMP-NEXT:     188:	c8 22 00 28 	clbu	$1, $zero, 5($c2)
; DUMP-NEXT:     18c:	24 02 00 06 	addiu	$2, $zero, 6
; DUMP-NEXT:     190:	14 22 00 0a 	bne	$1, $2, 44 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x1bc>
; DUMP-NEXT:     194:	00 00 00 00 	nop
; DUMP-NEXT:     198:	c8 22 00 1e 	clw	$1, $zero, 12($c2)
; DUMP-NEXT:     19c:	10 00 00 1f 	b	128 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x21c>
; DUMP-NEXT:     1a0:	00 01 10 2b 	sltu	$2, $zero, $1
; DUMP-NEXT:     1a4:	4a 61 c0 10 	cincoffset	$c1, $c24, 16
; DUMP-NEXT:     1a8:	64 01 00 07 	daddiu	$1, $zero, 7
; DUMP-NEXT:     1ac:	e8 21 00 0b 	csd	$1, $zero, 8($c1)
; DUMP-NEXT:     1b0:	d8 38 00 01 	clc	$c1, $zero, 16($c24)
; DUMP-NEXT:     1b4:	10 00 00 19 	b	104 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x21c>
; DUMP-NEXT:     1b8:	48 02 10 54 	ceq	$2, $c2, $c1
; DUMP-NEXT:     1bc:	48 01 13 ff 	cgetaddr	$1, $c2
; DUMP-NEXT:     1c0:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     1c4:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     1c8:	d8 22 08 13 	clc	$c1, $1, 304($c2)
; DUMP-NEXT:     1cc:	c8 22 00 02 	clwu	$1, $zero, 0($c2)
; DUMP-NEXT:     1d0:	d8 21 00 0e 	clc	$c1, $zero, 224($c1)
; DUMP-NEXT:     1d4:	00 01 09 38 	dsll	$1, $1, 4
; DUMP-NEXT:     1d8:	d8 21 08 00 	clc	$c1, $1, 0($c1)
; DUMP-NEXT:     1dc:	c8 21 00 70 	clbu	$1, $zero, 14($c1)
; DUMP-NEXT:     1e0:	30 21 00 01 	andi	$1, $1, 1
; DUMP-NEXT:     1e4:	10 20 00 0d 	beqz	$1, 56 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x21c>
; DUMP-NEXT:     1e8:	24 02 00 01 	addiu	$2, $zero, 1
; DUMP-NEXT:     1ec:	d8 52 00 03 	clc	$c2, $zero, 48($c18)
; DUMP-NEXT:     1f0:	48 01 13 ff 	cgetaddr	$1, $c2
; DUMP-NEXT:     1f4:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     1f8:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     1fc:	d8 62 08 13 	clc	$c3, $1, 304($c2)
; DUMP-NEXT:     200:	c8 22 00 02 	clwu	$1, $zero, 0($c2)
; DUMP-NEXT:     204:	d8 43 00 0e 	clc	$c2, $zero, 224($c3)
; DUMP-NEXT:     208:	00 01 09 38 	dsll	$1, $1, 4
; DUMP-NEXT:     20c:	d8 42 08 00 	clc	$c2, $1, 0($c2)
; DUMP-NEXT:     210:	d8 42 00 02 	clc	$c2, $zero, 32($c2)
; DUMP-NEXT:     214:	d8 21 00 02 	clc	$c1, $zero, 32($c1)
; DUMP-NEXT:     218:	48 02 08 95 	cne	$2, $c1, $c2
; DUMP-NEXT:     21c:	d8 32 00 03 	clc	$c1, $zero, 48($c18)
; DUMP-NEXT:     220:	48 01 0b ff 	cgetaddr	$1, $c1
; DUMP-NEXT:     224:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     228:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     22c:	d8 21 08 13 	clc	$c1, $1, 304($c1)
; DUMP-NEXT:     230:	34 01 b8 60 	ori	$1, $zero, 47200
; DUMP-NEXT:     234:	d8 21 08 00 	clc	$c1, $1, 0($c1)
; DUMP-NEXT:     238:	4a 41 00 24 	cbnz	$c1, 148 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x2cc>
; DUMP-NEXT:     23c:	00 00 00 00 	nop
; DUMP-NEXT:     240:	00 02 08 3c 	dsll32	$1, $2, 0
; DUMP-NEXT:     244:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     248:	00 01 20 3e 	dsrl32	$4, $1, 0
; DUMP-NEXT:     24c:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     250:	48 03 9a bf 	cmove	$c3,  $c19
; DUMP-NEXT:     254:	4a 61 c0 10 	cincoffset	$c1, $c24, 16
; DUMP-NEXT:     258:	64 01 00 0a 	daddiu	$1, $zero, 10
; DUMP-NEXT:     25c:	e8 21 00 0b 	csd	$1, $zero, 8($c1)
; DUMP-NEXT:     260:	d8 78 00 01 	clc	$c3, $zero, 16($c24)
; DUMP-NEXT:     264:	48 0b c0 11 	cincoffset	$c11, $c24, $zero
; DUMP-NEXT:     268:	da 2b 00 03 	clc	$c17, $zero, 48($c11)
; DUMP-NEXT:     26c:	da 4b 00 04 	clc	$c18, $zero, 64($c11)
; DUMP-NEXT:     270:	da 6b 00 05 	clc	$c19, $zero, 80($c11)
; DUMP-NEXT:     274:	da 8b 00 06 	clc	$c20, $zero, 96($c11)
; DUMP-NEXT:     278:	db 0b 00 07 	clc	$c24, $zero, 112($c11)
; DUMP-NEXT:     27c:	ca 0b 00 83 	cld	$16, $zero, 128($c11)
; DUMP-NEXT:     280:	ca 2b 00 8b 	cld	$17, $zero, 136($c11)
; DUMP-NEXT:     284:	48 11 1f ff 	cjr	$c17
; DUMP-NEXT:     288:	4a 6b 58 90 	cincoffset	$c11, $c11, 144
; DUMP-NEXT:     28c:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     290:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     294:	48 03 92 bf 	cmove	$c3,  $c18
; DUMP-NEXT:     298:	d8 32 00 03 	clc	$c1, $zero, 48($c18)
; DUMP-NEXT:     29c:	48 01 0b ff 	cgetaddr	$1, $c1
; DUMP-NEXT:     2a0:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     2a4:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     2a8:	d8 21 08 13 	clc	$c1, $1, 304($c1)
; DUMP-NEXT:     2ac:	f8 73 00 00 	csc	$c3, $zero, 0($c19)
; DUMP-NEXT:     2b0:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     2b4:	48 03 0a bf 	cmove	$c3,  $c1
; DUMP-NEXT:     2b8:	48 04 92 bf 	cmove	$c4,  $c18
; DUMP-NEXT:     2bc:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     2c0:	48 05 9a bf 	cmove	$c5,  $c19
; DUMP-NEXT:     2c4:	10 00 ff e7 	b	-96 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x264>
; DUMP-NEXT:     2c8:	00 00 00 00 	nop
; DUMP-NEXT:     2cc:	4a 61 c0 10 	cincoffset	$c1, $c24, 16
; DUMP-NEXT:     2d0:	64 01 00 0a 	daddiu	$1, $zero, 10
; DUMP-NEXT:     2d4:	e8 21 00 0b 	csd	$1, $zero, 8($c1)
; DUMP-NEXT:     2d8:	10 00 ff e2 	b	-116 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x264>
; DUMP-NEXT:     2dc:	d8 78 00 01 	clc	$c3, $zero, 16($c24)
...
; CHECK-NEXT:    cincoffset $c3, $c24, 0
; CHECK-NEXT:    cld $2, $zero, 8($c3)
...
; CHECK-NEXT:    cincoffset $c1, $c24, 16
