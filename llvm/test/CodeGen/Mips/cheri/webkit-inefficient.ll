...
; DUMP-NEXT:       0:	4a 6b 5f 30 	cincoffset	$c11, $c11, -208
; DUMP-NEXT:       4:	ea 2b 00 cb 	csd	$17, $zero, 200($c11)
; DUMP-NEXT:       8:	ea 0b 00 c3 	csd	$16, $zero, 192($c11)
; DUMP-NEXT:       c:	fb 0b 00 0b 	csc	$c24, $zero, 176($c11)
; DUMP-NEXT:      10:	fa cb 00 0a 	csc	$c22, $zero, 160($c11)
; DUMP-NEXT:      14:	fa ab 00 09 	csc	$c21, $zero, 144($c11)
; DUMP-NEXT:      18:	fa 8b 00 08 	csc	$c20, $zero, 128($c11)
; DUMP-NEXT:      1c:	fa 6b 00 07 	csc	$c19, $zero, 112($c11)
; DUMP-NEXT:      20:	fa 4b 00 06 	csc	$c18, $zero, 96($c11)
; DUMP-NEXT:      24:	fa 2b 00 05 	csc	$c17, $zero, 80($c11)
; DUMP-NEXT:      28:	48 18 58 11 	cincoffset	$c24, $c11, $zero
; DUMP-NEXT:      2c:	48 12 1a bf 	cmove	$c18,  $c3
; DUMP-NEXT:      30:	d8 23 00 05 	clc	$c1, $zero, 80($c3)
; DUMP-NEXT:      34:	3c 01 00 00 	lui	$1, 0
; DUMP-NEXT:      38:	64 21 00 00 	daddiu	$1, $1, 0
; DUMP-NEXT:      3c:	49 21 00 2d 	cbtu	$c1, 184 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xf4>
; DUMP-NEXT:      40:	48 14 60 51 	cincoffset	$c20, $c12, $1
; DUMP-NEXT:      44:	48 01 0b ff 	cgetaddr	$1, $c1
; DUMP-NEXT:      48:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:      4c:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:      50:	48 02 08 51 	cincoffset	$c2, $c1, $1
; DUMP-NEXT:      54:	4a 63 10 c8 	cincoffset	$c3, $c2, 200
; DUMP-NEXT:      58:	c8 23 00 00 	clbu	$1, $zero, 0($c3)
; DUMP-NEXT:      5c:	10 20 00 0b 	beqz	$1, 48 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x8c>
; DUMP-NEXT:      60:	00 00 00 00 	nop
; DUMP-NEXT:      64:	c8 21 00 30 	clbu	$1, $zero, 6($c1)
; DUMP-NEXT:      68:	30 21 00 20 	andi	$1, $1, 32
; DUMP-NEXT:      6c:	14 20 00 07 	bnez	$1, 32 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x8c>
; DUMP-NEXT:      70:	00 00 00 00 	nop
; DUMP-NEXT:      74:	4a 62 08 20 	cincoffset	$c2, $c1, 32
; DUMP-NEXT:      78:	d8 62 00 00 	clc	$c3, $zero, 0($c2)
; DUMP-NEXT:      7c:	4a 43 00 0c 	cbnz	$c3, 52 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xb0>
; DUMP-NEXT:      80:	00 00 00 00 	nop
; DUMP-NEXT:      84:	10 00 00 1b 	b	112 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xf4>
; DUMP-NEXT:      88:	00 00 00 00 	nop
; DUMP-NEXT:      8c:	d8 42 00 13 	clc	$c2, $zero, 304($c2)
; DUMP-NEXT:      90:	c8 21 00 02 	clwu	$1, $zero, 0($c1)
; DUMP-NEXT:      94:	d8 42 00 0e 	clc	$c2, $zero, 224($c2)
; DUMP-NEXT:      98:	00 01 09 38 	dsll	$1, $1, 4
; DUMP-NEXT:      9c:	d8 42 08 00 	clc	$c2, $1, 0($c2)
; DUMP-NEXT:      a0:	4a 62 10 70 	cincoffset	$c2, $c2, 112
; DUMP-NEXT:      a4:	d8 62 00 00 	clc	$c3, $zero, 0($c2)
; DUMP-NEXT:      a8:	4a 23 00 12 	cbez	$c3, 76 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xf4>
; DUMP-NEXT:      ac:	00 00 00 00 	nop
; DUMP-NEXT:      b0:	4a 62 c0 40 	cincoffset	$c2, $c24, 64
; DUMP-NEXT:      b4:	4a 64 c0 30 	cincoffset	$c4, $c24, 48
; DUMP-NEXT:      b8:	4a 66 c0 20 	cincoffset	$c6, $c24, 32
; DUMP-NEXT:      bc:	4a 67 c0 10 	cincoffset	$c7, $c24, 16
; DUMP-NEXT:      c0:	4a 68 c0 00 	cincoffset	$c8, $c24, 0
; DUMP-NEXT:      c4:	4a 93 10 10 	csetbounds	$c19, $c2, 16
; DUMP-NEXT:      c8:	4a 82 20 10 	csetbounds	$c2, $c4, 16
; DUMP-NEXT:      cc:	74 b4 00 00 	clcbi	$c5, 0($c20)
; DUMP-NEXT:      d0:	4a 96 30 10 	csetbounds	$c22, $c6, 16
; DUMP-NEXT:      d4:	4a 95 38 10 	csetbounds	$c21, $c7, 16
; DUMP-NEXT:      d8:	4a 84 40 10 	csetbounds	$c4, $c8, 16
; DUMP-NEXT:      dc:	48 01 19 54 	ceq	$1, $c3, $c5
; DUMP-NEXT:      e0:	14 20 00 0b 	bnez	$1, 48 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x110>
; DUMP-NEXT:      e4:	00 00 00 00 	nop
; DUMP-NEXT:      e8:	d8 63 00 01 	clc	$c3, $zero, 16($c3)
; DUMP-NEXT:      ec:	4a 43 ff fb 	cbnz	$c3, -16 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xdc>
; DUMP-NEXT:      f0:	00 00 00 00 	nop
; DUMP-NEXT:      f4:	74 94 00 00 	clcbi	$c4, 0($c20)
; DUMP-NEXT:      f8:	74 b4 00 00 	clcbi	$c5, 0($c20)
; DUMP-NEXT:      fc:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     100:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     104:	48 03 92 bf 	cmove	$c3,  $c18
; DUMP-NEXT:     108:	10 00 00 5d 	b	376 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x280>
; DUMP-NEXT:     10c:	00 00 00 00 	nop
; DUMP-NEXT:     110:	4a 21 ff f8 	cbez	$c1, -28 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0xf4>
; DUMP-NEXT:     114:	00 00 00 00 	nop
; DUMP-NEXT:     118:	c8 32 00 9e 	clw	$1, $zero, 76($c18)
; DUMP-NEXT:     11c:	24 02 00 01 	addiu	$2, $zero, 1
; DUMP-NEXT:     120:	10 22 00 63 	beq	$1, $2, 400 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x2b0>
; DUMP-NEXT:     124:	00 00 00 00 	nop
; DUMP-NEXT:     128:	d8 72 00 06 	clc	$c3, $zero, 96($c18)
; DUMP-NEXT:     12c:	da 61 00 03 	clc	$c19, $zero, 48($c1)
; DUMP-NEXT:     130:	f8 64 00 00 	csc	$c3, $zero, 0($c4)
; DUMP-NEXT:     134:	c8 44 00 0b 	cld	$2, $zero, 8($c4)
; DUMP-NEXT:     138:	64 01 ff ff 	daddiu	$1, $zero, -1
; DUMP-NEXT:     13c:	00 01 1c 3c 	dsll32	$3, $1, 16
; DUMP-NEXT:     140:	00 43 08 2b 	sltu	$1, $2, $3
; DUMP-NEXT:     144:	14 20 00 04 	bnez	$1, 20 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x158>
; DUMP-NEXT:     148:	00 00 00 00 	nop
; DUMP-NEXT:     14c:	00 02 08 00 	sll	$1, $2, 0
; DUMP-NEXT:     150:	10 00 00 3a 	b	236 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x23c>
; DUMP-NEXT:     154:	00 01 10 2b 	sltu	$2, $zero, $1
; DUMP-NEXT:     158:	00 43 80 2d 	daddu	$16, $2, $3
; DUMP-NEXT:     15c:	64 01 7f ff 	daddiu	$1, $zero, 32767
; DUMP-NEXT:     160:	00 01 0c 7c 	dsll32	$1, $1, 17
; DUMP-NEXT:     164:	64 21 ff ff 	daddiu	$1, $1, -1
; DUMP-NEXT:     168:	00 30 08 2b 	sltu	$1, $1, $16
; DUMP-NEXT:     16c:	14 20 00 0d 	bnez	$1, 56 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x1a4>
; DUMP-NEXT:     170:	00 00 00 00 	nop
; DUMP-NEXT:     174:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     178:	64 05 00 00 	daddiu	$5, $zero, 0
; DUMP-NEXT:     17c:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     180:	02 00 20 25 	move	$4, $16
; DUMP-NEXT:     184:	00 02 88 2a 	slt	$17, $zero, $2
; DUMP-NEXT:     188:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     18c:	64 05 00 00 	daddiu	$5, $zero, 0
; DUMP-NEXT:     190:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     194:	02 00 20 25 	move	$4, $16
; DUMP-NEXT:     198:	28 41 00 00 	slti	$1, $2, 0
; DUMP-NEXT:     19c:	10 00 00 27 	b	160 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x23c>
; DUMP-NEXT:     1a0:	00 31 10 25 	or	$2, $1, $17
; DUMP-NEXT:     1a4:	49 23 00 08 	cbtu	$c3, 36 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x1c8>
; DUMP-NEXT:     1a8:	00 00 00 00 	nop
; DUMP-NEXT:     1ac:	c8 23 00 28 	clbu	$1, $zero, 5($c3)
; DUMP-NEXT:     1b0:	24 02 00 06 	addiu	$2, $zero, 6
; DUMP-NEXT:     1b4:	14 22 00 09 	bne	$1, $2, 40 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x1dc>
; DUMP-NEXT:     1b8:	00 00 00 00 	nop
; DUMP-NEXT:     1bc:	c8 23 00 1e 	clw	$1, $zero, 12($c3)
; DUMP-NEXT:     1c0:	10 00 00 1e 	b	124 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x23c>
; DUMP-NEXT:     1c4:	00 01 10 2b 	sltu	$2, $zero, $1
; DUMP-NEXT:     1c8:	64 01 00 07 	daddiu	$1, $zero, 7
; DUMP-NEXT:     1cc:	e8 22 00 0b 	csd	$1, $zero, 8($c2)
; DUMP-NEXT:     1d0:	d8 22 00 00 	clc	$c1, $zero, 0($c2)
; DUMP-NEXT:     1d4:	10 00 00 19 	b	104 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x23c>
; DUMP-NEXT:     1d8:	48 02 18 54 	ceq	$2, $c3, $c1
; DUMP-NEXT:     1dc:	48 01 1b ff 	cgetaddr	$1, $c3
; DUMP-NEXT:     1e0:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     1e4:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     1e8:	d8 23 08 13 	clc	$c1, $1, 304($c3)
; DUMP-NEXT:     1ec:	c8 23 00 02 	clwu	$1, $zero, 0($c3)
; DUMP-NEXT:     1f0:	d8 21 00 0e 	clc	$c1, $zero, 224($c1)
; DUMP-NEXT:     1f4:	00 01 09 38 	dsll	$1, $1, 4
; DUMP-NEXT:     1f8:	d8 21 08 00 	clc	$c1, $1, 0($c1)
; DUMP-NEXT:     1fc:	c8 21 00 70 	clbu	$1, $zero, 14($c1)
; DUMP-NEXT:     200:	30 21 00 01 	andi	$1, $1, 1
; DUMP-NEXT:     204:	10 20 00 0d 	beqz	$1, 56 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x23c>
; DUMP-NEXT:     208:	24 02 00 01 	addiu	$2, $zero, 1
; DUMP-NEXT:     20c:	d8 52 00 03 	clc	$c2, $zero, 48($c18)
; DUMP-NEXT:     210:	48 01 13 ff 	cgetaddr	$1, $c2
; DUMP-NEXT:     214:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     218:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     21c:	d8 62 08 13 	clc	$c3, $1, 304($c2)
; DUMP-NEXT:     220:	c8 22 00 02 	clwu	$1, $zero, 0($c2)
; DUMP-NEXT:     224:	d8 43 00 0e 	clc	$c2, $zero, 224($c3)
; DUMP-NEXT:     228:	00 01 09 38 	dsll	$1, $1, 4
; DUMP-NEXT:     22c:	d8 42 08 00 	clc	$c2, $1, 0($c2)
; DUMP-NEXT:     230:	d8 42 00 02 	clc	$c2, $zero, 32($c2)
; DUMP-NEXT:     234:	d8 21 00 02 	clc	$c1, $zero, 32($c1)
; DUMP-NEXT:     238:	48 02 08 95 	cne	$2, $c1, $c2
; DUMP-NEXT:     23c:	d8 32 00 03 	clc	$c1, $zero, 48($c18)
; DUMP-NEXT:     240:	48 01 0b ff 	cgetaddr	$1, $c1
; DUMP-NEXT:     244:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     248:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     24c:	d8 21 08 13 	clc	$c1, $1, 304($c1)
; DUMP-NEXT:     250:	34 01 b8 60 	ori	$1, $zero, 47200
; DUMP-NEXT:     254:	d8 21 08 00 	clc	$c1, $1, 0($c1)
; DUMP-NEXT:     258:	4a 41 00 25 	cbnz	$c1, 152 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x2f0>
; DUMP-NEXT:     25c:	00 00 00 00 	nop
; DUMP-NEXT:     260:	00 02 08 3c 	dsll32	$1, $2, 0
; DUMP-NEXT:     264:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     268:	00 01 20 3e 	dsrl32	$4, $1, 0
; DUMP-NEXT:     26c:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     270:	48 03 9a bf 	cmove	$c3,  $c19
; DUMP-NEXT:     274:	64 01 00 0a 	daddiu	$1, $zero, 10
; DUMP-NEXT:     278:	e8 35 00 0b 	csd	$1, $zero, 8($c21)
; DUMP-NEXT:     27c:	d8 75 00 00 	clc	$c3, $zero, 0($c21)
; DUMP-NEXT:     280:	48 0b c0 11 	cincoffset	$c11, $c24, $zero
; DUMP-NEXT:     284:	da 2b 00 05 	clc	$c17, $zero, 80($c11)
; DUMP-NEXT:     288:	da 4b 00 06 	clc	$c18, $zero, 96($c11)
; DUMP-NEXT:     28c:	da 6b 00 07 	clc	$c19, $zero, 112($c11)
; DUMP-NEXT:     290:	da 8b 00 08 	clc	$c20, $zero, 128($c11)
; DUMP-NEXT:     294:	da ab 00 09 	clc	$c21, $zero, 144($c11)
; DUMP-NEXT:     298:	da cb 00 0a 	clc	$c22, $zero, 160($c11)
; DUMP-NEXT:     29c:	db 0b 00 0b 	clc	$c24, $zero, 176($c11)
; DUMP-NEXT:     2a0:	ca 0b 00 c3 	cld	$16, $zero, 192($c11)
; DUMP-NEXT:     2a4:	ca 2b 00 cb 	cld	$17, $zero, 200($c11)
; DUMP-NEXT:     2a8:	48 11 1f ff 	cjr	$c17
; DUMP-NEXT:     2ac:	4a 6b 58 d0 	cincoffset	$c11, $c11, 208
; DUMP-NEXT:     2b0:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     2b4:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     2b8:	48 03 92 bf 	cmove	$c3,  $c18
; DUMP-NEXT:     2bc:	d8 32 00 03 	clc	$c1, $zero, 48($c18)
; DUMP-NEXT:     2c0:	48 01 0b ff 	cgetaddr	$1, $c1
; DUMP-NEXT:     2c4:	30 21 3f ff 	andi	$1, $1, 16383
; DUMP-NEXT:     2c8:	00 01 08 2f 	dnegu	$1, $1
; DUMP-NEXT:     2cc:	d8 21 08 13 	clc	$c1, $1, 304($c1)
; DUMP-NEXT:     2d0:	f8 73 00 00 	csc	$c3, $zero, 0($c19)
; DUMP-NEXT:     2d4:	75 94 00 00 	clcbi	$c12, 0($c20)
; DUMP-NEXT:     2d8:	48 03 0a bf 	cmove	$c3,  $c1
; DUMP-NEXT:     2dc:	48 04 92 bf 	cmove	$c4,  $c18
; DUMP-NEXT:     2e0:	48 11 63 3f 	cjalr	$c12, $c17
; DUMP-NEXT:     2e4:	48 05 9a bf 	cmove	$c5,  $c19
; DUMP-NEXT:     2e8:	10 00 ff e5 	b	-104 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x280>
; DUMP-NEXT:     2ec:	00 00 00 00 	nop
; DUMP-NEXT:     2f0:	64 01 00 0a 	daddiu	$1, $zero, 10
; DUMP-NEXT:     2f4:	e8 36 00 0b 	csd	$1, $zero, 8($c22)
; DUMP-NEXT:     2f8:	d8 76 00 00 	clc	$c3, $zero, 0($c22)
; DUMP-NEXT:     2fc:	10 00 ff e0 	b	-124 <_ZN7WebCore67jsInternalSettingsGeneratedPrototypeFunctionSetCaretBrowsingEnabledEU3capPN3JSC9ExecStateE+0x280>
; DUMP-NEXT:     300:	00 00 00 00 	nop
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    cincoffset $c11, $c11, -[[STACKFRAME_SIZE:208|416]]
; CHECK-NEXT:    csd $17, $zero, [[@EXPR STACKFRAME_SIZE - 8]]($c11)
; CHECK-NEXT:    csd $16, $zero, [[@EXPR STACKFRAME_SIZE - 16]]($c11)
; CHECK-NEXT:    csc $c24, $zero, [[@EXPR 11 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    csc $c22, $zero, [[@EXPR 10 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    csc $c21, $zero, [[@EXPR 9 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    csc $c20, $zero, [[@EXPR 8 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    csc $c19, $zero, [[@EXPR 7 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    csc $c18, $zero, [[@EXPR 6 * $CAP_SIZE]]($c11)
...
; CHECK-NEXT:    clc $c3, $zero, 0($c2)
; CHECK-NEXT:    cbnz $c3, .LBB0_6
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    clc $c3, $zero, 0($c2)
; CHECK-NEXT:    cbez $c3, .LBB0_9
; CHECK-NEXT:    nop
; CHECK-NEXT:  .LBB0_6: # %for.body.i.i.i.preheader
; CHECK-NEXT:    cincoffset $c2, $c24, 64
; CHECK-NEXT:    cincoffset $c4, $c24, 48
; CHECK-NEXT:    cincoffset $c6, $c24, 32
; CHECK-NEXT:    cincoffset $c7, $c24, 16
; CHECK-NEXT:    cincoffset $c8, $c24, 0
; CHECK-NEXT:    csetbounds $c19, $c2, 16
; CHECK-NEXT:    csetbounds $c2, $c4, 16
; CHECK-NEXT:    clcbi $c5, %captab20(_ZN7WebCore27JSInternalSettingsGenerated6s_infoE)($c20)
; CHECK-NEXT:    csetbounds $c22, $c6, 16
; CHECK-NEXT:    csetbounds $c21, $c7, 16
; CHECK-NEXT:    csetbounds $c4, $c8, 16
; CHECK-NEXT:  .LBB0_7: # %for.body.i.i.i
; CHECK-NEXT:    # =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ceq $1, $c3, $c5
; CHECK-NEXT:    bnez $1, .LBB0_10
; CHECK-NEXT:    nop
; CHECK-NEXT:  # %bb.8: # %for.inc.i.i.i
; CHECK-NEXT:    # in Loop: Header=BB0_7 Depth=1
; CHECK-NEXT:    clc $c3, $zero, 16($c3)
; CHECK-NEXT:    cbnz $c3, .LBB0_7
; CHECK-NEXT:    nop
...
; CHECK-NEXT:    clc $c3, $zero, 96($c18)
; CHECK-NEXT:    clc $c19, $zero, 48($c1)
; CHECK-NEXT:    csc $c3, $zero, 0($c4)
; CHECK-NEXT:    cld $2, $zero, 8($c4)
...
; CHECK-NEXT:    csd $1, $zero, 8($c21)
; CHECK-NEXT:    clc $c3, $zero, 0($c21)
; CHECK-NEXT:  .LBB0_24: # %cleanup44
; CHECK-NEXT:    cincoffset $c11, $c24, $zero
; CHECK-NEXT:    clc $c17, $zero, [[@EXPR 5 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    clc $c18, $zero, [[@EXPR 6 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    clc $c19, $zero, [[@EXPR 7 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    clc $c20, $zero, [[@EXPR 8 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    clc $c21, $zero, [[@EXPR 9 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    clc $c22, $zero, [[@EXPR 10 * $CAP_SIZE]]($c11)
; CHECK-NEXT:    clc $c24, $zero, [[@EXPR 11 * $CAP_SIZE]]($c11)
...
; CHECK-NEXT:    daddiu $1, $zero, 10
; CHECK-NEXT:    csd $1, $zero, 8($c22)
; CHECK-NEXT:    clc $c3, $zero, 0($c22)
; CHECK-NEXT:    b .LBB0_24
; CHECK-NEXT:    nop
entry:
