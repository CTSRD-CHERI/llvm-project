...
define void @align4(ptr addrspace(200) nocapture %out) addrspace(200) {
entry:
  call void @llvm.memset.p200.i64(ptr addrspace(200) align 4 %out, i8 0, i64 36, i1 false)
...
define void @align8(ptr addrspace(200) nocapture %out) addrspace(200) {
entry:
  call void @llvm.memset.p200.i64(ptr addrspace(200) align 8 %out, i8 0, i64 36, i1 false)
; Check that the zero memset is expanded to stores.
; CHECK-LABEL: align8:
...
define void @align32(ptr addrspace(200) nocapture %out) addrspace(200) {
entry:
  call void @llvm.memset.p200.i64(ptr addrspace(200) align 32 %out, i8 0, i64 36, i1 false)
...
define void @align64_multiple_of_capsize(ptr addrspace(200) nocapture %out) addrspace(200) {
entry:
  call void @llvm.memset.p200.i64(ptr addrspace(200) align 64 %out, i8 0, i64 64, i1 false)
