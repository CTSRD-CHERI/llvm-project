...
; RUN: %cheri_purecap_llc -O1 %s -o - -disable-mips-delay-filler | FileCheck %s -check-prefixes CHECK,%cheri_type
...
; CHERI256 can't do a capability copy here, instead it uses two 8-byte ones
; CHERI128-NEXT:    clc $c2, $zero, 0($c1)
; CHERI128-NEXT:    csc $c2, $zero, 0($c3)
; CHERI256-NEXT:    cld $1, $zero, 0($c1)
; CHERI256-NEXT:    csd $1, $zero, 0($c3)
; CHECK-NEXT:       clw $1, $zero, 24($c1)
; CHECK-NEXT:       csw $1, $zero, 24($c3)
; CHECK-NEXT:       cld $1, $zero, 16($c1)
; CHECK-NEXT:       csd $1, $zero, 16($c3)
; CHERI256-NEXT:    cld $1, $zero, 8($c1)
; CHERI256-NEXT:    csd $1, $zero, 8($c3)
; CHECK-NEXT:       cjr $c17
; CHECK-NEXT:       nop
entry:
