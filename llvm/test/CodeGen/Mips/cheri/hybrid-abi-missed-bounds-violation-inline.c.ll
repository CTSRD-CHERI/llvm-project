...
; RUN: %cheri_llc -opaque-pointers=0 -o - -stop-after=cheri-range-checker %s | FileCheck %s -check-prefix RANGE-CHECKER
; RUN: %cheri_llc -opaque-pointers=0 -o - %s | %cheri_FileCheck %s
