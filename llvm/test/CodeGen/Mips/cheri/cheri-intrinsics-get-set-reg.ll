...
; RUN: %cheri_llc %s -o - -filetype=obj | llvm-objdump --no-print-imm-hex -d - | FileCheck %s -check-prefix DUMP
...
define ptr addrspace(200) @getddc() nounwind {
entry:
  ; CHECK-LABEL: getddc:
  ; CHECK: creadhwr $c3, $chwr_ddc
  ; CHECK: .end getddc
  %0 = call ptr addrspace(200) @llvm.cheri.ddc.get()
  ret ptr addrspace(200) %0
}
declare ptr addrspace(200) @llvm.cheri.ddc.get()

define ptr addrspace(200) @getpcc() nounwind {
entry:
  ; CHECK-LABEL: getpcc:
  ; CHECK: cgetpcc	$c3
  ; CHECK: .end getpcc
  %0 = call ptr addrspace(200) @llvm.cheri.pcc.get()
  ret ptr addrspace(200) %0
}
...
define ptr addrspace(200) @getidc() nounwind {
entry:
  %0 = call ptr addrspace(200) @llvm.mips.idc.get()
  ret ptr addrspace(200) %0
}
; CHECK-LABEL: getidc:
...
define ptr addrspace(200) @getkr1c() nounwind {
entry:
  %0 = call ptr addrspace(200) @llvm.mips.kr1c.get()
  ret ptr addrspace(200) %0
}
; CHECK-LABEL: getkr1c:
...
define ptr addrspace(200) @getkr2c() nounwind {
entry:
  %0 = call ptr addrspace(200) @llvm.mips.kr2c.get()
  ret ptr addrspace(200) %0
}
; CHECK-LABEL: getkr2c:
...
define ptr addrspace(200) @getkcc() nounwind {
entry:
  %0 = call ptr addrspace(200) @llvm.mips.kcc.get()
  ret ptr addrspace(200) %0
}
; CHECK-LABEL: getkcc:
...
define ptr addrspace(200) @getkdc() nounwind {
entry:
  %0 = call ptr addrspace(200) @llvm.mips.kdc.get()
  ret ptr addrspace(200) %0
}
; CHECK-LABEL: getkdc:
...
define ptr addrspace(200) @getepcc() nounwind {
entry:
...
declare ptr addrspace(200) @llvm.mips.idc.get()
declare ptr addrspace(200) @llvm.mips.kr1c.get()
declare ptr addrspace(200) @llvm.mips.kr2c.get()
declare ptr addrspace(200) @llvm.mips.kcc.get()
declare ptr addrspace(200) @llvm.mips.kdc.get()
