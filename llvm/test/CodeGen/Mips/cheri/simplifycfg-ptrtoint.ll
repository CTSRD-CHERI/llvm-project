...
; RUN: opt -opaque-pointers=0 -data-layout="E-m:e-pf200:128:128:128:64-i8:8:32-i16:16:32-i64:64-n32:64-S128-A200-P200-G200" -S -passes=instcombine %s -o - | FileCheck -check-prefix INSTCOMBINE %s
; RUN: opt -opaque-pointers=0 -data-layout="E-m:e-pf200:128:128:128:64-i8:8:32-i16:16:32-i64:64-n32:64-S128-A200-P200-G200" -S -O2 %s -o - | FileCheck -check-prefix IR %s
; RUN: opt -opaque-pointers=0 -data-layout="E-m:e-pf200:128:128:128:64-i8:8:32-i16:16:32-i64:64-n32:64-S128-A200-P200-G200" -S -O2 %s -o - | %cheri_purecap_llc -opaque-pointers=0 -O2 -o - | %cheri_FileCheck %s -check-prefix ASM
