...
; ASM:       # %bb.0: # %entry
; ASM-NEXT:    lui $1, %hi(%neg(%captab_rel(cannot_fold_tag_unknown)))
; ASM-NEXT:    daddiu $1, $1, %lo(%neg(%captab_rel(cannot_fold_tag_unknown)))
...
; ASM:       # %bb.0: # %entry
; ASM-NEXT:    lui $1, %hi(%neg(%captab_rel(can_fold_tag_unset)))
; ASM-NEXT:    daddiu $1, $1, %lo(%neg(%captab_rel(can_fold_tag_unset)))
; ASM-NEXT:    ccleartag $c1, $c3
; ASM-NEXT:    cgetaddr $2, $c1
; ASM-NEXT:    sltiu $2, $2, 3
; ASM-NEXT:    bnez $2, .LBB1_2
; ASM-NEXT:    cincoffset $c1, $c12, $1
