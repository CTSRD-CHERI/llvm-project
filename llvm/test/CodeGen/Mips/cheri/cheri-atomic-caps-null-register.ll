...
; CHECK-NEXT:    cincoffset $c11, $c11, -[[STACKFRAME_SIZE:16|32]]
; CHECK-NEXT:    csc $c17, $zero, 0($c11)
; CHECK-NEXT:    lui $1, %hi(%neg(%captab_rel(cmpxchg_null_exp)))
; CHECK-NEXT:    daddiu $1, $1, %lo(%neg(%captab_rel(cmpxchg_null_exp)))
; CHECK-NEXT:    cincoffset $c2, $c12, $1
...
; CHECK-NEXT:    cincoffset $c11, $c11, -[[STACKFRAME_SIZE:16|32]]
; CHECK-NEXT:    csc $c17, $zero, 0($c11)
; CHECK-NEXT:    lui $1, %hi(%neg(%captab_rel(cmpxchg_null_newval)))
; CHECK-NEXT:    daddiu $1, $1, %lo(%neg(%captab_rel(cmpxchg_null_newval)))
; CHECK-NEXT:    cincoffset $c2, $c12, $1
; CHECK-NEXT:    clcbi $c4, %captab20(cap)($c2)
; CHECK-NEXT:    sync
