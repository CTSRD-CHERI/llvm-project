...
// CHECK-NEXT:    call void @llvm.dbg.value(metadata i8 addrspace(200)* [[RETVAL_SROA_0_0_COPYLOAD]], metadata !22, metadata !DIExpression()), !dbg !25
// CHECK-NEXT:    [[DOTFCA_0_INSERT:%.*]] = insertvalue { i8 addrspace(200)* } undef, i8 addrspace(200)* [[RETVAL_SROA_0_0_COPYLOAD]], 0, !dbg !26
// CHECK-NEXT:    ret { i8 addrspace(200)* } [[DOTFCA_0_INSERT]], !dbg !26
//
...
// ASM-NEXT: .Ltmp1:
// ASM-NEXT: .loc 1 22 0 prologue_end
...
// CHECK-NEXT:    call void @llvm.dbg.value(metadata i8 addrspace(200)* [[A:%.*]], metadata !33, metadata !DIExpression()), !dbg !39
// CHECK-NEXT:    [[TMP0:%.*]] = bitcast i8 addrspace(200)* addrspace(200)* [[BUFFER]] to i8 addrspace(200)*, !dbg !40
// CHECK-NEXT:    call void @llvm.lifetime.start.p200i8(i64 16, i8 addrspace(200)* nonnull [[TMP0]]) #5, !dbg !40
// CHECK-NEXT:    call void @llvm.dbg.value(metadata i8 addrspace(200)* [[A]], metadata !34, metadata !DIExpression()), !dbg !40
// CHECK-NEXT:    store i8 addrspace(200)* [[A]], i8 addrspace(200)* addrspace(200)* [[BUFFER]], align 16, !dbg !41
// CHECK-NEXT:    [[TMP1:%.*]] = bitcast i8 addrspace(200)* addrspace(200)* [[BUFFER]] to [[STRUCT_GROUP:%.*]] addrspace(200)*, !dbg !42
// CHECK-NEXT:    call void @llvm.dbg.value(metadata [[STRUCT_GROUP]] addrspace(200)* [[TMP1]], metadata !38, metadata !DIExpression()), !dbg !42
// CHECK-NEXT:    call void @do_stuff(%struct.group addrspace(200)* nonnull [[TMP1]]) #5, !dbg !43
// CHECK-NEXT:    call void @llvm.lifetime.end.p200i8(i64 16, i8 addrspace(200)* nonnull [[TMP0]]) #5, !dbg !44
// CHECK-NEXT:    ret void, !dbg !44
//
