...
// RUN: %cheri_purecap_cc1 -cheri-uintcap=offset -O2 -std=c++11 -o - -emit-llvm %s | %cheri_FileCheck %s
// Check that this no longer crashes:
// RUN: %cheri_purecap_cc1 -cheri-uintcap=offset -O2 -std=c++11 -o /dev/null -S %s -verify
// REQUIRES: clang
