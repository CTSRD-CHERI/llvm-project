; RUN: %cheri_llc -mtriple=cheri-unknown-freebsd %s -o - -relocation-model=static | %cheri_FileCheck %s %s
; RUN: %cheri_llc -mtriple=cheri-unknown-freebsd %s -o - -relocation-model=pic | %cheri_FileCheck %s %s
; RUN: %cheri_llc -mtriple=cheri-unknown-freebsd %s -o - -filetype=obj | llvm-readobj -r | %cheri_FileCheck %s -check-prefix=RELOCS %s
