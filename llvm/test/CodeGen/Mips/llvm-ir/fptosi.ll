...
; M32R2-SF-NEXT:    # <MCOperand Reg:23>
; M32R2-SF-NEXT:    # <MCOperand Reg:23>
...
; MMR6-NEXT:    # <MCOperand Reg:212>
; MMR6-NEXT:    # <MCOperand Reg:224>>
...
; M32R2-FP64-NEXT:    # <MCOperand Reg:212>
; M32R2-FP64-NEXT:    # <MCOperand Reg:438>>
; M32R2-FP64-NEXT:    jr $ra # <MCInst #{{[0-9]+}} JR
; M32R2-FP64-NEXT:    # <MCOperand Reg:21>>
; M32R2-FP64-NEXT:    mfc1 $2, $f0 # <MCInst #{{[0-9]+}} MFC1
; M32R2-FP64-NEXT:    # <MCOperand Reg:386>
...
; M32R3R5-NEXT:    # <MCOperand Reg:212>
; M32R3R5-NEXT:    # <MCOperand Reg:198>>
; M32R3R5-NEXT:    jr $ra # <MCInst #{{[0-9]+}} JR
; M32R3R5-NEXT:    # <MCOperand Reg:21>>
; M32R3R5-NEXT:    mfc1 $2, $f0 # <MCInst #{{[0-9]+}} MFC1
; M32R3R5-NEXT:    # <MCOperand Reg:386>
...
; MMR2-FP32-NEXT:    # <MCOperand Reg:212>
; MMR2-FP32-NEXT:    # <MCOperand Reg:198>>
; MMR2-FP32-NEXT:    jr $ra # <MCInst #{{[0-9]+}} JR_MM
; MMR2-FP32-NEXT:    # <MCOperand Reg:21>>
; MMR2-FP32-NEXT:    mfc1 $2, $f0 # <MCInst #{{[0-9]+}} MFC1_MM
; MMR2-FP32-NEXT:    # <MCOperand Reg:386>
...
; MMR2-FP64-NEXT:    # <MCOperand Reg:212>
; MMR2-FP64-NEXT:    # <MCOperand Reg:438>>
; MMR2-FP64-NEXT:    jr $ra # <MCInst #{{[0-9]+}} JR_MM
; MMR2-FP64-NEXT:    # <MCOperand Reg:21>>
; MMR2-FP64-NEXT:    mfc1 $2, $f0 # <MCInst #{{[0-9]+}} MFC1_MM
; MMR2-FP64-NEXT:    # <MCOperand Reg:386>
