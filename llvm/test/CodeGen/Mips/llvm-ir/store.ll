...
; MMR3-NEXT:    # <MCOperand Reg:21>>
; MMR3-NEXT:    sb $4, %lo(a)($1) # <MCInst #{{[0-9]+}} SB_MM
; MMR3-NEXT:    # <MCOperand Reg:24>
; MMR3-NEXT:    # <MCOperand Reg:1>
...
; MIPS32R6-NEXT:    # <MCOperand Reg:24>
; MIPS32R6-NEXT:    # <MCOperand Reg:1>
...
; MIPS4-NEXT:    # <MCOperand Reg:366>>
; MIPS4-NEXT:    sb $4, %lo(a)($1) # <MCInst #{{[0-9]+}} SB64
; MIPS4-NEXT:    # <MCOperand Reg:421>
; MIPS4-NEXT:    # <MCOperand Reg:32>
...
; MIPS64R6-NEXT:    # <MCOperand Reg:32>
...
; MIPS64R6-NEXT:    # <MCOperand Reg:420>
; MIPS64R6-NEXT:    # <MCOperand Reg:366>>
; MIPS64R6-NEXT:    sb $4, %lo(a)($1) # <MCInst #{{[0-9]+}} SB64
; MIPS64R6-NEXT:    # <MCOperand Reg:421>
; MIPS64R6-NEXT:    # <MCOperand Reg:32>
...
; MMR3-NEXT:    # <MCOperand Reg:386>
; MMR3-NEXT:    # <MCOperand Reg:1>
; MMR3-NEXT:    # <MCOperand Expr:(%lo(d))>>
; MMR3-NEXT:    sw16 $5, 4($2) # <MCInst #{{[0-9]+}} SW16_MM
; MMR3-NEXT:    # <MCOperand Reg:25>
; MMR3-NEXT:    # <MCOperand Reg:386>
...
; MIPS32R6-NEXT:    # <MCOperand Reg:25>
; MIPS32R6-NEXT:    # <MCOperand Reg:1>
...
; MMR6-NEXT:    # <MCOperand Reg:386>
; MMR6-NEXT:    # <MCOperand Reg:1>
; MMR6-NEXT:    # <MCOperand Expr:(%lo(d))>>
; MMR6-NEXT:    sw16 $5, 4($2) # <MCInst #{{[0-9]+}} SW16_MM
; MMR6-NEXT:    # <MCOperand Reg:25>
; MMR6-NEXT:    # <MCOperand Reg:386>
