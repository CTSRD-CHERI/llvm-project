...
; MIPS32R6-NEXT:    # <MCOperand Reg:386>
; MIPS32R6-NEXT:    # <MCOperand Reg:1>
...
; MIPS3-NEXT:    # <MCOperand Reg:366>>
; MIPS3-NEXT:    lbu $2, %lo(a)($1) # <MCInst #{{[0-9]+}} LBu
; MIPS3-NEXT:    # <MCOperand Reg:386>
; MIPS3-NEXT:    # <MCOperand Reg:32>
...
; MIPS64-NEXT:    # <MCOperand Reg:366>>
; MIPS64-NEXT:    lbu $2, %lo(a)($1) # <MCInst #{{[0-9]+}} LBu
; MIPS64-NEXT:    # <MCOperand Reg:386>
; MIPS64-NEXT:    # <MCOperand Reg:32>
...
; MIPS64R6-NEXT:    # <MCOperand Reg:386>
; MIPS64R6-NEXT:    # <MCOperand Reg:32>
...
; MIPS32R6-NEXT:    # <MCOperand Reg:387>
; MIPS32R6-NEXT:    # <MCOperand Reg:1>
; MIPS32R6-NEXT:    # <MCOperand Expr:(%lo(c))>>
; MIPS32R6-NEXT:    jr $ra # <MCInst #{{[0-9]+}} JALR
; MIPS32R6-NEXT:    # <MCOperand Reg:23>
