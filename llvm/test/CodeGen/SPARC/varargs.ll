; RUN: llc -opaque-pointers=0 < %s -disable-block-placement | FileCheck %s
; RUN: llc -opaque-pointers=0 < %s -disable-block-placement -disable-sparc-leaf-proc=0 | FileCheck %s
