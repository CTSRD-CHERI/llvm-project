...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      iFATPTR64      =  136,   // 64-bit fat pointer type
      iFATPTR128     =  137,   // 128-bit fat pointer type
      iFATPTR256     =  138,   // 256-bit fat pointer type
      iFATPTR512     =  139,   // 512-bit fat pointer type
      iFATPTRAny     =  140,   // Generic fat pointer type (must be legalised
                               // to a sized  version)
