...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      iFATPTR64      =  146,   // 64-bit fat pointer type
      iFATPTR128     =  147,   // 128-bit fat pointer type
      iFATPTR256     =  148,   // 256-bit fat pointer type
      iFATPTR512     =  149,   // 512-bit fat pointer type
      iFATPTRAny     =  150,   // Generic fat pointer type (must be legalised
                               // to a sized  version)
