...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      iFATPTR64      =  134,   // 64-bit fat pointer type
      iFATPTR128     =  135,   // 128-bit fat pointer type
      iFATPTR256     =  136,   // 256-bit fat pointer type
      iFATPTR512     =  137,   // 512-bit fat pointer type
      iFATPTRAny     =  138,   // Generic fat pointer type (must be legalised
                               // to a sized  version)
