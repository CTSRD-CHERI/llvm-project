...
namespace llvm {
  ...
  public:
    enum SimpleValueType : uint8_t {
      ...
      iFATPTR64      =  132,   // 64-bit fat pointer type
      iFATPTR128     =  133,   // 128-bit fat pointer type
      iFATPTR256     =  134,   // 256-bit fat pointer type
      iFATPTR512     =  135,   // 512-bit fat pointer type
      iFATPTRAny     =  136,   // Generic fat pointer type (must be legalised
                               // to a sized  version)
      FIRST_FAT_POINTER = iFATPTR64,
      LAST_FAT_POINTER = iFATPTRAny,

      FIRST_VALUETYPE = 1,     // This is always the beginning of the list.
      LAST_VALUETYPE =  137,   // This always remains at the end of the list.
